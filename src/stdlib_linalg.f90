module stdlib_linalg
  ...
  interface chol
    ...
    !!     
     ...
     pure module function stdlib_linalg_x_cholesky_fun(a,lower,other_zeroed) result(c)
         !> Input matrix a[m,n]
     ...
     end function stdlib_linalg_x_cholesky_fun
     ...
     pure module function stdlib_linalg_y_cholesky_fun(a,lower,other_zeroed) result(c)
         !> Input matrix a[m,n]
     ...
     end function stdlib_linalg_y_cholesky_fun
  ...
  interface cholesky
    ...
    !!         
     ...
     pure module subroutine stdlib_linalg_x_cholesky_inplace(a,lower,other_zeroed,err) 
         !> Input matrix a[m,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
     end subroutine stdlib_linalg_x_cholesky_inplace
     
     pure module subroutine stdlib_linalg_x_cholesky(a,c,lower,other_zeroed,err) 
         !> Input matrix a[n,n]
         real(xdp), intent(in) :: a(:,:)
         !> Output matrix with Cholesky factors c[n,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err     
     end subroutine stdlib_linalg_x_cholesky
     ...
     pure module subroutine stdlib_linalg_y_cholesky_inplace(a,lower,other_zeroed,err) 
         !> Input matrix a[m,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
     end subroutine stdlib_linalg_y_cholesky_inplace
     
     pure module subroutine stdlib_linalg_y_cholesky(a,c,lower,other_zeroed,err) 
         !> Input matrix a[n,n]
         complex(xdp), intent(in) :: a(:,:)
         !> Output matrix with Cholesky factors c[n,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err     
     end subroutine stdlib_linalg_y_cholesky
  ...
  interface diag
    ...
    !! diag-create-a-diagonal-array-or-extract-the-diagonal-elements-of-an-array))
      ...
      module pure function diag_rxdp(v) result(res)
      ...
      module pure function diag_cxdp(v) result(res)
      ...
      module pure function diag_rxdp_k(v,k) result(res)
        real(xdp), intent(in) :: v(:)
        integer, intent(in) :: k
      ...
      module pure function diag_cxdp_k(v,k) result(res)
        complex(xdp), intent(in) :: v(:)
        integer, intent(in) :: k
      ...
      module pure function diag_rxdp_mat(A) result(res)
        real(xdp), intent(in) :: A(:,:)
      ...
      module pure function diag_cxdp_mat(A) result(res)
        complex(xdp), intent(in) :: A(:,:)
      ...
      module pure function diag_rxdp_mat_k(A,k) result(res)
        real(xdp), intent(in) :: A(:,:)
        integer, intent(in) :: k
      ...
      module pure function diag_cxdp_mat_k(A,k) result(res)
        complex(xdp), intent(in) :: A(:,:)
        integer, intent(in) :: k
  ...
  interface hermitian
    ...
    pure module function hermitian_rxdp(a) result(ah)
        real(xdp), intent(in) :: a(:,:)
        real(xdp) :: ah(size(a, 2), size(a, 1))
    end function hermitian_rxdp
    ...
    pure module function hermitian_cxdp(a) result(ah)
        complex(xdp), intent(in) :: a(:,:)
        complex(xdp) :: ah(size(a, 2), size(a, 1))
    end function hermitian_cxdp
  ...
  interface solve
     ...
     module function stdlib_linalg_x_solve_one(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         real(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
     ...
     end function stdlib_linalg_x_solve_one
     pure module function stdlib_linalg_x_pure_solve_one(a,b) result(x)
         !> Input matrix a[n,n]
         real(xdp), intent(in) :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(xdp), intent(in) :: b(:)
         !> Result array/matrix x[n] or x[n,nrhs]
         real(xdp), allocatable, target :: x(:)
     end function stdlib_linalg_x_pure_solve_one
     ...
     module function stdlib_linalg_y_solve_one(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
     ...
     end function stdlib_linalg_y_solve_one
     pure module function stdlib_linalg_y_pure_solve_one(a,b) result(x)
         !> Input matrix a[n,n]
         complex(xdp), intent(in) :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(xdp), intent(in) :: b(:)
         !> Result array/matrix x[n] or x[n,nrhs]
         complex(xdp), allocatable, target :: x(:)
     end function stdlib_linalg_y_pure_solve_one
     ...
     module function stdlib_linalg_x_solve_many(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         real(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(xdp), intent(in) :: b(:,:)     
         ...
         !> Result array/matrix x[n] or x[n,nrhs]
         real(xdp), allocatable, target :: x(:,:)
     end function stdlib_linalg_x_solve_many
     pure module function stdlib_linalg_x_pure_solve_many(a,b) result(x)
         !> Input matrix a[n,n]
         real(xdp), intent(in) :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(xdp), intent(in) :: b(:,:)
         !> Result array/matrix x[n] or x[n,nrhs]
         real(xdp), allocatable, target :: x(:,:)
     end function stdlib_linalg_x_pure_solve_many
     ...
     module function stdlib_linalg_y_solve_many(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(xdp), intent(in) :: b(:,:)     
         ...
         !> Result array/matrix x[n] or x[n,nrhs]
         complex(xdp), allocatable, target :: x(:,:)
     end function stdlib_linalg_y_solve_many
     pure module function stdlib_linalg_y_pure_solve_many(a,b) result(x)
         !> Input matrix a[n,n]
         complex(xdp), intent(in) :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(xdp), intent(in) :: b(:,:)
         !> Result array/matrix x[n] or x[n,nrhs]
         complex(xdp), allocatable, target :: x(:,:)
     end function stdlib_linalg_y_pure_solve_many
  ...
  interface solve_lu
     ...
     pure module subroutine stdlib_linalg_x_solve_lu_one(a,b,x,pivot,overwrite_a,err)     
         !> Input matrix a[n,n]
         real(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(xdp), intent(in) :: b(:)
         !> Result array/matrix x[n] or x[n,nrhs]     
         real(xdp), intent(inout), contiguous, target :: x(:)
         !> [optional] Storage array for the diagonal pivot indices
         integer(ilp), optional, intent(inout), target :: pivot(:)
         !> [optional] Can A data be overwritten and destroyed?
         logical(lk), optional, intent(in) :: overwrite_a
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
     end subroutine stdlib_linalg_x_solve_lu_one
     ...
     pure module subroutine stdlib_linalg_y_solve_lu_one(a,b,x,pivot,overwrite_a,err)     
         !> Input matrix a[n,n]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(xdp), intent(in) :: b(:)
         !> Result array/matrix x[n] or x[n,nrhs]     
         complex(xdp), intent(inout), contiguous, target :: x(:)
         !> [optional] Storage array for the diagonal pivot indices
         integer(ilp), optional, intent(inout), target :: pivot(:)
         !> [optional] Can A data be overwritten and destroyed?
         logical(lk), optional, intent(in) :: overwrite_a
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
     end subroutine stdlib_linalg_y_solve_lu_one
     ...
     pure module subroutine stdlib_linalg_x_solve_lu_many(a,b,x,pivot,overwrite_a,err)     
         !> Input matrix a[n,n]
         real(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(xdp), intent(in) :: b(:,:)
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
     end subroutine stdlib_linalg_x_solve_lu_many
     ...
     pure module subroutine stdlib_linalg_y_solve_lu_many(a,b,x,pivot,overwrite_a,err)     
         !> Input matrix a[n,n]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(xdp), intent(in) :: b(:,:)
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
     end subroutine stdlib_linalg_y_solve_lu_many
  ...
  interface lstsq
    ...
    !! 
      ...
      module function stdlib_linalg_x_lstsq_one(a,b,cond,overwrite_a,rank,err) result(x)
         !> Input matrix a[n,n]
         real(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(xdp), intent(in) :: b(:)
         ...
         !> Result array/matrix x[n] or x[n,nrhs]
         real(xdp), allocatable, target :: x(:)
      end function stdlib_linalg_x_lstsq_one
      ...
      module function stdlib_linalg_y_lstsq_one(a,b,cond,overwrite_a,rank,err) result(x)
         !> Input matrix a[n,n]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(xdp), intent(in) :: b(:)
         ...
         !> Result array/matrix x[n] or x[n,nrhs]
         complex(xdp), allocatable, target :: x(:)
      end function stdlib_linalg_y_lstsq_one
      ...
      module function stdlib_linalg_x_lstsq_many(a,b,cond,overwrite_a,rank,err) result(x)
         !> Input matrix a[n,n]
         real(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(xdp), intent(in) :: b(:,:)
         ...
         !> Result array/matrix x[n] or x[n,nrhs]
         real(xdp), allocatable, target :: x(:,:)
      end function stdlib_linalg_x_lstsq_many
      ...
      module function stdlib_linalg_y_lstsq_many(a,b,cond,overwrite_a,rank,err) result(x)
         !> Input matrix a[n,n]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(xdp), intent(in) :: b(:,:)
         ...
         !> Result array/matrix x[n] or x[n,nrhs]
         complex(xdp), allocatable, target :: x(:,:)
      end function stdlib_linalg_y_lstsq_many
  ...
  interface solve_lstsq
    ...
    !! 
      ...
      module subroutine stdlib_linalg_x_solve_lstsq_one(a,b,x,real_storage,int_storage,&
                        cond,singvals,overwrite_a,rank,err) 
         !> Input matrix a[n,n]
         real(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         ...
         real(xdp), intent(inout), contiguous, target :: x(:)     
         !> [optional] real working storage space
         real(xdp), optional, intent(inout), target :: real_storage(:)
         !> [optional] integer working storage space
         integer(ilp), optional, intent(inout), target :: int_storage(:)
         !> [optional] cutoff for rank evaluation: singular values s(i)<=cond*maxval(s) are considered 0.
         real(xdp), optional, intent(in) :: cond
         !> [optional] list of singular values [min(m,n)], in descending magnitude order, returned by the SVD
         real(xdp), optional, intent(out), target :: singvals(:)                  
         !> [optional] Can A,b data be overwritten and destroyed?
         logical(lk), optional, intent(in) :: overwrite_a
         !> [optional] Return rank of A
         integer(ilp), optional, intent(out) :: rank
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
      end subroutine stdlib_linalg_x_solve_lstsq_one
      ...
      module subroutine stdlib_linalg_y_solve_lstsq_one(a,b,x,real_storage,int_storage,&
                        cmpl_storage,cond,singvals,overwrite_a,rank,err) 
         !> Input matrix a[n,n]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         ...
         integer(ilp), optional, intent(inout), target :: int_storage(:)
         !> [optional] complex working storage space
         complex(xdp), optional, intent(inout), target :: cmpl_storage(:)                  
         !> [optional] cutoff for rank evaluation: singular values s(i)<=cond*maxval(s) are considered 0.
         real(xdp), optional, intent(in) :: cond
         !> [optional] list of singular values [min(m,n)], in descending magnitude order, returned by the SVD
         real(xdp), optional, intent(out), target :: singvals(:)                  
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
      end subroutine stdlib_linalg_y_solve_lstsq_one
      ...
      module subroutine stdlib_linalg_x_solve_lstsq_many(a,b,x,real_storage,int_storage,&
                        cond,singvals,overwrite_a,rank,err) 
         !> Input matrix a[n,n]
         real(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
      end subroutine stdlib_linalg_x_solve_lstsq_many
      ...
      module subroutine stdlib_linalg_y_solve_lstsq_many(a,b,x,real_storage,int_storage,&
                        cmpl_storage,cond,singvals,overwrite_a,rank,err) 
         !> Input matrix a[n,n]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
      end subroutine stdlib_linalg_y_solve_lstsq_many
  ...
  interface lstsq_space
    ...
    !! 
      ...
      pure module subroutine stdlib_linalg_x_lstsq_space_one(a,b,lrwork,liwork)
         !> Input matrix a[m,n]
         ...
         !> Size of the working space arrays                
         integer(ilp), intent(out) :: lrwork,liwork         
      end subroutine stdlib_linalg_x_lstsq_space_one
      ...
      pure module subroutine stdlib_linalg_y_lstsq_space_one(a,b,lrwork,liwork,lcwork)
         !> Input matrix a[m,n]
         ...
         !> Size of the working space arrays                
         integer(ilp), intent(out) :: lrwork,liwork,lcwork         
      end subroutine stdlib_linalg_y_lstsq_space_one
      ...
      pure module subroutine stdlib_linalg_x_lstsq_space_many(a,b,lrwork,liwork)
         !> Input matrix a[m,n]
         real(xdp), intent(in), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(xdp), intent(in) :: b(:,:)
         !> Size of the working space arrays                
         integer(ilp), intent(out) :: lrwork,liwork         
      end subroutine stdlib_linalg_x_lstsq_space_many
      ...
      pure module subroutine stdlib_linalg_y_lstsq_space_many(a,b,lrwork,liwork,lcwork)
         !> Input matrix a[m,n]
         complex(xdp), intent(in), target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(xdp), intent(in) :: b(:,:)
         !> Size of the working space arrays                
         integer(ilp), intent(out) :: lrwork,liwork,lcwork         
      end subroutine stdlib_linalg_y_lstsq_space_many
  ...
  interface qr
    ...
    !!     
      ...
      pure module subroutine stdlib_linalg_x_qr(a,q,r,overwrite_a,storage,err) 
         !> Input matrix a[m,n]
         real(xdp), intent(inout), target :: a(:,:)
         !> Orthogonal matrix Q ([m,m], or [m,k] if reduced)
         ...
         logical(lk), optional, intent(in) :: overwrite_a
         !> [optional] Provide pre-allocated workspace, size to be checked with qr_space
         real(xdp), intent(out), optional, target :: storage(:)
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
      end subroutine stdlib_linalg_x_qr
      ...
      pure module subroutine stdlib_linalg_y_qr(a,q,r,overwrite_a,storage,err) 
         !> Input matrix a[m,n]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Orthogonal matrix Q ([m,m], or [m,k] if reduced)
         ...
         logical(lk), optional, intent(in) :: overwrite_a
         !> [optional] Provide pre-allocated workspace, size to be checked with qr_space
         complex(xdp), intent(out), optional, target :: storage(:)
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
      end subroutine stdlib_linalg_y_qr
  ...
  interface qr_space
    ...
    !!     
      ...
      pure module subroutine get_qr_x_workspace(a,lwork,err)
         !> Input matrix a[m,n]
         real(xdp), intent(in), target :: a(:,:)
         !> Minimum workspace size for both operations
         integer(ilp), intent(out) :: lwork
      ...
      pure module subroutine get_qr_y_workspace(a,lwork,err)
         !> Input matrix a[m,n]
         complex(xdp), intent(in), target :: a(:,:)
         !> Minimum workspace size for both operations
         integer(ilp), intent(out) :: lwork
  ...
  interface schur
    ...
    !! 
      ...
      module subroutine stdlib_linalg_x_schur(a, t, z, eigvals, overwrite_a, storage, err)
         !> Input matrix a[m,m]
         real(xdp), intent(inout), target :: a(:,:)
         !> Schur form of A: upper-triangular or quasi-upper-triangular matrix T
         ...
         !> [optional] State return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
      end subroutine stdlib_linalg_x_schur
      
      ! Schur decomposition subroutine: real eigenvalue interface
      module subroutine stdlib_linalg_real_eig_x_schur(a,t,z,eigvals,overwrite_a,storage,err)
         !> Input matrix a[m,m]
         real(xdp), intent(inout), target :: a(:,:)
         !> Schur form of A: upper-triangular or quasi-upper-triangular matrix T
         real(xdp), intent(out), contiguous, target :: t(:,:)
         ...
         !> [optional] State return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err        
      end subroutine stdlib_linalg_real_eig_x_schur 
      ...
      module subroutine stdlib_linalg_y_schur(a, t, z, eigvals, overwrite_a, storage, err)
         !> Input matrix a[m,m]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Schur form of A: upper-triangular or quasi-upper-triangular matrix T
         ...
         !> [optional] State return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
      end subroutine stdlib_linalg_y_schur
      
      ! Schur decomposition subroutine: real eigenvalue interface
      module subroutine stdlib_linalg_real_eig_y_schur(a,t,z,eigvals,overwrite_a,storage,err)
         !> Input matrix a[m,m]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Schur form of A: upper-triangular or quasi-upper-triangular matrix T
         complex(xdp), intent(out), contiguous, target :: t(:,:)
         ...
         !> [optional] State return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err        
      end subroutine stdlib_linalg_real_eig_y_schur 
  ...
  interface schur_space
    ...
    !!     
      ...
      module subroutine get_schur_x_workspace(a,lwork,err)
         !> Input matrix a[m,m]
         real(xdp), intent(in), target :: a(:,:)
         !> Minimum workspace size for the decomposition operation
         integer(ilp), intent(out) :: lwork
      ...
      module subroutine get_schur_y_workspace(a,lwork,err)
         !> Input matrix a[m,m]
         complex(xdp), intent(in), target :: a(:,:)
         !> Minimum workspace size for the decomposition operation
         integer(ilp), intent(out) :: lwork
  ...
  interface inv
    ...
    module function stdlib_linalg_inverse_x(a,err) result(inva)
         !> Input matrix a[n,n]
         real(xdp), intent(in) :: a(:,:)
         !> Output matrix inverse
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end function stdlib_linalg_inverse_x
    ...
    module function stdlib_linalg_inverse_y(a,err) result(inva)
         !> Input matrix a[n,n]
         complex(xdp), intent(in) :: a(:,:)
         !> Output matrix inverse
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end function stdlib_linalg_inverse_y
  ...
  interface invert
    ...
    module subroutine stdlib_linalg_invert_inplace_x(a,pivot,err)
         !> Input matrix a[n,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_invert_inplace_x
    ! Compute the square matrix inverse of a
    module subroutine stdlib_linalg_invert_split_x(a,inva,pivot,err)
         !> Input matrix a[n,n].
         real(xdp), intent(in) :: a(:,:)
         !> Inverse matrix a[n,n]. 
         real(xdp), intent(out) :: inva(:,:)         
         !> [optional] Storage array for the diagonal pivot indices
         integer(ilp), optional, intent(inout), target :: pivot(:)
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err    
    end subroutine stdlib_linalg_invert_split_x
    ...
    module subroutine stdlib_linalg_invert_inplace_y(a,pivot,err)
         !> Input matrix a[n,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_invert_inplace_y
    ! Compute the square matrix inverse of a
    module subroutine stdlib_linalg_invert_split_y(a,inva,pivot,err)
         !> Input matrix a[n,n].
         complex(xdp), intent(in) :: a(:,:)
         !> Inverse matrix a[n,n]. 
         complex(xdp), intent(out) :: inva(:,:)         
         !> [optional] Storage array for the diagonal pivot indices
         integer(ilp), optional, intent(inout), target :: pivot(:)
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err    
    end subroutine stdlib_linalg_invert_split_y
  ...
  interface operator(.inv.)
    ...
    module function stdlib_linalg_inverse_x_operator(a) result(inva)
         !> Input matrix a[n,n]
         real(xdp), intent(in) :: a(:,:)
         !> Result matrix
         real(xdp), allocatable :: inva(:,:)        
    end function stdlib_linalg_inverse_x_operator
    ...
    module function stdlib_linalg_inverse_y_operator(a) result(inva)
         !> Input matrix a[n,n]
         complex(xdp), intent(in) :: a(:,:)
         !> Result matrix
         complex(xdp), allocatable :: inva(:,:)        
    end function stdlib_linalg_inverse_y_operator
  ...
  interface pinv
    ...
    module function stdlib_linalg_pseudoinverse_x(a,rtol,err) result(pinva)
        !> Input matrix a[m,n]
        real(xdp), intent(in), target :: a(:,:)
        !> [optional] Relative tolerance for singular value cutoff
     ...
     end function stdlib_linalg_pseudoinverse_x
    ...
    module function stdlib_linalg_pseudoinverse_y(a,rtol,err) result(pinva)
        !> Input matrix a[m,n]
        complex(xdp), intent(in), target :: a(:,:)
        !> [optional] Relative tolerance for singular value cutoff
        real(xdp), optional, intent(in) :: rtol         
     ...
     end function stdlib_linalg_pseudoinverse_y
  ...
  interface pseudoinvert
    ...
    module subroutine stdlib_linalg_pseudoinvert_x(a,pinva,rtol,err)
        !> Input matrix a[m,n]
        real(xdp), intent(inout) :: a(:,:)
        !> Output pseudo-inverse matrix [n,m]
        real(xdp), intent(out) :: pinva(:,:)
        !> [optional] Relative tolerance for singular value cutoff
        real(xdp), optional, intent(in) :: rtol
        !> [optional] State return flag. On error if not requested, the code will stop
        type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_pseudoinvert_x
    ...
    module subroutine stdlib_linalg_pseudoinvert_y(a,pinva,rtol,err)
        !> Input matrix a[m,n]
        complex(xdp), intent(inout) :: a(:,:)
        !> Output pseudo-inverse matrix [n,m]
        complex(xdp), intent(out) :: pinva(:,:)
        !> [optional] Relative tolerance for singular value cutoff
        real(xdp), optional, intent(in) :: rtol
        !> [optional] State return flag. On error if not requested, the code will stop
        type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_pseudoinvert_y
  ...
  interface operator(.pinv.)
    ...
    module function stdlib_linalg_pinv_x_operator(a) result(pinva)
         !> Input matrix a[m,n]
         real(xdp), intent(in), target :: a(:,:)
         !> Result pseudo-inverse matrix
         real(xdp) :: pinva(size(a,2,kind=ilp),size(a,1,kind=ilp))
    end function stdlib_linalg_pinv_x_operator
    ...
    module function stdlib_linalg_pinv_y_operator(a) result(pinva)
         !> Input matrix a[m,n]
         complex(xdp), intent(in), target :: a(:,:)
         !> Result pseudo-inverse matrix
         complex(xdp) :: pinva(size(a,2,kind=ilp),size(a,1,kind=ilp))
    end function stdlib_linalg_pinv_y_operator
  ...
  interface eig    
    ...
    module subroutine stdlib_linalg_eig_standard_x(a,lambda,right,left, &
                                                      overwrite_a,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of eigenvalues, 
     !! and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_eig_standard_x

    module subroutine stdlib_linalg_real_eig_standard_x(a,lambda,right,left, &
                                                           overwrite_a,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of real eigenvalues, 
     !! and optionally right or left eigenvectors. Returns an error if the eigenvalues had
     !! non-trivial imaginary parts.
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_real_eig_standard_x
    module subroutine stdlib_linalg_eig_generalized_x(a,b,lambda,right,left, &
                                                      overwrite_a,overwrite_b,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of eigenvalues, 
     !! and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_eig_generalized_x

    module subroutine stdlib_linalg_real_eig_generalized_x(a,b,lambda,right,left, &
                                                           overwrite_a,overwrite_b,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of real eigenvalues, 
     !! and optionally right or left eigenvectors. Returns an error if the eigenvalues had
     !! non-trivial imaginary parts.
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_real_eig_generalized_x
    ...
    module subroutine stdlib_linalg_eig_standard_y(a,lambda,right,left, &
                                                      overwrite_a,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of eigenvalues, 
     !! and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_eig_standard_y

    module subroutine stdlib_linalg_real_eig_standard_y(a,lambda,right,left, &
                                                           overwrite_a,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of real eigenvalues, 
     !! and optionally right or left eigenvectors. Returns an error if the eigenvalues had
     !! non-trivial imaginary parts.
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_real_eig_standard_y
    module subroutine stdlib_linalg_eig_generalized_y(a,b,lambda,right,left, &
                                                      overwrite_a,overwrite_b,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of eigenvalues, 
     !! and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         complex(xdp), intent(inout), target :: a(:,:)
         !> Generalized problem matrix B[n,n]
         complex(xdp), intent(inout), target :: b(:,:)
         !> Array of eigenvalues
         complex(xdp), intent(out) :: lambda(:)
         !> The columns of RIGHT contain the right eigenvectors of A
         complex(xdp), optional, intent(out), target :: right(:,:)
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_eig_generalized_y

    module subroutine stdlib_linalg_real_eig_generalized_y(a,b,lambda,right,left, &
                                                           overwrite_a,overwrite_b,err)
     !! Eigendecomposition of matrix A returning an array `lambda` of real eigenvalues, 
     !! and optionally right or left eigenvectors. Returns an error if the eigenvalues had
     !! non-trivial imaginary parts.
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_real_eig_generalized_y
  ...
  interface eigvals
    ...
    module function stdlib_linalg_eigvals_standard_x(a,err) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
    ...
    end function stdlib_linalg_eigvals_standard_x
    
    module function stdlib_linalg_eigvals_noerr_standard_x(a) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         real(xdp), intent(in), dimension(:,:), target :: a 
         !> Array of singular values
         complex(xdp), allocatable :: lambda(:)
    end function stdlib_linalg_eigvals_noerr_standard_x
    module function stdlib_linalg_eigvals_generalized_x(a,b,err) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         real(xdp), intent(in), dimension(:,:), target :: a 
         !> Generalized problem matrix B[n,n]
         ...
         !> Array of singular values
         complex(xdp), allocatable :: lambda(:)        
    end function stdlib_linalg_eigvals_generalized_x
    
    module function stdlib_linalg_eigvals_noerr_generalized_x(a,b) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         real(xdp), intent(in), dimension(:,:), target :: a 
         !> Generalized problem matrix B[n,n]
         ...
         !> Array of singular values
         complex(xdp), allocatable :: lambda(:)
    end function stdlib_linalg_eigvals_noerr_generalized_x
    ...
    module function stdlib_linalg_eigvals_standard_y(a,err) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         ...
         !> Array of singular values
         complex(xdp), allocatable :: lambda(:)        
    end function stdlib_linalg_eigvals_standard_y
    
    module function stdlib_linalg_eigvals_noerr_standard_y(a) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         complex(xdp), intent(in), dimension(:,:), target :: a 
         !> Array of singular values
         complex(xdp), allocatable :: lambda(:)
    end function stdlib_linalg_eigvals_noerr_standard_y
    module function stdlib_linalg_eigvals_generalized_y(a,b,err) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         complex(xdp), intent(in), dimension(:,:), target :: a 
         !> Generalized problem matrix B[n,n]
         ...
         !> Array of singular values
         complex(xdp), allocatable :: lambda(:)        
    end function stdlib_linalg_eigvals_generalized_y
    
    module function stdlib_linalg_eigvals_noerr_generalized_y(a,b) result(lambda)
     !! Return an array of eigenvalues of matrix A.
         !> Input matrix A[m,n]
         complex(xdp), intent(in), dimension(:,:), target :: a 
         !> Generalized problem matrix B[n,n]
         ...
         !> Array of singular values
         complex(xdp), allocatable :: lambda(:)
    end function stdlib_linalg_eigvals_noerr_generalized_y
  ...
  interface eigh
    ...
    module subroutine stdlib_linalg_eigh_x(a,lambda,vectors,upper_a,overwrite_a,err)
     !! Eigendecomposition of a real symmetric or complex Hermitian matrix A returning an array `lambda` 
     !! of eigenvalues, and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         real(xdp), intent(inout), target :: a(:,:)
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_eigh_x
    ...
    module subroutine stdlib_linalg_eigh_y(a,lambda,vectors,upper_a,overwrite_a,err)
     !! Eigendecomposition of a real symmetric or complex Hermitian matrix A returning an array `lambda` 
     !! of eigenvalues, and optionally right or left eigenvectors.        
         !> Input matrix A[m,n]
         complex(xdp), intent(inout), target :: a(:,:)
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
    end subroutine stdlib_linalg_eigh_y
  ...
  interface eigvalsh
    ...
    module function stdlib_linalg_eigvalsh_x(a,upper_a,err) result(lambda)
     !! Return an array of eigenvalues of real symmetric / complex hermitian A
         !> Input matrix A[m,n]
         real(xdp), intent(in), target :: a(:,:)
         !> [optional] Should the upper/lower half of A be used? Default: lower
    ...
    end function stdlib_linalg_eigvalsh_x
    
    module function stdlib_linalg_eigvalsh_noerr_x(a,upper_a) result(lambda)
     !! Return an array of eigenvalues of real symmetric / complex hermitian A        
         !> Input matrix A[m,n]
         real(xdp), intent(in), target :: a(:,:)
         !> [optional] Should the upper/lower half of A be used? Default: lower
         ...
         !> Array of singular values
         real(xdp), allocatable :: lambda(:)
    end function stdlib_linalg_eigvalsh_noerr_x
    ...
    module function stdlib_linalg_eigvalsh_y(a,upper_a,err) result(lambda)
     !! Return an array of eigenvalues of real symmetric / complex hermitian A
         !> Input matrix A[m,n]
         complex(xdp), intent(in), target :: a(:,:)
         !> [optional] Should the upper/lower half of A be used? Default: lower
         ...
         !> Array of singular values
         real(xdp), allocatable :: lambda(:)    
    end function stdlib_linalg_eigvalsh_y
    
    module function stdlib_linalg_eigvalsh_noerr_y(a,upper_a) result(lambda)
     !! Return an array of eigenvalues of real symmetric / complex hermitian A        
         !> Input matrix A[m,n]
         complex(xdp), intent(in), target :: a(:,:)
         !> [optional] Should the upper/lower half of A be used? Default: lower
         ...
         !> Array of singular values
         real(xdp), allocatable :: lambda(:)
    end function stdlib_linalg_eigvalsh_noerr_y
  ...
  interface svd 
    ...
    module subroutine stdlib_linalg_svd_x(a,s,u,vt,overwrite_a,full_matrices,err)
     !!### Summary
     !! Compute singular value decomposition of a matrix \( A = U \cdot S \cdot \V^T \)
     !!
     !!### Description
     ...
     !!            
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
      end subroutine stdlib_linalg_svd_x
    ...
    module subroutine stdlib_linalg_svd_y(a,s,u,vt,overwrite_a,full_matrices,err)
     !!### Summary
     !! Compute singular value decomposition of a matrix \( A = U \cdot S \cdot \V^T \)
     !!
     !!### Description
     ...
     !!            
         ...
         !> [optional] state return flag. On error if not requested, the code will stop
         type(linalg_state_type), optional, intent(out) :: err
      end subroutine stdlib_linalg_svd_y
  ...
  interface svdvals
    ...
    module function stdlib_linalg_svdvals_x(a,err) result(s)
     !!### Summary
     !! Compute singular values \(S \) from the singular-value decomposition of a matrix \( A = U \cdot S \cdot \V^T \).
     !!
     !!### Description
     ...
     !!           
      ...
      end function stdlib_linalg_svdvals_x
    ...
    module function stdlib_linalg_svdvals_y(a,err) result(s)
     !!### Summary
     !! Compute singular values \(S \) from the singular-value decomposition of a matrix \( A = U \cdot S \cdot \V^T \).
     !!
     !!### Description
     ...
     !!           
         ...
         !> Array of singular values
         real(xdp), allocatable :: s(:)
      end function stdlib_linalg_svdvals_y
  ...
  interface norm
     ...
     !> Scalar norms: real(xdp)
     pure module function stdlib_linalg_norm_1D_order_char_x(a, order) result(nrm)
        !> Input 1-d matrix a(:)
        real(xdp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_1D_order_char_x
     module function stdlib_linalg_norm_1D_order_err_char_x(a, order, err) result(nrm)
        !> Input 1-d matrix a(:)
        real(xdp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_1D_order_err_char_x
     pure module function stdlib_linalg_norm_2D_order_char_x(a, order) result(nrm)
        !> Input 2-d matrix a(:,:)
        real(xdp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_2D_order_char_x
     module function stdlib_linalg_norm_2D_order_err_char_x(a, order, err) result(nrm)
        !> Input 2-d matrix a(:,:)
        real(xdp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_2D_order_err_char_x
     pure module function stdlib_linalg_norm_3D_order_char_x(a, order) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        real(xdp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_3D_order_char_x
     module function stdlib_linalg_norm_3D_order_err_char_x(a, order, err) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        real(xdp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_3D_order_err_char_x
     pure module function stdlib_linalg_norm_4D_order_char_x(a, order) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        real(xdp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_4D_order_char_x
     module function stdlib_linalg_norm_4D_order_err_char_x(a, order, err) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        real(xdp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_4D_order_err_char_x
     !> Array norms: real(xdp)
     pure module function stdlib_linalg_norm_2D_to_1D_char_x(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        integer(ilp), intent(in) :: dim
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim))   
     end function stdlib_linalg_norm_2D_to_1D_char_x
     module function stdlib_linalg_norm_2D_to_1D_err_char_x(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim))     
     end function stdlib_linalg_norm_2D_to_1D_err_char_x
     pure module function stdlib_linalg_norm_3D_to_2D_char_x(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        integer(ilp), intent(in) :: dim
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim))   
     end function stdlib_linalg_norm_3D_to_2D_char_x
     module function stdlib_linalg_norm_3D_to_2D_err_char_x(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim))     
     end function stdlib_linalg_norm_3D_to_2D_err_char_x
     pure module function stdlib_linalg_norm_4D_to_3D_char_x(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        integer(ilp), intent(in) :: dim
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim), merge(size(a, 3),&
            & size(a, 4), mask=3<dim))   
     end function stdlib_linalg_norm_4D_to_3D_char_x
     module function stdlib_linalg_norm_4D_to_3D_err_char_x(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim), merge(size(a, 3),&
            & size(a, 4), mask=3<dim))     
     end function stdlib_linalg_norm_4D_to_3D_err_char_x
     !> Scalar norms: real(xdp)
     pure module function stdlib_linalg_norm_1D_order_int_x(a, order) result(nrm)
        !> Input 1-d matrix a(:)
        real(xdp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_1D_order_int_x
     module function stdlib_linalg_norm_1D_order_err_int_x(a, order, err) result(nrm)
        !> Input 1-d matrix a(:)
        real(xdp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_1D_order_err_int_x
     pure module function stdlib_linalg_norm_2D_order_int_x(a, order) result(nrm)
        !> Input 2-d matrix a(:,:)
        real(xdp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_2D_order_int_x
     module function stdlib_linalg_norm_2D_order_err_int_x(a, order, err) result(nrm)
        !> Input 2-d matrix a(:,:)
        real(xdp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_2D_order_err_int_x
     pure module function stdlib_linalg_norm_3D_order_int_x(a, order) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        real(xdp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_3D_order_int_x
     module function stdlib_linalg_norm_3D_order_err_int_x(a, order, err) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        real(xdp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_3D_order_err_int_x
     pure module function stdlib_linalg_norm_4D_order_int_x(a, order) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        real(xdp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_4D_order_int_x
     module function stdlib_linalg_norm_4D_order_err_int_x(a, order, err) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        real(xdp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_4D_order_err_int_x
     !> Array norms: real(xdp)
     pure module function stdlib_linalg_norm_2D_to_1D_int_x(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim))   
     end function stdlib_linalg_norm_2D_to_1D_int_x
     module function stdlib_linalg_norm_2D_to_1D_err_int_x(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim))     
     end function stdlib_linalg_norm_2D_to_1D_err_int_x
     pure module function stdlib_linalg_norm_3D_to_2D_int_x(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim))   
     end function stdlib_linalg_norm_3D_to_2D_int_x
     module function stdlib_linalg_norm_3D_to_2D_err_int_x(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim))     
     end function stdlib_linalg_norm_3D_to_2D_err_int_x
     pure module function stdlib_linalg_norm_4D_to_3D_int_x(a, order, dim) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim), merge(size(a, 3),&
            & size(a, 4), mask=3<dim))   
     end function stdlib_linalg_norm_4D_to_3D_int_x
     module function stdlib_linalg_norm_4D_to_3D_err_int_x(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        real(xdp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim), merge(size(a, 3),&
            & size(a, 4), mask=3<dim))     
     end function stdlib_linalg_norm_4D_to_3D_err_int_x
     ...
     !> Scalar norms: complex(xdp)
     pure module function stdlib_linalg_norm_1D_order_char_y(a, order) result(nrm)
        !> Input 1-d matrix a(:)
        complex(xdp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_1D_order_char_y
     module function stdlib_linalg_norm_1D_order_err_char_y(a, order, err) result(nrm)
        !> Input 1-d matrix a(:)
        complex(xdp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_1D_order_err_char_y
     pure module function stdlib_linalg_norm_2D_order_char_y(a, order) result(nrm)
        !> Input 2-d matrix a(:,:)
        complex(xdp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_2D_order_char_y
     module function stdlib_linalg_norm_2D_order_err_char_y(a, order, err) result(nrm)
        !> Input 2-d matrix a(:,:)
        complex(xdp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_2D_order_err_char_y
     pure module function stdlib_linalg_norm_3D_order_char_y(a, order) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        complex(xdp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_3D_order_char_y
     module function stdlib_linalg_norm_3D_order_err_char_y(a, order, err) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        complex(xdp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_3D_order_err_char_y
     pure module function stdlib_linalg_norm_4D_order_char_y(a, order) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        complex(xdp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_4D_order_char_y
     module function stdlib_linalg_norm_4D_order_err_char_y(a, order, err) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        complex(xdp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_4D_order_err_char_y
     !> Array norms: complex(xdp)
     pure module function stdlib_linalg_norm_2D_to_1D_char_y(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim))   
     end function stdlib_linalg_norm_2D_to_1D_char_y
     module function stdlib_linalg_norm_2D_to_1D_err_char_y(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim))     
     end function stdlib_linalg_norm_2D_to_1D_err_char_y
     pure module function stdlib_linalg_norm_3D_to_2D_char_y(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim))   
     end function stdlib_linalg_norm_3D_to_2D_char_y
     module function stdlib_linalg_norm_3D_to_2D_err_char_y(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim))     
     end function stdlib_linalg_norm_3D_to_2D_err_char_y
     pure module function stdlib_linalg_norm_4D_to_3D_char_y(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim), merge(size(a, 3),&
            & size(a, 4), mask=3<dim))   
     end function stdlib_linalg_norm_4D_to_3D_char_y
     module function stdlib_linalg_norm_4D_to_3D_err_char_y(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        character(len=*), intent(in) :: order
        ...
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim), merge(size(a, 3),&
            & size(a, 4), mask=3<dim))     
     end function stdlib_linalg_norm_4D_to_3D_err_char_y
     !> Scalar norms: complex(xdp)
     pure module function stdlib_linalg_norm_1D_order_int_y(a, order) result(nrm)
        !> Input 1-d matrix a(:)
        complex(xdp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_1D_order_int_y
     module function stdlib_linalg_norm_1D_order_err_int_y(a, order, err) result(nrm)
        !> Input 1-d matrix a(:)
        complex(xdp), intent(in) :: a(:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_1D_order_err_int_y
     pure module function stdlib_linalg_norm_2D_order_int_y(a, order) result(nrm)
        !> Input 2-d matrix a(:,:)
        complex(xdp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_2D_order_int_y
     module function stdlib_linalg_norm_2D_order_err_int_y(a, order, err) result(nrm)
        !> Input 2-d matrix a(:,:)
        complex(xdp), intent(in) :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_2D_order_err_int_y
     pure module function stdlib_linalg_norm_3D_order_int_y(a, order) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        complex(xdp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_3D_order_int_y
     module function stdlib_linalg_norm_3D_order_err_int_y(a, order, err) result(nrm)
        !> Input 3-d matrix a(:,:,:)
        complex(xdp), intent(in) :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_3D_order_err_int_y
     pure module function stdlib_linalg_norm_4D_order_int_y(a, order) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        complex(xdp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        !> Norm of the matrix.
        real(xdp) :: nrm       
     end function stdlib_linalg_norm_4D_order_int_y
     module function stdlib_linalg_norm_4D_order_err_int_y(a, order, err) result(nrm)
        !> Input 4-d matrix a(:,:,:,:)
        complex(xdp), intent(in) :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix.
        real(xdp) :: nrm               
     end function stdlib_linalg_norm_4D_order_err_int_y
     !> Array norms: complex(xdp)
     pure module function stdlib_linalg_norm_2D_to_1D_int_y(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim))   
     end function stdlib_linalg_norm_2D_to_1D_int_y
     module function stdlib_linalg_norm_2D_to_1D_err_int_y(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim))     
     end function stdlib_linalg_norm_2D_to_1D_err_int_y
     pure module function stdlib_linalg_norm_3D_to_2D_int_y(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim))   
     end function stdlib_linalg_norm_3D_to_2D_int_y
     module function stdlib_linalg_norm_3D_to_2D_err_int_y(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim))     
     end function stdlib_linalg_norm_3D_to_2D_err_int_y
     pure module function stdlib_linalg_norm_4D_to_3D_int_y(a, order, dim) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim), merge(size(a, 3),&
            & size(a, 4), mask=3<dim))   
     end function stdlib_linalg_norm_4D_to_3D_int_y
     module function stdlib_linalg_norm_4D_to_3D_err_int_y(a, order, dim, err) result(nrm)
        !> Input matrix a[..]
        complex(xdp), intent(in), target :: a(:,:,:,:)
        !> Order of the matrix norm being computed.
        integer(ilp), intent(in) :: order
        ...
        real(xdp) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim), merge(size(a, 3),&
            & size(a, 4), mask=3<dim))     
     end function stdlib_linalg_norm_4D_to_3D_err_int_y
  ...
  interface get_norm
     ...
     !!     
        ...
        !> Scalar norms: real(xdp)
        pure module subroutine norm_1D_char_x(a, nrm, order, err)
           !> Input 1-d matrix a(:)
           real(xdp), intent(in), target :: a(:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           !> Order of the matrix norm being computed.
           character(len=*), intent(in) :: order
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_1D_char_x
        pure module subroutine norm_2D_char_x(a, nrm, order, err)
           !> Input 2-d matrix a(:,:)
           real(xdp), intent(in), target :: a(:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_2D_char_x
        pure module subroutine norm_3D_char_x(a, nrm, order, err)
           !> Input 3-d matrix a(:,:,:)
           real(xdp), intent(in), target :: a(:,:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_3D_char_x
        pure module subroutine norm_4D_char_x(a, nrm, order, err)
           !> Input 4-d matrix a(:,:,:,:)
           real(xdp), intent(in), target :: a(:,:,:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_4D_char_x
        !> Array norms: real(xdp)
        pure module subroutine norm_2D_to_1D_char_x(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(xdp), intent(in) :: a(:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
           real(xdp), intent(out) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim))     
           !> Order of the matrix norm being computed.
           character(len=*), intent(in) :: order
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_2D_to_1D_char_x
        pure module subroutine norm_3D_to_2D_char_x(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(xdp), intent(in) :: a(:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           !> Norm of the matrix. (Same shape as `a`, with `dim` dropped).
           real(xdp), intent(out) :: nrm(merge(size(a, 1), size(a, 2), mask=1<dim), merge(size(a, 2), size(a, 3), mask=2<dim))     
           !> Order of the matrix norm being computed.
           character(len=*), intent(in) :: order
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_3D_to_2D_char_x
        pure module subroutine norm_4D_to_3D_char_x(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(xdp), intent(in) :: a(:,:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_4D_to_3D_char_x
        !> Scalar norms: real(xdp)
        pure module subroutine norm_1D_int_x(a, nrm, order, err)
           !> Input 1-d matrix a(:)
           real(xdp), intent(in), target :: a(:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_1D_int_x
        pure module subroutine norm_2D_int_x(a, nrm, order, err)
           !> Input 2-d matrix a(:,:)
           real(xdp), intent(in), target :: a(:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_2D_int_x
        pure module subroutine norm_3D_int_x(a, nrm, order, err)
           !> Input 3-d matrix a(:,:,:)
           real(xdp), intent(in), target :: a(:,:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_3D_int_x
        pure module subroutine norm_4D_int_x(a, nrm, order, err)
           !> Input 4-d matrix a(:,:,:,:)
           real(xdp), intent(in), target :: a(:,:,:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_4D_int_x
        !> Array norms: real(xdp)
        pure module subroutine norm_2D_to_1D_int_x(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(xdp), intent(in) :: a(:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_2D_to_1D_int_x
        pure module subroutine norm_3D_to_2D_int_x(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(xdp), intent(in) :: a(:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_3D_to_2D_int_x
        pure module subroutine norm_4D_to_3D_int_x(a, nrm, order, dim, err)
           !> Input matrix a[..]
           real(xdp), intent(in) :: a(:,:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_4D_to_3D_int_x
        !> Scalar norms: real(qp)
        ...
        !> Scalar norms: complex(xdp)
        pure module subroutine norm_1D_char_y(a, nrm, order, err)
           !> Input 1-d matrix a(:)
           complex(xdp), intent(in), target :: a(:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_1D_char_y
        pure module subroutine norm_2D_char_y(a, nrm, order, err)
           !> Input 2-d matrix a(:,:)
           complex(xdp), intent(in), target :: a(:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_2D_char_y
        pure module subroutine norm_3D_char_y(a, nrm, order, err)
           !> Input 3-d matrix a(:,:,:)
           complex(xdp), intent(in), target :: a(:,:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_3D_char_y
        pure module subroutine norm_4D_char_y(a, nrm, order, err)
           !> Input 4-d matrix a(:,:,:,:)
           complex(xdp), intent(in), target :: a(:,:,:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_4D_char_y
        !> Array norms: complex(xdp)
        pure module subroutine norm_2D_to_1D_char_y(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(xdp), intent(in) :: a(:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_2D_to_1D_char_y
        pure module subroutine norm_3D_to_2D_char_y(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(xdp), intent(in) :: a(:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_3D_to_2D_char_y
        pure module subroutine norm_4D_to_3D_char_y(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(xdp), intent(in) :: a(:,:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_4D_to_3D_char_y
        !> Scalar norms: complex(xdp)
        pure module subroutine norm_1D_int_y(a, nrm, order, err)
           !> Input 1-d matrix a(:)
           complex(xdp), intent(in), target :: a(:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_1D_int_y
        pure module subroutine norm_2D_int_y(a, nrm, order, err)
           !> Input 2-d matrix a(:,:)
           complex(xdp), intent(in), target :: a(:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_2D_int_y
        pure module subroutine norm_3D_int_y(a, nrm, order, err)
           !> Input 3-d matrix a(:,:,:)
           complex(xdp), intent(in), target :: a(:,:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_3D_int_y
        pure module subroutine norm_4D_int_y(a, nrm, order, err)
           !> Input 4-d matrix a(:,:,:,:)
           complex(xdp), intent(in), target :: a(:,:,:,:)
           !> Norm of the matrix.
           real(xdp), intent(out) :: nrm
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err   
        end subroutine norm_4D_int_y
        !> Array norms: complex(xdp)
        pure module subroutine norm_2D_to_1D_int_y(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(xdp), intent(in) :: a(:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_2D_to_1D_int_y
        pure module subroutine norm_3D_to_2D_int_y(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(xdp), intent(in) :: a(:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_3D_to_2D_int_y
        pure module subroutine norm_4D_to_3D_int_y(a, nrm, order, dim, err)
           !> Input matrix a[..]
           complex(xdp), intent(in) :: a(:,:,:,:)
           !> Dimension the norm is computed along
           integer(ilp), intent(in) :: dim        
           ...
           !> [optional] state return flag. On error if not requested, the code will stop
           type(linalg_state_type), intent(out), optional :: err           
        end subroutine  norm_4D_to_3D_int_y
        !> Scalar norms: complex(qp)
  ...
  interface mnorm
     ...
     !!
      ...
      !> Matrix norms: real(xdp) rank-2 arrays
      module function matrix_norm_char_x(a, order, err) result(nrm)
        !> Input matrix a(m,n)
        real(xdp), intent(in), target :: a(:,:)
        !> Norm of the matrix.        
        real(xdp) :: nrm
        ...
        !> [optional] state return flag. On error if not requested, the code will stop
        type(linalg_state_type), intent(out), optional :: err      
      end function matrix_norm_char_x
      
      !> Matrix norms: real(xdp) higher rank arrays
      module function matrix_norm_3D_to_1D_char_x(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          real(xdp), intent(in), contiguous, target :: a(:,:,:)
          !> Norm of the matrix.        
          real(xdp), allocatable :: nrm(:)
          !> Order of the matrix norm being computed.
          character(len=*), intent(in) :: order
          !> [optional] dimensions of the sub-matrices the norms should be evaluated at (default = [1,2])
          integer(ilp), optional, intent(in) :: dim(2)
          !> [optional] state return flag. On error if not requested, the code will stop
          type(linalg_state_type), intent(out), optional :: err        
      end function matrix_norm_3D_to_1D_char_x
      module function matrix_norm_4D_to_2D_char_x(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          real(xdp), intent(in), contiguous, target :: a(:,:,:,:)
          !> Norm of the matrix.        
          real(xdp), allocatable :: nrm(:,:)
          ...
          !> [optional] state return flag. On error if not requested, the code will stop
          type(linalg_state_type), intent(out), optional :: err        
      end function matrix_norm_4D_to_2D_char_x
      
      !> Matrix norms: real(xdp) rank-2 arrays
      module function matrix_norm_int_x(a, order, err) result(nrm)
        !> Input matrix a(m,n)
        real(xdp), intent(in), target :: a(:,:)
        !> Norm of the matrix.        
        real(xdp) :: nrm
        ...
        !> [optional] state return flag. On error if not requested, the code will stop
        type(linalg_state_type), intent(out), optional :: err      
      end function matrix_norm_int_x
      
      !> Matrix norms: real(xdp) higher rank arrays
      module function matrix_norm_3D_to_1D_int_x(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          real(xdp), intent(in), contiguous, target :: a(:,:,:)
          !> Norm of the matrix.        
          real(xdp), allocatable :: nrm(:)
          ...
          !> [optional] state return flag. On error if not requested, the code will stop
          type(linalg_state_type), intent(out), optional :: err        
      end function matrix_norm_3D_to_1D_int_x
      module function matrix_norm_4D_to_2D_int_x(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          real(xdp), intent(in), contiguous, target :: a(:,:,:,:)
          !> Norm of the matrix.        
          real(xdp), allocatable :: nrm(:,:)
          ...
          !> [optional] state return flag. On error if not requested, the code will stop
          type(linalg_state_type), intent(out), optional :: err        
      end function matrix_norm_4D_to_2D_int_x
      ...
      !> Matrix norms: complex(xdp) rank-2 arrays
      module function matrix_norm_char_y(a, order, err) result(nrm)
        !> Input matrix a(m,n)
        complex(xdp), intent(in), target :: a(:,:)
        !> Norm of the matrix.        
        real(xdp) :: nrm
        ...
        !> [optional] state return flag. On error if not requested, the code will stop
        type(linalg_state_type), intent(out), optional :: err      
      end function matrix_norm_char_y
      
      !> Matrix norms: complex(xdp) higher rank arrays
      module function matrix_norm_3D_to_1D_char_y(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          complex(xdp), intent(in), contiguous, target :: a(:,:,:)
          !> Norm of the matrix.        
          real(xdp), allocatable :: nrm(:)
          !> Order of the matrix norm being computed.
          character(len=*), intent(in) :: order
          ...
          !> [optional] state return flag. On error if not requested, the code will stop
          type(linalg_state_type), intent(out), optional :: err        
      end function matrix_norm_3D_to_1D_char_y
      module function matrix_norm_4D_to_2D_char_y(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          complex(xdp), intent(in), contiguous, target :: a(:,:,:,:)
          !> Norm of the matrix.        
          real(xdp), allocatable :: nrm(:,:)
          ...
          !> [optional] state return flag. On error if not requested, the code will stop
          type(linalg_state_type), intent(out), optional :: err        
      end function matrix_norm_4D_to_2D_char_y
      
      !> Matrix norms: complex(xdp) rank-2 arrays
      module function matrix_norm_int_y(a, order, err) result(nrm)
        !> Input matrix a(m,n)
        complex(xdp), intent(in), target :: a(:,:)
        !> Norm of the matrix.        
        real(xdp) :: nrm
        ...
        !> [optional] state return flag. On error if not requested, the code will stop
        type(linalg_state_type), intent(out), optional :: err      
      end function matrix_norm_int_y
      
      !> Matrix norms: complex(xdp) higher rank arrays
      module function matrix_norm_3D_to_1D_int_y(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          complex(xdp), intent(in), contiguous, target :: a(:,:,:)
          !> Norm of the matrix.        
          real(xdp), allocatable :: nrm(:)
          ...
          !> [optional] state return flag. On error if not requested, the code will stop
          type(linalg_state_type), intent(out), optional :: err        
      end function matrix_norm_3D_to_1D_int_y
      module function matrix_norm_4D_to_2D_int_y(a, order, dim, err) result(nrm)
          !> Input matrix a(m,n)
          complex(xdp), intent(in), contiguous, target :: a(:,:,:,:)
          !> Norm of the matrix.        
          real(xdp), allocatable :: nrm(:,:)
          ...
          !> [optional] state return flag. On error if not requested, the code will stop
          type(linalg_state_type), intent(out), optional :: err        
      end function matrix_norm_4D_to_2D_int_y
...
contains
    ...
    pure function eye_rxdp(dim1, dim2, mold) result(result)

        integer, intent(in) :: dim1
        integer, intent(in), optional :: dim2
        real(xdp), intent(in) :: mold        
        real(xdp), allocatable :: result(:, :)
    ...
    pure function eye_cxdp(dim1, dim2, mold) result(result)

        integer, intent(in) :: dim1
        integer, intent(in), optional :: dim2
        complex(xdp), intent(in) :: mold        
        complex(xdp), allocatable :: result(:, :)
