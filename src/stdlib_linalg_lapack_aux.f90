module stdlib_linalg_lapack_aux
     ...
     public :: stdlib_ilaylc
     public :: stdlib_ilaylr
     ...
     public :: stdlib_I64_xroundup_lwork
     public :: stdlib_I64_qroundup_lwork
     public :: stdlib_I64_icmax1
     public :: stdlib_I64_izmax1
     public :: stdlib_I64_iymax1
     public :: stdlib_I64_iwmax1
     public :: stdlib_I64_ilaslc
     public :: stdlib_I64_ilaslr
     public :: stdlib_I64_iladlc
     public :: stdlib_I64_iladlr
     public :: stdlib_I64_ilaxlc
     public :: stdlib_I64_ilaxlr
     public :: stdlib_I64_ilaqlc
     public :: stdlib_I64_ilaqlr
     public :: stdlib_I64_ilaclc
     public :: stdlib_I64_ilaclr
     public :: stdlib_I64_ilazlc
     public :: stdlib_I64_ilazlr
     public :: stdlib_I64_ilaylc
     public :: stdlib_I64_ilaylr
     public :: stdlib_I64_ilawlc
     public :: stdlib_I64_ilawlr
     public :: stdlib_select_s
     public :: stdlib_selctg_s     
     public :: stdlib_select_d
     public :: stdlib_selctg_d     
     public :: stdlib_select_x
     public :: stdlib_selctg_x     
     ...
     public :: stdlib_select_y
     public :: stdlib_selctg_y     
     ...
     abstract interface 
        ...
        pure logical(lk) function stdlib_selctg_x(alphar,alphai,beta) 
            import xdp,lk 
            implicit none 
            real(xdp), intent(in) :: alphar,alphai,beta 
        end function stdlib_selctg_x
        pure logical(lk) function stdlib_select_x(alphar,alphai) 
            import xdp,lk
            implicit none 
            real(xdp), intent(in) :: alphar,alphai 
        end function stdlib_select_x 
        ...
        pure logical(lk) function stdlib_selctg_y(alpha,beta) 
            import xdp,lk 
            implicit none 
            complex(xdp), intent(in) :: alpha,beta 
        end function stdlib_selctg_y
        pure logical(lk) function stdlib_select_y(alpha) 
            import xdp,lk 
            implicit none 
            complex(xdp), intent(in) :: alpha 
        end function stdlib_select_y        
     ...
     pure real(xdp) function stdlib_xroundup_lwork( lwork )
     !! ROUNDUP_LWORK >= LWORK.
     !! ROUNDUP_LWORK is guaranteed to have zero decimal part.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
       ...
       ! =====================================================================
           ...
           intrinsic :: epsilon,real,int
           ! Executable Statements 
           stdlib_xroundup_lwork = real(lwork,KIND=xdp)
           if (int( stdlib_xroundup_lwork,KIND=ilp)<lwork) then
               ! force round up of lwork
               stdlib_xroundup_lwork = stdlib_xroundup_lwork * (1.0e+0_xdp + epsilon(0.0e+0_xdp))
           endif
           return
     end function stdlib_xroundup_lwork
     ...
     pure integer(ilp) function stdlib_ilaxlc( m, n, a, lda )
     !! ILADLC: scans A for its last non-zero column.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           ! now scan each column from the end, returning with the first non-zero.
              do stdlib_ilaxlc = n, 1, -1
                 do i = 1, m
                    if (a(i, stdlib_ilaxlc)/=zero) return
                 end do
              end do
           end if
           return
     end function stdlib_ilaxlc
     
     pure integer(ilp) function stdlib_ilaxlr( m, n, a, lda )
     !! ILADLR: scans A for its last non-zero row.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ...
           ! scan up each column tracking the last zero row seen.
              ...
              do j = 1, n
                 ...
                 do while((a(max(i,1),j)==zero).and.(i>=1))
                    i=i-1
                 enddo
                 stdlib_ilaxlr = max( stdlib_ilaxlr, i )
              end do
           end if
           return
     end function stdlib_ilaxlr     
     ...
     pure integer(ilp) function stdlib_ilaylc( m, n, a, lda )
     !! ILADLC: scans A for its last non-zero column.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           ! now scan each column from the end, returning with the first non-zero.
              do stdlib_ilaylc = n, 1, -1
                 do i = 1, m
                    if (a(i, stdlib_ilaylc)/=zero) return
                 end do
              end do
           end if
           return
     end function stdlib_ilaylc
     
     pure integer(ilp) function stdlib_ilaylr( m, n, a, lda )
     !! ILADLR: scans A for its last non-zero row.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ...
           ! scan up each column tracking the last zero row seen.
              ...
              do j = 1, n
                 ...
                 do while((a(max(i,1),j)==zero).and.(i>=1))
                    i=i-1
                 enddo
                 stdlib_ilaylr = max( stdlib_ilaylr, i )
              end do
           end if
           return
     end function stdlib_ilaylr     
     ...
     pure integer(ilp) function stdlib_iymax1( n, zx, incx )
     !! I*MAX1: finds the index of the first vector element of maximum absolute value.
     !! Based on I*AMAX from Level 1 BLAS.
     !! The change is to use the 'genuine' absolute value.
        ! -- lapack auxiliary routine --
     ...
     pure real(xdp) function stdlib_I64_xroundup_lwork( lwork )
     !! ROUNDUP_LWORK >= LWORK.
     !! ROUNDUP_LWORK is guaranteed to have zero decimal part.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
       ...
       ! =====================================================================
           ...
           intrinsic :: epsilon,real,int
           ! Executable Statements 
           stdlib_I64_xroundup_lwork = real(lwork,KIND=xdp)
           if (int( stdlib_I64_xroundup_lwork,KIND=ilp)<lwork) then
               ! force round up of lwork
               stdlib_I64_xroundup_lwork = stdlib_I64_xroundup_lwork * (1.0e+0_xdp + epsilon(0.0e+0_xdp))
           endif
           return
     end function stdlib_I64_xroundup_lwork
     
     pure real(qp) function stdlib_I64_qroundup_lwork( lwork )
     !! ROUNDUP_LWORK >= LWORK.
     !! ROUNDUP_LWORK is guaranteed to have zero decimal part.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
       ...
       ! =====================================================================
           ...
           intrinsic :: epsilon,real,int
           ! Executable Statements 
           stdlib_I64_qroundup_lwork = real(lwork,KIND=qp)
           if (int( stdlib_I64_qroundup_lwork,KIND=ilp)<lwork) then
               ! force round up of lwork
               stdlib_I64_qroundup_lwork = stdlib_I64_qroundup_lwork * (1.0e+0_qp + epsilon(0.0e+0_qp))
           endif
           return
     end function stdlib_I64_qroundup_lwork
     ...
     pure integer(ilp64) function stdlib_I64_ilaxlc( m, n, a, lda )
     !! ILADLC: scans A for its last non-zero column.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           ! now scan each column from the end, returning with the first non-zero.
              do stdlib_I64_ilaxlc = n, 1, -1
                 do i = 1, m
                    if (a(i, stdlib_I64_ilaxlc)/=zero) return
                 end do
              end do
           end if
           return
     end function stdlib_I64_ilaxlc
     
     pure integer(ilp64) function stdlib_I64_ilaxlr( m, n, a, lda )
     !! ILADLR: scans A for its last non-zero row.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ...
           ! scan up each column tracking the last zero row seen.
              ...
              do j = 1, n
                 ...
                 do while((a(max(i,1),j)==zero).and.(i>=1))
                    i=i-1
                 enddo
                 stdlib_I64_ilaxlr = max( stdlib_I64_ilaxlr, i )
              end do
           end if
           return
     end function stdlib_I64_ilaxlr     
     
     pure integer(ilp64) function stdlib_I64_ilaqlc( m, n, a, lda )
     !! ILADLC: scans A for its last non-zero column.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           ! now scan each column from the end, returning with the first non-zero.
              do stdlib_I64_ilaqlc = n, 1, -1
                 do i = 1, m
                    if (a(i, stdlib_I64_ilaqlc)/=zero) return
                 end do
              end do
           end if
           return
     end function stdlib_I64_ilaqlc
     
     pure integer(ilp64) function stdlib_I64_ilaqlr( m, n, a, lda )
     !! ILADLR: scans A for its last non-zero row.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ...
           ! scan up each column tracking the last zero row seen.
              ...
              do j = 1, n
                 ...
                 do while((a(max(i,1),j)==zero).and.(i>=1))
                    i=i-1
                 enddo
                 stdlib_I64_ilaqlr = max( stdlib_I64_ilaqlr, i )
              end do
           end if
           return
     end function stdlib_I64_ilaqlr     
     ...
     pure integer(ilp64) function stdlib_I64_ilaylc( m, n, a, lda )
     !! ILADLC: scans A for its last non-zero column.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           ! now scan each column from the end, returning with the first non-zero.
              do stdlib_I64_ilaylc = n, 1, -1
                 do i = 1, m
                    if (a(i, stdlib_I64_ilaylc)/=zero) return
                 end do
              end do
           end if
           return
     end function stdlib_I64_ilaylc
     
     pure integer(ilp64) function stdlib_I64_ilaylr( m, n, a, lda )
     !! ILADLR: scans A for its last non-zero row.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ...
           ! scan up each column tracking the last zero row seen.
              ...
              do j = 1, n
                 ...
                 do while((a(max(i,1),j)==zero).and.(i>=1))
                    i=i-1
                 enddo
                 stdlib_I64_ilaylr = max( stdlib_I64_ilaylr, i )
              end do
           end if
           return
     end function stdlib_I64_ilaylr     
     
     pure integer(ilp64) function stdlib_I64_ilawlc( m, n, a, lda )
     !! ILADLC: scans A for its last non-zero column.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           ! now scan each column from the end, returning with the first non-zero.
              do stdlib_I64_ilawlc = n, 1, -1
                 do i = 1, m
                    if (a(i, stdlib_I64_ilawlc)/=zero) return
                 end do
              end do
           end if
           return
     end function stdlib_I64_ilawlc
     
     pure integer(ilp64) function stdlib_I64_ilawlr( m, n, a, lda )
     !! ILADLR: scans A for its last non-zero row.
        ! -- lapack auxiliary routine --
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           ...
           ! scan up each column tracking the last zero row seen.
              ...
              do j = 1, n
                 ...
                 do while((a(max(i,1),j)==zero).and.(i>=1))
                    i=i-1
                 enddo
                 stdlib_I64_ilawlr = max( stdlib_I64_ilawlr, i )
              end do
           end if
           return
     end function stdlib_I64_ilawlr     
     ...
     pure integer(ilp64) function stdlib_I64_iymax1( n, zx, incx )
     !! I*MAX1: finds the index of the first vector element of maximum absolute value.
     !! Based on I*AMAX from Level 1 BLAS.
     !! The change is to use the 'genuine' absolute value.
        ! -- lapack auxiliary routine --
        ...
        ! =====================================================================
           ...
           return
     end function stdlib_I64_iymax1
     pure integer(ilp64) function stdlib_I64_iwmax1( n, zx, incx )
     !! I*MAX1: finds the index of the first vector element of maximum absolute value.
     !! Based on I*AMAX from Level 1 BLAS.
     !! The change is to use the 'genuine' absolute value.
        ! -- lapack auxiliary routine --
        ...
        ! =====================================================================
           ...
           return
     end function stdlib_I64_iwmax1
