...
submodule (stdlib_linalg) stdlib_linalg_cholesky
     ...
     pure module subroutine stdlib_linalg_x_cholesky(a,c,lower,other_zeroed,err) 
         ...
         if (lda<1 .or. n<1 .or. lda<n .or. ldc<n .or. nc<n) then 
            ...
            ! Get cholesky factors
            call stdlib_linalg_x_cholesky_inplace(c,lower,other_zeroed,err0)            
     ...
     pure module function stdlib_linalg_x_cholesky_fun(a,lower,other_zeroed) result(c)
         ...
         call stdlib_linalg_x_cholesky_inplace(c,lower,other_zeroed)
     ...
     pure module subroutine stdlib_linalg_y_cholesky(a,c,lower,other_zeroed,err) 
         ...
         if (lda<1 .or. n<1 .or. lda<n .or. ldc<n .or. nc<n) then 
            ...
            ! Get cholesky factors
            call stdlib_linalg_y_cholesky_inplace(c,lower,other_zeroed,err0)            
     ...
     pure module function stdlib_linalg_y_cholesky_fun(a,lower,other_zeroed) result(c)
         ...
         call stdlib_linalg_y_cholesky_inplace(c,lower,other_zeroed)
