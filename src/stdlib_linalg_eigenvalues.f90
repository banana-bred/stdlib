...
!! Compute eigenvalues and eigenvectors    
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_standard_x(amat,lambda,err=err)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_standard_x(amat,lambda,overwrite_a=.false.)
     ...
     !! and optionally right or left eigenvectors.        
         ...
         real(xdp), pointer :: amat(:,:),umat(:,:),vmat(:,:)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_generalized_x(amat,bmat,lambda,err=err)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_generalized_x(amat,bmat,lambda,overwrite_a=.false.)
     ...
     !! and optionally right or left eigenvectors.        
         ...
         real(xdp), target :: work_dummy(1),u_dummy(1,1),v_dummy(1,1)
         real(xdp), allocatable :: work(:)
         real(xdp), pointer :: amat(:,:),umat(:,:),vmat(:,:),bmat(:,:)
         real(xdp), pointer :: lreal(:),limag(:)
     ...
     !! Return an array of eigenvalues of real symmetric / complex hermitian A
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eigh_x(amat,lambda,upper_a=upper_a,err=err)
     ...
     !! Return an array of eigenvalues of real symmetric / complex hermitian A        
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eigh_x(amat,lambda,upper_a=upper_a,overwrite_a=.false.)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_standard_y(amat,lambda,err=err)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_standard_y(amat,lambda,overwrite_a=.false.)
     ...
     !! and optionally right or left eigenvectors.        
         ...
         complex(xdp), pointer :: amat(:,:),umat(:,:),vmat(:,:)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_generalized_y(amat,bmat,lambda,err=err)
     ...
     !! Return an array of eigenvalues of matrix A.
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eig_generalized_y(amat,bmat,lambda,overwrite_a=.false.)
     ...
     !! and optionally right or left eigenvectors.        
         ...
         complex(xdp), target :: work_dummy(1),u_dummy(1,1),v_dummy(1,1)
         complex(xdp), allocatable :: work(:)
         complex(xdp), pointer :: amat(:,:),umat(:,:),vmat(:,:),bmat(:,:)
         real(xdp), allocatable :: rwork(:)
     ...
     !! Return an array of eigenvalues of real symmetric / complex hermitian A
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eigh_y(amat,lambda,upper_a=upper_a,err=err)
     ...
     !! Return an array of eigenvalues of real symmetric / complex hermitian A        
         ...
         !> Compute eigenvalues only
         call stdlib_linalg_eigh_y(amat,lambda,upper_a=upper_a,overwrite_a=.false.)
     ...
     module subroutine stdlib_linalg_real_eig_standard_x(a,lambda,right,left, &
      ...
      !! non-trivial imaginary parts.
          ...
          call stdlib_linalg_eig_standard_x(a,clambda,right,left, &
                                                 overwrite_a,err0)          
     ...
     module subroutine stdlib_linalg_real_eig_generalized_x(a,b,lambda,right,left, &
      ...
      !! non-trivial imaginary parts.
          ...
          call stdlib_linalg_eig_generalized_x(a,b,clambda,right,left, &
                                                 overwrite_a,overwrite_b,err0)          
