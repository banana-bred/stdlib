...
module stdlib_intrinsics
    ...
    interface stdlib_sum
        ...
        pure module function stdlib_sum_4d_dim_xdp( x , dim, mask ) result( s )
            ...
            integer, intent(in):: dim
            logical, intent(in), optional :: mask(:,:,:,:)
            real(xdp) :: s(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x, 3),&
                & size(x, 4), mask=3<dim))
        end function
        ...
        pure module function stdlib_sum_4d_dim_cxdp( x , dim, mask ) result( s )
            ...
            integer, intent(in):: dim
            logical, intent(in), optional :: mask(:,:,:,:)
            complex(xdp) :: s(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x,&
                & 3), size(x, 4), mask=3<dim))
        end function
    end interface
    public :: stdlib_sum
    ...
    interface stdlib_dot_product
        ...
        pure module function stdlib_dot_product_xdp(a,b) result(p)
            real(xdp), intent(in) :: a(:)
        ...
        pure module function stdlib_dot_product_cxdp(a,b) result(p)
            complex(xdp), intent(in) :: a(:)
    ...
    interface stdlib_dot_product_kahan
        ...
        pure module function stdlib_dot_product_kahan_xdp(a,b) result(p)
            real(xdp), intent(in) :: a(:)
            real(xdp), intent(in) :: b(:)
            real(xdp) :: p
        end function
        ...
        pure module function stdlib_dot_product_kahan_cxdp(a,b) result(p)
            complex(xdp), intent(in) :: a(:)
            complex(xdp), intent(in) :: b(:)
            complex(xdp) :: p
        end function
    ...
    interface kahan_kernel 
        ...
        module procedure :: kahan_kernel_xdp
        module procedure :: kahan_kernel_m_xdp
        ...
        module procedure :: kahan_kernel_cxdp
        module procedure :: kahan_kernel_m_cxdp
    end interface
    public :: kahan_kernel
...
elemental subroutine kahan_kernel_xdp(a,s,c)
    real(xdp), intent(in) :: a
...
elemental subroutine kahan_kernel_m_xdp(a,s,c,m)
    real(xdp), intent(in) :: a
    real(xdp), intent(inout) :: s
    real(xdp), intent(inout) :: c
    logical, intent(in) :: m
...
elemental subroutine kahan_kernel_cxdp(a,s,c)
    complex(xdp), intent(in) :: a
    complex(xdp), intent(inout) :: s
...
elemental subroutine kahan_kernel_m_cxdp(a,s,c,m)
    complex(xdp), intent(in) :: a
    complex(xdp), intent(inout) :: s
    complex(xdp), intent(inout) :: c
    logical, intent(in) :: m
