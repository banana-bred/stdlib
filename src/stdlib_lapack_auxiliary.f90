submodule(stdlib_lapack_base) stdlib_lapack_auxiliary
  ...
  contains
     ...
     !! DLAMCH: determines quad precision machine parameters.
        ...
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           use stdlib_blas_constants_xdp, only: zero, one, eps
           ! Scalar Arguments 
           character, intent(in) :: cmach
       ! =====================================================================
           
           ! Local Scalars 
           real(xdp) :: sfmin, small, rmach
           ! Intrinsic Functions 
           ! Executable Statements 
           ! assume rounding, not chopping. always.
           if( stdlib_lsame( cmach, 'E' ) ) then
     ...
     !! The change is to use the 'genuine' absolute value.
        ...
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           use stdlib_blas_constants_xdp, only: zero
           ! Scalar Arguments 
           integer(ilp), intent(in) :: incx, n
           ! Array Arguments 
     ...
     pure module subroutine stdlib_xladiv1( a, b, c, d, p, q )
        ...
        ! =====================================================================
           ...
           r = d / c
           t = one / (c + d * r)
           p = stdlib_xladiv2(a, b, c, d, r, t)
           a = -a
           q = stdlib_xladiv2(b, a, c, d, r, t)
           return
     ...
     pure real(xdp) module function stdlib_xladiv2( a, b, c, d, r, t )
        ...
        ! =====================================================================
           ...
           if( r/=zero ) then
              br = b * r
              if( br/=zero ) then
                 stdlib_xladiv2 = (a + br) * t
              else
                 stdlib_xladiv2 = a * t + (b * t) * r
              end if
           else
              stdlib_xladiv2 = (a + d * (b / c)) * t
           end if
           return
     ...
     !! factors in the vector S.
        ...
        ! =====================================================================
           ...
           ! initialize large and small.
           small = stdlib_I64_xlamch( 'SAFE MINIMUM' ) / stdlib_I64_xlamch( 'PRECISION' )
           large = one / small
           if( scond>=thresh .and. amax>=small .and. amax<=large ) then
              ! no equilibration
              equed = 'N'
     ...
     !! factors in the vector S.
        ...
        ! =====================================================================
           ...
           ! initialize large and small.
           small = stdlib_I64_qlamch( 'SAFE MINIMUM' ) / stdlib_I64_qlamch( 'PRECISION' )
           large = one / small
           if( scond>=thresh .and. amax>=small .and. amax<=large ) then
              ! no equilibration
              equed = 'N'
     ...
     pure module subroutine stdlib_I64_xladiv1( a, b, c, d, p, q )
        ...
        ! =====================================================================
           ...
           r = d / c
           t = one / (c + d * r)
           p = stdlib_I64_xladiv2(a, b, c, d, r, t)
           a = -a
           q = stdlib_I64_xladiv2(b, a, c, d, r, t)
           return
     ...
     pure module subroutine stdlib_I64_qladiv1( a, b, c, d, p, q )
        ...
        ! =====================================================================
           ...
           r = d / c
           t = one / (c + d * r)
           p = stdlib_I64_qladiv2(a, b, c, d, r, t)
           a = -a
           q = stdlib_I64_qladiv2(b, a, c, d, r, t)
           return
     ...
     pure real(xdp) module function stdlib_I64_xladiv2( a, b, c, d, r, t )
        ...
        ! =====================================================================
           ...
           if( r/=zero ) then
              br = b * r
              if( br/=zero ) then
                 stdlib_I64_xladiv2 = (a + br) * t
              else
                 stdlib_I64_xladiv2 = a * t + (b * t) * r
              end if
           else
              stdlib_I64_xladiv2 = (a + d * (b / c)) * t
           end if
           return
     ...
     pure real(qp) module function stdlib_I64_qladiv2( a, b, c, d, r, t )
        ...
        ! =====================================================================
           ...
           if( r/=zero ) then
              br = b * r
              if( br/=zero ) then
                 stdlib_I64_qladiv2 = (a + br) * t
              else
                 stdlib_I64_qladiv2 = a * t + (b * t) * r
              end if
           else
              stdlib_I64_qladiv2 = (a + d * (b / c)) * t
           end if
           return
