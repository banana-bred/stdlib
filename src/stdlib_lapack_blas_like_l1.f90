submodule(stdlib_lapack_base) stdlib_lapack_blas_like_l1
  ...
  contains
     ...
     !! HUGE     -- biggest representable number.
        ...
        ! -- lapack is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
           use stdlib_blas_constants_xdp, only: zero, half, one, two, tbig, tsml, ssml, sbig
        ! Scalar Arguments 
     integer(ilp), intent(in) :: incx, n
     ...
     !! the final result x/a does not overflow or underflow.
       ...
       ! =====================================================================
           ...
           ! scale the vector x by mul
           call stdlib_xscal( n, mul, sx, incx )
           if( .not.done )go to 10
           return
     ...
     !! the final result x/a does not overflow or underflow.
       ...
       ! =====================================================================
           ...
           ! scale the vector x by mul
           call stdlib_ydscal( n, mul, sx, incx )
           if( .not.done )go to 10
           return
     ...
     !! the final result x/a does not overflow or underflow.
       ...
       ! =====================================================================
           ...
           ! scale the vector x by mul
           call stdlib_I64_xscal( n, mul, sx, incx )
           if( .not.done )go to 10
           return
     ...
     !! the final result x/a does not overflow or underflow.
       ...
       ! =====================================================================
           ...
           ! scale the vector x by mul
           call stdlib_I64_qscal( n, mul, sx, incx )
           if( .not.done )go to 10
           return
     ...
     !! the final result x/a does not overflow or underflow.
       ...
       ! =====================================================================
           ...
           ! scale the vector x by mul
           call stdlib_I64_ydscal( n, mul, sx, incx )
           if( .not.done )go to 10
           return
     ...
     !! the final result x/a does not overflow or underflow.
       ...
       ! =====================================================================
           ...
           ! scale the vector x by mul
           call stdlib_I64_wdscal( n, mul, sx, incx )
           if( .not.done )go to 10
           return
