...
module stdlib_str2num
    ...
    interface to_num_from_stream
        ...
        module procedure to_xdp_from_stream
    ...
    function to_xdp_from_stream(s,mold,stat) result(v)
        ! -- In/out Variables
        character(len=:), pointer :: s !! input string
        real(xdp), intent(in) :: mold !! dummy argument to disambiguate at compile time the generic interface
        real(xdp) :: v !! Output real(xdp) value
