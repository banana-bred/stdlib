module stdlib_linalg_blas_aux
     ...
     interface stdlib_cabs1
        ...
        module procedure stdlib_xcabs1
     ...
     pure elemental real(xdp) function stdlib_xcabs1(z)
     !! DCABS1 computes |Re(.)| + |Im(.)| of a double complex number
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ! Intrinsic Functions 
           intrinsic :: abs,real,aimag
           stdlib_xcabs1 = abs(real(z,KIND=xdp)) + abs(aimag(z))
           return
     end function stdlib_xcabs1
     ...
     pure integer(ilp) function stdlib_ixamax(n,dx,incx) result(iamax)
     !! IDAMAX: finds the index of the first element having maximum absolute value.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure integer(ilp) function stdlib_iyamax(n,zx,incx) result(iamax)
     !! IZAMAX: finds the index of the first element having maximum |Re(.)| + |Im(.)|
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure integer(ilp64) function stdlib_I64_ixamax(n,dx,incx) result(iamax)
     !! IDAMAX: finds the index of the first element having maximum absolute value.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           return
     end function stdlib_I64_ixamax
     
     pure integer(ilp64) function stdlib_I64_iqamax(n,dx,incx) result(iamax)
     !! IDAMAX: finds the index of the first element having maximum absolute value.
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           return
     end function stdlib_I64_iqamax
     ...
     pure integer(ilp64) function stdlib_I64_iyamax(n,zx,incx) result(iamax)
     !! IZAMAX: finds the index of the first element having maximum |Re(.)| + |Im(.)|
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           return
     end function stdlib_I64_iyamax
     
     pure integer(ilp64) function stdlib_I64_iwamax(n,zx,incx) result(iamax)
     !! IZAMAX: finds the index of the first element having maximum |Re(.)| + |Im(.)|
        ! -- reference blas level1 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           return
     end function stdlib_I64_iwamax
