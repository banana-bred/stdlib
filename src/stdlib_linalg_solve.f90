...
!! Solve linear system Ax=b
     ...
     module function stdlib_linalg_x_solve_one(a,b,overwrite_a,err) result(x)
         ...
         call stdlib_linalg_x_solve_lu_one(a,b,x,overwrite_a=overwrite_a,err=err)
     ...
     pure module function stdlib_linalg_x_pure_solve_one(a,b) result(x)
         ...
         call stdlib_linalg_x_solve_lu_one(amat,b,x,overwrite_a=.true.)
     ...
     module function stdlib_linalg_y_solve_one(a,b,overwrite_a,err) result(x)
         ...
         call stdlib_linalg_y_solve_lu_one(a,b,x,overwrite_a=overwrite_a,err=err)
     ...
     pure module function stdlib_linalg_y_pure_solve_one(a,b) result(x)
         ...
         call stdlib_linalg_y_solve_lu_one(amat,b,x,overwrite_a=.true.)
     ...
     module function stdlib_linalg_x_solve_many(a,b,overwrite_a,err) result(x)
         ...
         call stdlib_linalg_x_solve_lu_many(a,b,x,overwrite_a=overwrite_a,err=err)
     ...
     pure module function stdlib_linalg_x_pure_solve_many(a,b) result(x)
         ...
         call stdlib_linalg_x_solve_lu_many(amat,b,x,overwrite_a=.true.)
     ...
     module function stdlib_linalg_y_solve_many(a,b,overwrite_a,err) result(x)
         ...
         call stdlib_linalg_y_solve_lu_many(a,b,x,overwrite_a=overwrite_a,err=err)
     ...
     pure module function stdlib_linalg_y_pure_solve_many(a,b) result(x)
         ...
         call stdlib_linalg_y_solve_lu_many(amat,b,x,overwrite_a=.true.)
