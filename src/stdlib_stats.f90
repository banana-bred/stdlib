module stdlib_stats
  ...
  interface cov
    ...
    !! ([Specification](../page/specs/stdlib_stats.html#cov-covariance-of-array-elements))
      ...
      module function cov_1_rxdp_rxdp(x, dim, mask, corrected) result(res)
        real(xdp), intent(in) :: x(:)
        integer, intent(in) :: dim
        logical, intent(in), optional :: mask
        logical, intent(in), optional :: corrected
        real(xdp) :: res
      end function cov_1_rxdp_rxdp
      ...
      module function cov_1_cxdp_cxdp(x, dim, mask, corrected) result(res)
        complex(xdp), intent(in) :: x(:)
        integer, intent(in) :: dim
        logical, intent(in), optional :: mask
        logical, intent(in), optional :: corrected
        real(xdp) :: res
      end function cov_1_cxdp_cxdp
      ...
      module function cov_mask_1_rxdp_rxdp(x, dim, mask, corrected) result(res)
        real(xdp), intent(in) :: x(:)
        integer, intent(in) :: dim
        logical, intent(in) :: mask(:)
        logical, intent(in), optional :: corrected
        real(xdp) :: res
      end function cov_mask_1_rxdp_rxdp
      ...
      module function cov_mask_1_cxdp_cxdp(x, dim, mask, corrected) result(res)
        complex(xdp), intent(in) :: x(:)
        integer, intent(in) :: dim
        logical, intent(in) :: mask(:)
        logical, intent(in), optional :: corrected
        real(xdp) :: res
      end function cov_mask_1_cxdp_cxdp
      ...
      module function cov_2_rxdp_rxdp(x, dim, mask, corrected) result(res)
        real(xdp), intent(in) :: x(:, :)
        integer, intent(in) :: dim
        logical, intent(in), optional :: mask
        logical, intent(in), optional :: corrected
      ...
      module function cov_2_cxdp_cxdp(x, dim, mask, corrected) result(res)
        complex(xdp), intent(in) :: x(:, :)
        integer, intent(in) :: dim
        logical, intent(in), optional :: mask
        logical, intent(in), optional :: corrected
      ...
      module function cov_mask_2_rxdp_rxdp(x, dim, mask, corrected) result(res)
        real(xdp), intent(in) :: x(:, :)
        integer, intent(in) :: dim
        logical, intent(in) :: mask(:,:)
        logical, intent(in), optional :: corrected
        real(xdp) :: res(merge(size(x, 1), size(x, 2), mask = 1<dim)&
                            , merge(size(x, 1), size(x, 2), mask = 1<dim))
      end function cov_mask_2_rxdp_rxdp
      ...
      module function cov_mask_2_cxdp_cxdp(x, dim, mask, corrected) result(res)
        complex(xdp), intent(in) :: x(:, :)
        integer, intent(in) :: dim
        logical, intent(in) :: mask(:,:)
        logical, intent(in), optional :: corrected
        complex(xdp) :: res(merge(size(x, 1), size(x, 2), mask = 1<dim)&
                            , merge(size(x, 1), size(x, 2), mask = 1<dim))
      end function cov_mask_2_cxdp_cxdp
  ...
  interface mean
    ...
    !! ([Specification](../page/specs/stdlib_stats.html#mean-mean-of-array-elements))
        ...
        module function mean_all_1_rxdp_rxdp (x, mask) result(res)
          real(xdp), intent(in) :: x(:)
          logical, intent(in), optional :: mask
          real(xdp) :: res
        end function mean_all_1_rxdp_rxdp
        module function mean_all_2_rxdp_rxdp (x, mask) result(res)
          real(xdp), intent(in) :: x(:,:)
          logical, intent(in), optional :: mask
          real(xdp) :: res
        end function mean_all_2_rxdp_rxdp
        module function mean_all_3_rxdp_rxdp (x, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          logical, intent(in), optional :: mask
          real(xdp) :: res
        end function mean_all_3_rxdp_rxdp
        module function mean_all_4_rxdp_rxdp (x, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          logical, intent(in), optional :: mask
          real(xdp) :: res
        end function mean_all_4_rxdp_rxdp
        ...
        module function mean_all_1_cxdp_cxdp (x, mask) result(res)
          complex(xdp), intent(in) :: x(:)
          logical, intent(in), optional :: mask
          complex(xdp) :: res
        end function mean_all_1_cxdp_cxdp
        module function mean_all_2_cxdp_cxdp (x, mask) result(res)
          complex(xdp), intent(in) :: x(:,:)
          logical, intent(in), optional :: mask
          complex(xdp) :: res
        end function mean_all_2_cxdp_cxdp
        module function mean_all_3_cxdp_cxdp (x, mask) result(res)
          complex(xdp), intent(in) :: x(:,:,:)
          logical, intent(in), optional :: mask
          complex(xdp) :: res
        end function mean_all_3_cxdp_cxdp
        module function mean_all_4_cxdp_cxdp (x, mask) result(res)
          complex(xdp), intent(in) :: x(:,:,:,:)
          logical, intent(in), optional :: mask
          complex(xdp) :: res
        end function mean_all_4_cxdp_cxdp
        ...
        module function mean_1_rxdp_rxdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          real(xdp) :: res
        end function mean_1_rxdp_rxdp
        module function mean_2_rxdp_rxdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function mean_2_rxdp_rxdp
        module function mean_3_rxdp_rxdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function mean_3_rxdp_rxdp
        module function mean_4_rxdp_rxdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x, 3),&
              & size(x, 4), mask=3<dim))
        end function mean_4_rxdp_rxdp
        ...
        module function mean_1_cxdp_cxdp(x, dim, mask) result(res)
          complex(xdp), intent(in) :: x(:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          complex(xdp) :: res
        end function mean_1_cxdp_cxdp
        module function mean_2_cxdp_cxdp(x, dim, mask) result(res)
          complex(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          complex(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function mean_2_cxdp_cxdp
        module function mean_3_cxdp_cxdp(x, dim, mask) result(res)
          complex(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          complex(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function mean_3_cxdp_cxdp
        module function mean_4_cxdp_cxdp(x, dim, mask) result(res)
          complex(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          complex(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x,&
              & 3), size(x, 4), mask=3<dim))
        end function mean_4_cxdp_cxdp
        ...
        module function mean_mask_all_1_rxdp_rxdp(x, mask) result(res)
          real(xdp), intent(in) :: x(:)
          logical, intent(in) :: mask(:)
          real(xdp) :: res
          end function mean_mask_all_1_rxdp_rxdp
        module function mean_mask_all_2_rxdp_rxdp(x, mask) result(res)
          real(xdp), intent(in) :: x(:,:)
          logical, intent(in) :: mask(:,:)
          real(xdp) :: res
          end function mean_mask_all_2_rxdp_rxdp
        module function mean_mask_all_3_rxdp_rxdp(x, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          logical, intent(in) :: mask(:,:,:)
          real(xdp) :: res
          end function mean_mask_all_3_rxdp_rxdp
        module function mean_mask_all_4_rxdp_rxdp(x, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          logical, intent(in) :: mask(:,:,:,:)
          real(xdp) :: res
          end function mean_mask_all_4_rxdp_rxdp
        ...
        module function mean_mask_all_1_cxdp_cxdp(x, mask) result(res)
          complex(xdp), intent(in) :: x(:)
          logical, intent(in) :: mask(:)
          complex(xdp) :: res
          end function mean_mask_all_1_cxdp_cxdp
        module function mean_mask_all_2_cxdp_cxdp(x, mask) result(res)
          complex(xdp), intent(in) :: x(:,:)
          logical, intent(in) :: mask(:,:)
          complex(xdp) :: res
          end function mean_mask_all_2_cxdp_cxdp
        module function mean_mask_all_3_cxdp_cxdp(x, mask) result(res)
          complex(xdp), intent(in) :: x(:,:,:)
          logical, intent(in) :: mask(:,:,:)
          complex(xdp) :: res
          end function mean_mask_all_3_cxdp_cxdp
        module function mean_mask_all_4_cxdp_cxdp(x, mask) result(res)
          complex(xdp), intent(in) :: x(:,:,:,:)
          logical, intent(in) :: mask(:,:,:,:)
          complex(xdp) :: res
          end function mean_mask_all_4_cxdp_cxdp
        ...
        module function mean_mask_1_rxdp_rxdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:)
          real(xdp) :: res
        end function mean_mask_1_rxdp_rxdp
        module function mean_mask_2_rxdp_rxdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:)
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function mean_mask_2_rxdp_rxdp
        module function mean_mask_3_rxdp_rxdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:,:)
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function mean_mask_3_rxdp_rxdp
        module function mean_mask_4_rxdp_rxdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:,:,:)
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x, 3),&
              & size(x, 4), mask=3<dim))
        end function mean_mask_4_rxdp_rxdp
        ...
        module function mean_mask_1_cxdp_cxdp(x, dim, mask) result(res)
          complex(xdp), intent(in) :: x(:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:)
          complex(xdp) :: res
        end function mean_mask_1_cxdp_cxdp
        module function mean_mask_2_cxdp_cxdp(x, dim, mask) result(res)
          complex(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:)
          complex(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function mean_mask_2_cxdp_cxdp
        module function mean_mask_3_cxdp_cxdp(x, dim, mask) result(res)
          complex(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:,:)
          complex(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function mean_mask_3_cxdp_cxdp
        module function mean_mask_4_cxdp_cxdp(x, dim, mask) result(res)
          complex(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:,:,:)
          complex(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x,&
              & 3), size(x, 4), mask=3<dim))
        end function mean_mask_4_cxdp_cxdp
  ...
  interface median
    ...
    !! ([Specification](../page/specs/stdlib_stats.html#median-median-of-array-elements))
        ...
        module function median_all_1_rxdp_xdp (x, mask) result(res)
          real(xdp), intent(in) :: x(:)
          logical, intent(in), optional :: mask
          real(xdp) :: res
        end function median_all_1_rxdp_xdp
        module function median_all_2_rxdp_xdp (x, mask) result(res)
          real(xdp), intent(in) :: x(:,:)
          logical, intent(in), optional :: mask
          real(xdp) :: res
        end function median_all_2_rxdp_xdp
        module function median_all_3_rxdp_xdp (x, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          logical, intent(in), optional :: mask
          real(xdp) :: res
        end function median_all_3_rxdp_xdp
        module function median_all_4_rxdp_xdp (x, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          logical, intent(in), optional :: mask
          real(xdp) :: res
        end function median_all_4_rxdp_xdp
        ...
        module function median_1_rxdp_xdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          real(xdp) :: res
        end function median_1_rxdp_xdp
        module function median_2_rxdp_xdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function median_2_rxdp_xdp
        module function median_3_rxdp_xdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function median_3_rxdp_xdp
        module function median_4_rxdp_xdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x, 3),&
              & size(x, 4), mask=3<dim))
        end function median_4_rxdp_xdp
        ...
        module function median_all_mask_1_rxdp_xdp(x, mask) result(res)
          real(xdp), intent(in) :: x(:)
          logical, intent(in) :: mask(:)
          real(xdp) :: res
        end function median_all_mask_1_rxdp_xdp
        module function median_all_mask_2_rxdp_xdp(x, mask) result(res)
          real(xdp), intent(in) :: x(:,:)
          logical, intent(in) :: mask(:,:)
          real(xdp) :: res
        end function median_all_mask_2_rxdp_xdp
        module function median_all_mask_3_rxdp_xdp(x, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          logical, intent(in) :: mask(:,:,:)
          real(xdp) :: res
        end function median_all_mask_3_rxdp_xdp
        module function median_all_mask_4_rxdp_xdp(x, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          logical, intent(in) :: mask(:,:,:,:)
          real(xdp) :: res
        end function median_all_mask_4_rxdp_xdp
        ...
        module function  median_mask_1_rxdp_xdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:)
          real(xdp) :: res
        end function median_mask_1_rxdp_xdp
        module function  median_mask_2_rxdp_xdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:)
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function median_mask_2_rxdp_xdp
        module function  median_mask_3_rxdp_xdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:,:)
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function median_mask_3_rxdp_xdp
        module function  median_mask_4_rxdp_xdp(x, dim, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:,:,:)
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x, 3),&
              & size(x, 4), mask=3<dim))
        end function median_mask_4_rxdp_xdp
  ...
  interface var
    ...
    !! ([Specification](../page/specs/stdlib_stats.html#var-variance-of-array-elements))
        ...
        module function var_all_1_rxdp_rxdp(x, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:)
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_all_1_rxdp_rxdp
        module function var_all_2_rxdp_rxdp(x, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:)
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_all_2_rxdp_rxdp
        module function var_all_3_rxdp_rxdp(x, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_all_3_rxdp_rxdp
        module function var_all_4_rxdp_rxdp(x, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_all_4_rxdp_rxdp
        ...
        module function var_all_1_cxdp_cxdp(x, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:)
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_all_1_cxdp_cxdp
        module function var_all_2_cxdp_cxdp(x, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:)
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_all_2_cxdp_cxdp
        module function var_all_3_cxdp_cxdp(x, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:,:)
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_all_3_cxdp_cxdp
        module function var_all_4_cxdp_cxdp(x, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:,:,:)
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_all_4_cxdp_cxdp
        ...
        module function var_1_rxdp_rxdp(x, dim, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_1_rxdp_rxdp
        module function var_2_rxdp_rxdp(x, dim, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function var_2_rxdp_rxdp
        module function var_3_rxdp_rxdp(x, dim, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function var_3_rxdp_rxdp
        module function var_4_rxdp_rxdp(x, dim, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
        ...
        module function var_1_cxdp_cxdp(x, dim, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_1_cxdp_cxdp
        module function var_2_cxdp_cxdp(x, dim, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function var_2_cxdp_cxdp
        module function var_3_cxdp_cxdp(x, dim, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function var_3_cxdp_cxdp
        module function var_4_cxdp_cxdp(x, dim, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: dim
          logical, intent(in), optional :: mask
          logical, intent(in), optional :: corrected
        ...
        module function var_mask_all_1_rxdp_rxdp(x, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:)
          logical, intent(in) :: mask(:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_mask_all_1_rxdp_rxdp
        module function var_mask_all_2_rxdp_rxdp(x, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:)
          logical, intent(in) :: mask(:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_mask_all_2_rxdp_rxdp
        module function var_mask_all_3_rxdp_rxdp(x, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          logical, intent(in) :: mask(:,:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_mask_all_3_rxdp_rxdp
        module function var_mask_all_4_rxdp_rxdp(x, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          logical, intent(in) :: mask(:,:,:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_mask_all_4_rxdp_rxdp
        ...
        module function var_mask_all_1_cxdp_cxdp(x, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:)
          logical, intent(in) :: mask(:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_mask_all_1_cxdp_cxdp
        module function var_mask_all_2_cxdp_cxdp(x, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:)
          logical, intent(in) :: mask(:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_mask_all_2_cxdp_cxdp
        module function var_mask_all_3_cxdp_cxdp(x, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:,:)
          logical, intent(in) :: mask(:,:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_mask_all_3_cxdp_cxdp
        module function var_mask_all_4_cxdp_cxdp(x, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:,:,:)
          logical, intent(in) :: mask(:,:,:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_mask_all_4_cxdp_cxdp
        ...
        module function var_mask_1_rxdp_rxdp(x, dim, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_mask_1_rxdp_rxdp
        module function var_mask_2_rxdp_rxdp(x, dim, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function var_mask_2_rxdp_rxdp
        module function var_mask_3_rxdp_rxdp(x, dim, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function var_mask_3_rxdp_rxdp
        module function var_mask_4_rxdp_rxdp(x, dim, mask, corrected) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:,:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x, 3),&
              & size(x, 4), mask=3<dim))
        end function var_mask_4_rxdp_rxdp
        ...
        module function var_mask_1_cxdp_cxdp(x, dim, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res
        end function var_mask_1_cxdp_cxdp
        module function var_mask_2_cxdp_cxdp(x, dim, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function var_mask_2_cxdp_cxdp
        module function var_mask_3_cxdp_cxdp(x, dim, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function var_mask_3_cxdp_cxdp
        module function var_mask_4_cxdp_cxdp(x, dim, mask, corrected) result(res)
          complex(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: dim
          logical, intent(in) :: mask(:,:,:,:)
          logical, intent(in), optional :: corrected
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x, 3),&
              & size(x, 4), mask=3<dim))
        end function var_mask_4_cxdp_cxdp
  ...
  interface moment
    ...
    !! ([Specification](../page/specs/stdlib_stats.html#moment-central-moments-of-array-elements))
        ...
        module function moment_mask_1_rxdp_rxdp(x, order, dim, center, mask) result(res)
          real(xdp), intent(in) :: x(:)
          integer, intent(in) :: order
          integer, intent(in) :: dim
          real(xdp), intent(in), optional :: center
          logical, intent(in) :: mask(:)
          real(xdp) :: res
        end function moment_mask_1_rxdp_rxdp
        module function moment_mask_2_rxdp_rxdp(x, order, dim, center, mask) result(res)
          real(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: order
          integer, intent(in) :: dim
          real(xdp), intent(in), optional :: center(merge(size(x, 1), size(x, 2), mask=1<dim))
          logical, intent(in) :: mask(:,:)
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function moment_mask_2_rxdp_rxdp
        module function moment_mask_3_rxdp_rxdp(x, order, dim, center, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: order
          integer, intent(in) :: dim
          real(xdp), intent(in), optional :: center(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3),&
          ...
          logical, intent(in) :: mask(:,:,:)
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function moment_mask_3_rxdp_rxdp
        module function moment_mask_4_rxdp_rxdp(x, order, dim, center, mask) result(res)
          real(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: order
          integer, intent(in) :: dim
          real(xdp), intent(in), optional :: center(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3),&
          ...
          real(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x, 3),&
              & size(x, 4), mask=3<dim))
        end function moment_mask_4_rxdp_rxdp
        ...
        module function moment_mask_1_cxdp_cxdp(x, order, dim, center, mask) result(res)
          complex(xdp), intent(in) :: x(:)
          integer, intent(in) :: order
          integer, intent(in) :: dim
          complex(xdp), intent(in), optional :: center
          logical, intent(in) :: mask(:)
          complex(xdp) :: res
        end function moment_mask_1_cxdp_cxdp
        module function moment_mask_2_cxdp_cxdp(x, order, dim, center, mask) result(res)
          complex(xdp), intent(in) :: x(:,:)
          integer, intent(in) :: order
          integer, intent(in) :: dim
          complex(xdp), intent(in), optional :: center(merge(size(x, 1), size(x, 2), mask=1<dim))
          logical, intent(in) :: mask(:,:)
          complex(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim))
        end function moment_mask_2_cxdp_cxdp
        module function moment_mask_3_cxdp_cxdp(x, order, dim, center, mask) result(res)
          complex(xdp), intent(in) :: x(:,:,:)
          integer, intent(in) :: order
          integer, intent(in) :: dim
          complex(xdp), intent(in), optional :: center(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3),&
          ...
          logical, intent(in) :: mask(:,:,:)
          complex(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim))
        end function moment_mask_3_cxdp_cxdp
        module function moment_mask_4_cxdp_cxdp(x, order, dim, center, mask) result(res)
          complex(xdp), intent(in) :: x(:,:,:,:)
          integer, intent(in) :: order
          integer, intent(in) :: dim
          complex(xdp), intent(in), optional :: center(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3),&
          ...
          complex(xdp) :: res(merge(size(x, 1), size(x, 2), mask=1<dim), merge(size(x, 2), size(x, 3), mask=2<dim), merge(size(x,&
              & 3), size(x, 4), mask=3<dim))
        end function moment_mask_4_cxdp_cxdp
