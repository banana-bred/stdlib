...
module stdlib_sparse_spmv
    ...
    interface spmv
        ...
        module procedure :: spmv_coo_1d_xdp
        module procedure :: spmv_csr_1d_xdp
        module procedure :: spmv_csc_1d_xdp
        module procedure :: spmv_ell_1d_xdp
        module procedure :: spmv_coo_2d_xdp
        module procedure :: spmv_csr_2d_xdp
        module procedure :: spmv_csc_2d_xdp
        module procedure :: spmv_ell_2d_xdp
        module procedure :: spmv_sellc_xdp
        ...
        module procedure :: spmv_coo_1d_cxdp
        module procedure :: spmv_csr_1d_cxdp
        module procedure :: spmv_csc_1d_cxdp
        module procedure :: spmv_ell_1d_cxdp
        module procedure :: spmv_coo_2d_cxdp
        module procedure :: spmv_csr_2d_cxdp
        module procedure :: spmv_csc_2d_cxdp
        module procedure :: spmv_ell_2d_cxdp
        module procedure :: spmv_sellc_cxdp
    end interface
    public :: spmv
...
contains
    ...
    subroutine spmv_coo_1d_xdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(COO_xdp_type), intent(in) :: matrix
        real(xdp), intent(in)    :: vec_x(:)
        real(xdp), intent(inout) :: vec_y(:)
        real(xdp), intent(in), optional :: alpha
        real(xdp), intent(in), optional :: beta
        character(1), intent(in), optional :: op
        real(xdp) :: alpha_
        character(1) :: op_
        integer(ilp) :: k, ik, jk
    ...
    subroutine spmv_coo_2d_xdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(COO_xdp_type), intent(in) :: matrix
        real(xdp), intent(in)    :: vec_x(:,:)
        real(xdp), intent(inout) :: vec_y(:,:)
        real(xdp), intent(in), optional :: alpha
    ...
    subroutine spmv_coo_1d_cxdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(COO_cxdp_type), intent(in) :: matrix
        complex(xdp), intent(in)    :: vec_x(:)
        complex(xdp), intent(inout) :: vec_y(:)
        complex(xdp), intent(in), optional :: alpha
        complex(xdp), intent(in), optional :: beta
        character(1), intent(in), optional :: op
        complex(xdp) :: alpha_
        character(1) :: op_
        integer(ilp) :: k, ik, jk
    ...
    subroutine spmv_coo_2d_cxdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(COO_cxdp_type), intent(in) :: matrix
        complex(xdp), intent(in)    :: vec_x(:,:)
        complex(xdp), intent(inout) :: vec_y(:,:)
        complex(xdp), intent(in), optional :: alpha
    ...
    subroutine spmv_csr_1d_xdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSR_xdp_type), intent(in) :: matrix
        real(xdp), intent(in)    :: vec_x(:)
        real(xdp), intent(inout) :: vec_y(:)
        real(xdp), intent(in), optional :: alpha
        real(xdp), intent(in), optional :: beta
    ...
    subroutine spmv_csr_2d_xdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSR_xdp_type), intent(in) :: matrix
        real(xdp), intent(in)    :: vec_x(:,:)
        real(xdp), intent(inout) :: vec_y(:,:)
        real(xdp), intent(in), optional :: alpha
        ...
        character(1) :: op_
        integer(ilp) :: i, j
        real(xdp) :: aux(size(vec_x,dim=1)), aux2(size(vec_x,dim=1))
    ...
    subroutine spmv_csr_1d_cxdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSR_cxdp_type), intent(in) :: matrix
        complex(xdp), intent(in)    :: vec_x(:)
        complex(xdp), intent(inout) :: vec_y(:)
        complex(xdp), intent(in), optional :: alpha
        complex(xdp), intent(in), optional :: beta
    ...
    subroutine spmv_csr_2d_cxdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSR_cxdp_type), intent(in) :: matrix
        complex(xdp), intent(in)    :: vec_x(:,:)
        complex(xdp), intent(inout) :: vec_y(:,:)
        complex(xdp), intent(in), optional :: alpha
        ...
        character(1) :: op_
        integer(ilp) :: i, j
        complex(xdp) :: aux(size(vec_x,dim=1)), aux2(size(vec_x,dim=1))
    ...
    subroutine spmv_csc_1d_xdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSC_xdp_type), intent(in) :: matrix
        real(xdp), intent(in)    :: vec_x(:)
        real(xdp), intent(inout) :: vec_y(:)
        real(xdp), intent(in), optional :: alpha
        real(xdp), intent(in), optional :: beta
    ...
    subroutine spmv_csc_2d_xdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSC_xdp_type), intent(in) :: matrix
        real(xdp), intent(in)    :: vec_x(:,:)
        real(xdp), intent(inout) :: vec_y(:,:)
        real(xdp), intent(in), optional :: alpha
    ...
    subroutine spmv_csc_1d_cxdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSC_cxdp_type), intent(in) :: matrix
        complex(xdp), intent(in)    :: vec_x(:)
        complex(xdp), intent(inout) :: vec_y(:)
        complex(xdp), intent(in), optional :: alpha
        complex(xdp), intent(in), optional :: beta
    ...
    subroutine spmv_csc_2d_cxdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(CSC_cxdp_type), intent(in) :: matrix
        complex(xdp), intent(in)    :: vec_x(:,:)
        complex(xdp), intent(inout) :: vec_y(:,:)
        complex(xdp), intent(in), optional :: alpha
        ...
        character(1) :: op_
        integer(ilp) :: i, j
        complex(xdp) :: aux(size(vec_x,dim=1))
    ...
    subroutine spmv_ell_1d_xdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(ELL_xdp_type), intent(in) :: matrix
        real(xdp), intent(in)    :: vec_x(:)
        real(xdp), intent(inout) :: vec_y(:)
        real(xdp), intent(in), optional :: alpha
        real(xdp), intent(in), optional :: beta
    ...
    subroutine spmv_ell_2d_xdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(ELL_xdp_type), intent(in) :: matrix
        real(xdp), intent(in)    :: vec_x(:,:)
        real(xdp), intent(inout) :: vec_y(:,:)
        real(xdp), intent(in), optional :: alpha
    ...
    subroutine spmv_ell_1d_cxdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(ELL_cxdp_type), intent(in) :: matrix
        complex(xdp), intent(in)    :: vec_x(:)
        complex(xdp), intent(inout) :: vec_y(:)
        complex(xdp), intent(in), optional :: alpha
        complex(xdp), intent(in), optional :: beta
    ...
    subroutine spmv_ell_2d_cxdp(matrix,vec_x,vec_y,alpha,beta,op)
        type(ELL_cxdp_type), intent(in) :: matrix
        complex(xdp), intent(in)    :: vec_x(:,:)
        complex(xdp), intent(inout) :: vec_y(:,:)
        complex(xdp), intent(in), optional :: alpha
    ...
    subroutine spmv_sellc_xdp(matrix,vec_x,vec_y,alpha,beta,op)
        !! This algorithm was gracefully provided by Ivan Privec and adapted by Jose Alves
        type(SELLC_xdp_type), intent(in) :: matrix
        real(xdp), intent(in)    :: vec_x(:)
        real(xdp), intent(inout) :: vec_y(:)
        real(xdp), intent(in), optional :: alpha
        real(xdp), intent(in), optional :: beta
    ...
    contains
        pure subroutine chunk_kernel_4(n,a,col,x,y)
            integer, value      :: n
            real(xdp), intent(in)  :: a(4,n), x(:)
            integer(ilp), intent(in) :: col(4,n)
            real(xdp), intent(inout) :: y(4)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_8(n,a,col,x,y)
            integer, value      :: n
            real(xdp), intent(in)  :: a(8,n), x(:)
            integer(ilp), intent(in) :: col(8,n)
            real(xdp), intent(inout) :: y(8)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_16(n,a,col,x,y)
            integer, value      :: n
            real(xdp), intent(in)  :: a(16,n), x(:)
            integer(ilp), intent(in) :: col(16,n)
            real(xdp), intent(inout) :: y(16)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_trans_16(n,a,col,x,y)
            integer, value      :: n
            real(xdp), intent(in)  :: a(16,n), x(16)
            integer(ilp), intent(in) :: col(16,n)
            real(xdp), intent(inout) :: y(:)
            integer :: j, k
            do j = 1, n
        ...
        pure subroutine chunk_kernel_rm(n,cs,r,a,col,x,y)
            integer, value      :: n, cs, r
            real(xdp), intent(in)  :: a(cs,n), x(:)
            integer(ilp), intent(in) :: col(cs,n)
            real(xdp), intent(inout) :: y(r)
            integer :: j
            do j = 1, n
                y(1:r) = y(1:r) + alpha_ * a(1:r,j) * x(col(1:r,j))
            end do
    ...
    subroutine spmv_sellc_cxdp(matrix,vec_x,vec_y,alpha,beta,op)
        !! This algorithm was gracefully provided by Ivan Privec and adapted by Jose Alves
        type(SELLC_cxdp_type), intent(in) :: matrix
        complex(xdp), intent(in)    :: vec_x(:)
        complex(xdp), intent(inout) :: vec_y(:)
        complex(xdp), intent(in), optional :: alpha
        complex(xdp), intent(in), optional :: beta
    ...
    contains
        pure subroutine chunk_kernel_4(n,a,col,x,y)
            integer, value      :: n
            complex(xdp), intent(in)  :: a(4,n), x(:)
            integer(ilp), intent(in) :: col(4,n)
            complex(xdp), intent(inout) :: y(4)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_trans_4(n,a,col,x,y)
            integer, value      :: n
            complex(xdp), intent(in)  :: a(4,n), x(4)
            integer(ilp), intent(in) :: col(4,n)
        ...
        pure subroutine chunk_kernel_8(n,a,col,x,y)
            integer, value      :: n
            complex(xdp), intent(in)  :: a(8,n), x(:)
            integer(ilp), intent(in) :: col(8,n)
            complex(xdp), intent(inout) :: y(8)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_trans_8(n,a,col,x,y)
            integer, value      :: n
            complex(xdp), intent(in)  :: a(8,n), x(8)
            integer(ilp), intent(in) :: col(8,n)
            complex(xdp), intent(inout) :: y(:)
            integer :: j, k
            do j = 1, n
        ...
        pure subroutine chunk_kernel_16(n,a,col,x,y)
            integer, value      :: n
            complex(xdp), intent(in)  :: a(16,n), x(:)
            integer(ilp), intent(in) :: col(16,n)
            complex(xdp), intent(inout) :: y(16)
            integer :: j
            do j = 1, n
                y(:) = y(:) + alpha_ * a(:,j) * x(col(:,j))
            end do
        ...
        pure subroutine chunk_kernel_trans_16(n,a,col,x,y)
            integer, value      :: n
            complex(xdp), intent(in)  :: a(16,n), x(16)
            integer(ilp), intent(in) :: col(16,n)
            complex(xdp), intent(inout) :: y(:)
            integer :: j, k
            do j = 1, n
        ...
        pure subroutine chunk_kernel_rm(n,cs,r,a,col,x,y)
            integer, value      :: n, cs, r
            complex(xdp), intent(in)  :: a(cs,n), x(:)
            integer(ilp), intent(in) :: col(cs,n)
            complex(xdp), intent(inout) :: y(r)
            integer :: j
            do j = 1, n
                y(1:r) = y(1:r) + alpha_ * a(1:r,j) * x(col(1:r,j))
            end do
        ...
        pure subroutine chunk_kernel_rm_trans(n,cs,r,a,col,x,y)
            integer, value      :: n, cs, r
            complex(xdp), intent(in)  :: a(cs,n), x(r)
            integer(ilp), intent(in) :: col(cs,n)
            complex(xdp), intent(inout) :: y(:)
            integer :: j, k
            do j = 1, n
