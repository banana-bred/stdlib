...
!! Least-squares solution to Ax=b
     ...
     ! Workspace needed by gelsd
     elemental subroutine xgelsd_space(m,n,nrhs,lrwork,liwork,lcwork)
         integer(ilp), intent(in) :: m,n,nrhs
         integer(ilp), intent(out) :: lrwork,liwork,lcwork
         ...
         ! Maximum size of the subproblems at the bottom of the computation (~25)
         smlsiz = stdlib_ilaenv(9,'xgelsd',' ',0,0,0,0)
     ...
     ! Workspace needed by gelsd
     elemental subroutine ygelsd_space(m,n,nrhs,lrwork,liwork,lcwork)
         integer(ilp), intent(in) :: m,n,nrhs
         integer(ilp), intent(out) :: lrwork,liwork,lcwork
         ...
         ! Maximum size of the subproblems at the bottom of the computation (~25)
         smlsiz = stdlib_ilaenv(9,'ygelsd',' ',0,0,0,0)
     ...
     pure module subroutine stdlib_linalg_x_lstsq_space_one(a,b,lrwork,liwork)
         ...
         call xgelsd_space(m,n,nrhs,lrwork,liwork,lcwork)
     ...
     !!
         ...
         call stdlib_linalg_x_solve_lstsq_one(a,b,x,&
              cond=cond,overwrite_a=overwrite_a,rank=rank,err=err)
     ...
     !!
         ...
         real(xdp), pointer :: rwork(:),singular(:)
     ...
     pure module subroutine stdlib_linalg_y_lstsq_space_one(a,b,lrwork,liwork,lcwork)
         ...
         call ygelsd_space(m,n,nrhs,lrwork,liwork,lcwork)
     ...
     !!
         ...
         call stdlib_linalg_y_solve_lstsq_one(a,b,x,&
              cond=cond,overwrite_a=overwrite_a,rank=rank,err=err)
     ...
     !!
         ...
         call stdlib_linalg_x_solve_lstsq_many(a,b,x,&
              cond=cond,overwrite_a=overwrite_a,rank=rank,err=err)
     ...
     !!
         ...
         call stdlib_linalg_y_solve_lstsq_many(a,b,x,&
              cond=cond,overwrite_a=overwrite_a,rank=rank,err=err)
