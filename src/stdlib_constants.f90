...
module stdlib_constants
    ...
    real(xdp), parameter, public :: PI_xdp = acos(-1.0_xdp) !! PI
    ...
    real(xdp), parameter, public :: zero_xdp = 0._xdp
    real(xdp), parameter, public :: one_xdp  = 1._xdp
    ...
    complex(xdp), parameter, public :: zero_cxdp = (0._xdp,0._xdp)
    complex(xdp), parameter, public :: one_cxdp  = (1._xdp,0._xdp)
