...
contains
    ...
    subroutine test_nor_rvs_rxdp
        real(xdp) :: res(10), loc, scale
        integer, parameter :: k = 5
        integer :: i
        integer :: seed, get
        real(xdp), parameter :: ans(10) =                                         &
                            [2.66708039318040679432897377409972250_xdp,     &
                             2.36030794936128329730706809641560540_xdp,     &
                             1.27712218793084242296487218482070602_xdp,     &
                            -2.39132544130814794769435138732660562_xdp,     &
                             1.72566595106028652928387145948363468_xdp,     &
                            -1.50621775537767632613395107910037041_xdp,     &
                             2.13518835158352082714827702147886157_xdp,     &
                           -0.636788253742142318358787633769679815_xdp,     &
                             2.48600787778845799813609573902795091_xdp,     &
                            -3.03711473837981227319460231228731573_xdp]

        print *, "Test normal_distribution_rvs_rxdp"
        seed = 25836914
        call random_seed(seed, get)
        loc = 0.5_xdp; scale = 2.0_xdp
        ...
        call check(all(abs(res - ans) < xdptol),                            &
            msg="normal_distribution_rvs_rxdp failed", warn=warn)
    end subroutine test_nor_rvs_rxdp
    ...
    subroutine test_nor_rvs_rqp
        ...
        real(qp), parameter :: ans(10) =                                         &
                            [2.66708039318040679432897377409972250_qp,     &
    ...
    subroutine test_nor_rvs_cxdp
        complex(xdp) :: res(10), loc, scale
        integer, parameter :: k = 5
        integer :: i
        integer :: seed, get
        complex(xdp), parameter :: ans(10) =                                         &
                            [(2.12531029488530509574673033057479188_xdp,    &
                              1.46507698734032082432676702410390135_xdp),   &
                             (1.08284164094813181722365413861552952_xdp,    &
                             0.277168639672963013076412153168348595_xdp),   &
                             (1.41924946329521489696290359461272601_xdp,    &
                             0.498445561155580918466512230224907398_xdp),   &
                             (1.72639126368764062036120776610914618_xdp,    &
                             0.715802936564464420410303091557580046_xdp),   &
                             (1.98950590834134349860207180427096318_xdp,    &
                             0.115721315405046931701349421928171068_xdp),   &
                            (-1.16929014824793620075382705181255005_xdp,    &
                             0.250744737486995217246033007540972903_xdp),   &
                             (1.57160542831869509683428987045772374_xdp,    &
                             0.638282596371312238581197107123443857_xdp),   &
                            (-1.36106107654239116833139178197598085_xdp,    &
                             0.166259201494369124318950525776017457_xdp),   &
                             (1.13403096805387920698038328737311531_xdp,    &
                              1.04232618148691447146347854868508875_xdp),   &
                            (-1.68220535920475811053620418533682823_xdp,    &
                              1.63361446685040256898702182297711261_xdp)]

        print *, "Test normal_distribution_rvs_cxdp"
        seed = 25836914
        call random_seed(seed, get)
        loc = (0.5_xdp, 1.0_xdp); scale = (1.5_xdp, 0.5_xdp)
        ...
        res(6:10) = nor_rvs(loc, scale, k)  ! 3 dummies
        call check(all(abs(res - ans) < xdptol),                            &
            msg="normal_distribution_rvs_cxdp failed", warn=warn)
    end subroutine test_nor_rvs_cxdp
    ...
    subroutine test_nor_rvs_cqp
        ...
        complex(qp), parameter :: ans(10) =                                         &
                            [(2.12531029488530509574673033057479188_qp,    &
    ...
    subroutine test_nor_pdf_rxdp

        real(xdp) :: x1, x2(3,4), loc, scale
        integer, parameter :: k = 5
        integer :: seed, get
        real(xdp) :: res(3,5)
        real(xdp), parameter :: ans(15) =                                   &
                         [0.215050766989949083210785218076278553_xdp,       &
                          0.215050766989949083210785218076278553_xdp,       &
                          0.215050766989949083210785218076278553_xdp,       &
                          0.200537626692880596839299818454439236_xdp,       &
                          5.66161527403268434368575024104022496E-0002_xdp,  &
                          0.238986957612021514867582359518579138_xdp,       &
                          0.265935969411942911029638292783132425_xdp,       &
                          0.262147558654079961109031890374902943_xdp,       &
                          0.249866408914952245533320687656894701_xdp,       &
                          3.98721117498705317877792757313696510E-0002_xdp,  &
                          0.265902369803533466897906694845094995_xdp,       &
                          0.161311603170650092038944290133124635_xdp,       &
                          0.249177740354276111998717092437037695_xdp,       &
                          0.237427217242213206474603807278971527_xdp,       &
                          0.155696086384122017518186260628090478_xdp]

        print *, "Test normal_distribution_pdf_rxdp"
        seed = 741852963
        call random_seed(seed, get)
        loc = -0.5_xdp; scale = 1.5_xdp
        ...
        call check(all(abs(res - reshape(ans, [3,5])) < xdptol),            &
            msg="normal_distribution_pdf_rxdp failed", warn=warn)
    end subroutine test_nor_pdf_rxdp
    ...
    subroutine test_nor_pdf_rqp
        ...
        real(qp), parameter :: ans(15) =                                   &
                         [0.215050766989949083210785218076278553_qp,       &
                          0.215050766989949083210785218076278553_qp,       &
                          0.215050766989949083210785218076278553_qp,       &
                          0.200537626692880596839299818454439236_qp,       &
                          5.66161527403268434368575024104022496E-0002_qp,  &
                          0.238986957612021514867582359518579138_qp,       &
                          0.265935969411942911029638292783132425_qp,       &
                          0.262147558654079961109031890374902943_qp,       &
                          0.249866408914952245533320687656894701_qp,       &
                          3.98721117498705317877792757313696510E-0002_qp,  &
                          0.265902369803533466897906694845094995_qp,       &
                          0.161311603170650092038944290133124635_qp,       &
                          0.249177740354276111998717092437037695_qp,       &
                          0.237427217242213206474603807278971527_qp,       &
                          0.155696086384122017518186260628090478_qp]
    ...
    subroutine test_nor_pdf_cxdp

        complex(xdp) :: x1, x2(3,4), loc, scale
        integer, parameter :: k = 5
        integer :: seed, get
        real(xdp) :: res(3,5)
        real(xdp), parameter :: ans(15) =                                   &
                         [0.129377311291944176372137325120411497_xdp,       &
                          0.129377311291944176372137325120411497_xdp,       &
                          0.129377311291944176372137325120411497_xdp,       &
                          4.05915662853246811934977653001971736E-0002_xdp,  &
                          0.209143395418940756076861773161637924_xdp,       &
                          2.98881041363874672676853084975547667E-0002_xdp,  &
                          0.128679412679649127469385460133445161_xdp,       &
                          0.177484732473055532384223611956177231_xdp,       &
                          3.82205306942578982084957100753849738E-0002_xdp,  &
                          7.09915714309796034515515428785324918E-0002_xdp,  &
                          4.56126582912124629544443072483362352E-0002_xdp,  &
                          6.57454133967021123696499056531595921E-0002_xdp,  &
                          0.165161039915667041643464172210282279_xdp,       &
                          3.86104822953520989775015755966798359E-0002_xdp,  &
                          0.196922947431391188040943672442575686_xdp]

        print *, "Test normal_distribution_pdf_cxdp"
        seed = 741852963
        call random_seed(seed, get)
        loc = (-0.5_xdp, 0.5_xdp); scale = (0.5_xdp, 1.5_xdp)
        ...
        res(:, 2:5) = nor_pdf(x2, loc, scale)
        call check(all(abs(res - reshape(ans, [3,5])) < xdptol),            &
            msg="normal_distribution_pdf_cxdp failed", warn=warn)
    end subroutine test_nor_pdf_cxdp
    ...
    subroutine test_nor_pdf_cqp
        ...
        real(qp) :: res(3,5)
        real(qp), parameter :: ans(15) =                                   &
                         [0.129377311291944176372137325120411497_qp,       &
                          0.129377311291944176372137325120411497_qp,       &
                          0.129377311291944176372137325120411497_qp,       &
                          4.05915662853246811934977653001971736E-0002_qp,  &
                          0.209143395418940756076861773161637924_qp,       &
                          2.98881041363874672676853084975547667E-0002_qp,  &
                          0.128679412679649127469385460133445161_qp,       &
                          0.177484732473055532384223611956177231_qp,       &
                          3.82205306942578982084957100753849738E-0002_qp,  &
                          7.09915714309796034515515428785324918E-0002_qp,  &
                          4.56126582912124629544443072483362352E-0002_qp,  &
                          6.57454133967021123696499056531595921E-0002_qp,  &
                          0.165161039915667041643464172210282279_qp,       &
                          3.86104822953520989775015755966798359E-0002_qp,  &
                          0.196922947431391188040943672442575686_qp]
    ...
    subroutine test_nor_cdf_rxdp

        real(xdp) :: x1, x2(3,4), loc, scale
        integer :: seed, get
        real(xdp) :: res(3,5)
        real(xdp), parameter :: ans(15) =                                   &
                          [7.50826305038441048487991102776953948E-0002_xdp, &
                           7.50826305038441048487991102776953948E-0002_xdp, &
                           7.50826305038441048487991102776953948E-0002_xdp, &
                           0.143119834108717983250834016885129863_xdp,      &
                           0.241425421525703182028420560765471735_xdp,      &
                           0.284345878626039240974266199229875972_xdp,      &
                           0.233239836366015928845367994433532757_xdp,      &
                           0.341059506137219171082517155967522896_xdp,      &
                           0.353156850199835111081038166086606192_xdp,      &
                           6.81066766396638231790017005897813244E-0002_xdp, &
                           4.38792331441682923984716366123285346E-0002_xdp, &
                           0.763679637882860826030745070304416929_xdp,      &
                           0.363722187587355040667876190724308059_xdp,      &
                           0.868187114884980488672309198087692444_xdp,      &
                           0.626506799809652872401992867475200722_xdp]

        print *, "Test normal_distribution_cdf_rxdp"
        seed = 369147582
        call random_seed(seed, get)
        loc = -1.0_xdp; scale = 2.0_xdp
        ...
        res(:, 2:5) = nor_cdf(x2, loc, scale)
        call check(all(abs(res - reshape(ans,[3,5])) < xdptol),             &
            msg="normal_distribution_cdf_rxdp failed", warn=warn)
    end subroutine test_nor_cdf_rxdp
    ...
    subroutine test_nor_cdf_rqp
        ...
        real(qp) :: res(3,5)
        real(qp), parameter :: ans(15) =                                   &
                          [7.50826305038441048487991102776953948E-0002_qp, &
                           7.50826305038441048487991102776953948E-0002_qp, &
                           7.50826305038441048487991102776953948E-0002_qp, &
                           ...
                           0.233239836366015928845367994433532757_qp,      &
                           0.341059506137219171082517155967522896_qp,      &
                           0.353156850199835111081038166086606192_qp,      &
                           6.81066766396638231790017005897813244E-0002_qp, &
                           4.38792331441682923984716366123285346E-0002_qp, &
    ...
    subroutine test_nor_cdf_cxdp

        complex(xdp) :: x1, x2(3,4), loc, scale
        integer :: seed, get
        real(xdp) :: res(3,5)
        real(xdp), parameter :: ans(15) =                                   &
                          [1.07458136221563368133842063954746170E-0002_xdp, &
                           1.07458136221563368133842063954746170E-0002_xdp, &
                           1.07458136221563368133842063954746170E-0002_xdp, &
                           6.86483236063879585051085536740820057E-0002_xdp, &
                           7.95486634025192048896990048539218724E-0002_xdp, &
                           2.40523393996423661445007940057223384E-0002_xdp, &
                           3.35096768781160662250307446207445131E-0002_xdp, &
                           0.315778916661119434962814841317323376_xdp,      &
                           0.446311293878359175362094845206410428_xdp,      &
                           0.102010220821382542292905161748120877_xdp,      &
                           7.66919007012121545175655727052974512E-0002_xdp, &
                           0.564690968410069125818268877247699603_xdp,      &
                           0.708769523556518785240723539383512333_xdp,      &
                           6.40553790808161720088070925562830659E-0002_xdp, &
                           5.39999153072107729358158443133850711E-0002_xdp]

        print *, "Test normal_distribution_cdf_cxdp"
        seed = 369147582
        call random_seed(seed, get)
        loc = (-1.0_xdp, 1.0_xdp); scale = (1.7_xdp, 2.4_xdp)
        ...
        res(:, 2:5) = nor_cdf(x2, loc, scale)
        call check(all(abs(res - reshape(ans,[3,5])) < xdptol),             &
            msg="normal_distribution_cdf_cxdp failed", warn=warn)
    end subroutine test_nor_cdf_cxdp
    ...
    subroutine test_nor_cdf_cqp
        ...
        real(qp) :: res(3,5)
        real(qp), parameter :: ans(15) =                                   &
                          [1.07458136221563368133842063954746170E-0002_qp, &
                           1.07458136221563368133842063954746170E-0002_qp, &
                           1.07458136221563368133842063954746170E-0002_qp, &
                           6.86483236063879585051085536740820057E-0002_qp, &
                           7.95486634025192048896990048539218724E-0002_qp, &
                           2.40523393996423661445007940057223384E-0002_qp, &
                           3.35096768781160662250307446207445131E-0002_qp, &
                           0.315778916661119434962814841317323376_qp,      &
                           0.446311293878359175362094845206410428_qp,      &
                           0.102010220821382542292905161748120877_qp,      &
                           7.66919007012121545175655727052974512E-0002_qp, &
                           0.564690968410069125818268877247699603_qp,      &
                           0.708769523556518785240723539383512333_qp,      &
                           6.40553790808161720088070925562830659E-0002_qp, &
                           5.39999153072107729358158443133850711E-0002_qp]
