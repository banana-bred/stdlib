...
contains
    ...
    subroutine collect_selection(testsuite)
        ...
        testsuite = [ &
              ...
              , new_unittest("test_select_1_rxdp_int8", test_select_1_rxdp_int8) &
              , new_unittest("test_select_1_rxdp_int16", test_select_1_rxdp_int16) &
              , new_unittest("test_select_1_rxdp_int32", test_select_1_rxdp_int32) &
              , new_unittest("test_select_1_rxdp_int64", test_select_1_rxdp_int64) &
              , new_unittest("test_select_1_rqp_int8", test_select_1_rqp_int8) &
              , new_unittest("test_select_1_rqp_int16", test_select_1_rqp_int16) &
              , new_unittest("test_select_1_rqp_int32", test_select_1_rqp_int32) &
              , new_unittest("test_select_1_rqp_int64", test_select_1_rqp_int64) &
              ...
              , new_unittest("test_arg_select_1_rxdp_int8", test_arg_select_1_rxdp_int8) &
              , new_unittest("test_arg_select_1_rxdp_int16", test_arg_select_1_rxdp_int16) &
              , new_unittest("test_arg_select_1_rxdp_int32", test_arg_select_1_rxdp_int32) &
              , new_unittest("test_arg_select_1_rxdp_int64", test_arg_select_1_rxdp_int64) &
              , new_unittest("test_arg_select_1_rqp_int8", test_arg_select_1_rqp_int8) &
              , new_unittest("test_arg_select_1_rqp_int16", test_arg_select_1_rqp_int16) &
              , new_unittest("test_arg_select_1_rqp_int32", test_arg_select_1_rqp_int32) &
              , new_unittest("test_arg_select_1_rqp_int64", test_arg_select_1_rqp_int64) &
          ]
      ...
      subroutine test_select_1_rxdp_int8(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          real(xdp) :: x(N), x_copy(N), mat(Nm), mat_copy(Nm), len1(1), len2(2), &
              kth_smallest, random_vals(Nr), one = 1
          integer(int8) :: i, p, up_rank, down_rank, mid_rank
          real(dp) :: random_doubles(Nr) ! Deliberately double precision for all cases
          logical :: test1, test2, test3
          real(xdp), allocatable :: long_array(:)
          ...
          do i = 1, size(x, kind=ip)
              x_copy = x
              call select(x_copy, i, kth_smallest)
              call check( error, (kth_smallest == i**2), " test_select_1_rxdp_int8: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call select(x_copy, i, kth_smallest, left=i)
              call check( error,  (kth_smallest == i**2), " test_select_1_rxdp_int8: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call select(x_copy, i, kth_smallest, right=i)
              call check( error, (kth_smallest == i**2), " test_select_1_rxdp_int8: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array(1:3) = one
              call select(long_array, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest == one), " test_select_1_rxdp_int8: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array)
          end if
          ...
          mat_copy = mat
          call select(mat_copy, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int8: mat test 1")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 2_ip, kth_smallest)
          call check(error, kth_smallest == 1, " test_select_1_rxdp_int8: mat test 2")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, size(mat, kind=ip)+1_ip-4_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int8: mat test 3")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 5_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int8: mat test 4")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 6_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int8: mat test 5")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 7_ip, kth_smallest)
          call check(error, kth_smallest == 5, " test_select_1_rxdp_int8: mat test 6")
          if(allocated(error)) return

          ! Check it works for size(a) == 1
          len1(1) = -1 * one
          call select(len1, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int8: array with size 1")
          if(allocated(error)) return

          ! Check it works for size(a) == 2
          len2 = [-3, -5]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -3, " test_select_1_rxdp_int8: array with size 2, test 1")
          if(allocated(error)) return
          len2 = [-3, -5]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -5, " test_select_1_rxdp_int8: array with size 2, test 2")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int8: array with size 2, test 3")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int8: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(p) <= &
                      random_vals((p+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int8: random data regular select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(up_rank) <= &
                      random_vals((up_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int8: random data left-constrained select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(down_rank) <= &
                      random_vals((down_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int8: random data right-constrained&
                      & select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(mid_rank) <= &
                      random_vals((mid_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int8: random data left-right-constrained&
                      & select")
                  if(allocated(error)) return
      ...
      subroutine test_select_1_rxdp_int16(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              x_copy = x
              call select(x_copy, i, kth_smallest)
              call check( error, (kth_smallest == i**2), " test_select_1_rxdp_int16: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call select(x_copy, i, kth_smallest, left=i)
              call check( error,  (kth_smallest == i**2), " test_select_1_rxdp_int16: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call select(x_copy, i, kth_smallest, right=i)
              call check( error, (kth_smallest == i**2), " test_select_1_rxdp_int16: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array(1:3) = one
              call select(long_array, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest == one), " test_select_1_rxdp_int16: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array)
          end if
          ...
          mat_copy = mat
          call select(mat_copy, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int16: mat test 1")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 2_ip, kth_smallest)
          call check(error, kth_smallest == 1, " test_select_1_rxdp_int16: mat test 2")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, size(mat, kind=ip)+1_ip-4_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int16: mat test 3")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 5_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int16: mat test 4")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 6_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int16: mat test 5")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 7_ip, kth_smallest)
          call check(error, kth_smallest == 5, " test_select_1_rxdp_int16: mat test 6")
          if(allocated(error)) return

          ! Check it works for size(a) == 1
          len1(1) = -1 * one
          call select(len1, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int16: array with size 1")
          if(allocated(error)) return

          ! Check it works for size(a) == 2
          len2 = [-3, -5]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -3, " test_select_1_rxdp_int16: array with size 2, test 1")
          if(allocated(error)) return
          len2 = [-3, -5]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -5, " test_select_1_rxdp_int16: array with size 2, test 2")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int16: array with size 2, test 3")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int16: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(p) <= &
                      random_vals((p+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int16: random data regular select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(up_rank) <= &
                      random_vals((up_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int16: random data left-constrained&
                      & select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(down_rank) <= &
                      random_vals((down_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int16: random data right-constrained&
                      & select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(mid_rank) <= &
                      random_vals((mid_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int16: random data left-right-constrained&
                      & select")
                  if(allocated(error)) return
      ...
      subroutine test_select_1_rxdp_int32(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              x_copy = x
              call select(x_copy, i, kth_smallest)
              call check( error, (kth_smallest == i**2), " test_select_1_rxdp_int32: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call select(x_copy, i, kth_smallest, left=i)
              call check( error,  (kth_smallest == i**2), " test_select_1_rxdp_int32: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call select(x_copy, i, kth_smallest, right=i)
              call check( error, (kth_smallest == i**2), " test_select_1_rxdp_int32: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array(1:3) = one
              call select(long_array, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest == one), " test_select_1_rxdp_int32: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array)
          end if
          ...
          mat_copy = mat
          call select(mat_copy, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int32: mat test 1")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 2_ip, kth_smallest)
          call check(error, kth_smallest == 1, " test_select_1_rxdp_int32: mat test 2")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, size(mat, kind=ip)+1_ip-4_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int32: mat test 3")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 5_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int32: mat test 4")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 6_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int32: mat test 5")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 7_ip, kth_smallest)
          call check(error, kth_smallest == 5, " test_select_1_rxdp_int32: mat test 6")
          if(allocated(error)) return

          ! Check it works for size(a) == 1
          len1(1) = -1 * one
          call select(len1, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int32: array with size 1")
          if(allocated(error)) return

          ! Check it works for size(a) == 2
          len2 = [-3, -5]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -3, " test_select_1_rxdp_int32: array with size 2, test 1")
          if(allocated(error)) return
          len2 = [-3, -5]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -5, " test_select_1_rxdp_int32: array with size 2, test 2")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int32: array with size 2, test 3")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int32: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(p) <= &
                      random_vals((p+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int32: random data regular select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(up_rank) <= &
                      random_vals((up_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int32: random data left-constrained&
                      & select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(down_rank) <= &
                      random_vals((down_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int32: random data right-constrained&
                      & select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(mid_rank) <= &
                      random_vals((mid_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int32: random data left-right-constrained&
                      & select")
                  if(allocated(error)) return
      ...
      subroutine test_select_1_rxdp_int64(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              x_copy = x
              call select(x_copy, i, kth_smallest)
              call check( error, (kth_smallest == i**2), " test_select_1_rxdp_int64: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call select(x_copy, i, kth_smallest, left=i)
              call check( error,  (kth_smallest == i**2), " test_select_1_rxdp_int64: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call select(x_copy, i, kth_smallest, right=i)
              call check( error, (kth_smallest == i**2), " test_select_1_rxdp_int64: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array(1:3) = one
              call select(long_array, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest == one), " test_select_1_rxdp_int64: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array)
          end if
          ...
          mat_copy = mat
          call select(mat_copy, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int64: mat test 1")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 2_ip, kth_smallest)
          call check(error, kth_smallest == 1, " test_select_1_rxdp_int64: mat test 2")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, size(mat, kind=ip)+1_ip-4_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int64: mat test 3")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 5_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int64: mat test 4")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 6_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rxdp_int64: mat test 5")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 7_ip, kth_smallest)
          call check(error, kth_smallest == 5, " test_select_1_rxdp_int64: mat test 6")
          if(allocated(error)) return

          ! Check it works for size(a) == 1
          len1(1) = -1 * one
          call select(len1, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int64: array with size 1")
          if(allocated(error)) return

          ! Check it works for size(a) == 2
          len2 = [-3, -5]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -3, " test_select_1_rxdp_int64: array with size 2, test 1")
          if(allocated(error)) return
          len2 = [-3, -5]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -5, " test_select_1_rxdp_int64: array with size 2, test 2")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int64: array with size 2, test 3")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rxdp_int64: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(p) <= &
                      random_vals((p+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int64: random data regular select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(up_rank) <= &
                      random_vals((up_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int64: random data left-constrained&
                      & select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(down_rank) <= &
                      random_vals((down_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int64: random data right-constrained&
                      & select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(mid_rank) <= &
                      random_vals((mid_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rxdp_int64: random data left-right-constrained&
                      & select")
                  if(allocated(error)) return
      ...
      subroutine test_select_1_rqp_int8(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          real(qp) :: x(N), x_copy(N), mat(Nm), mat_copy(Nm), len1(1), len2(2), &
              kth_smallest, random_vals(Nr), one = 1
          integer(int8) :: i, p, up_rank, down_rank, mid_rank
          real(dp) :: random_doubles(Nr) ! Deliberately double precision for all cases
          logical :: test1, test2, test3
          real(qp), allocatable :: long_array(:)
          ...
          do i = 1, size(x, kind=ip)
              x_copy = x
              call select(x_copy, i, kth_smallest)
              call check( error, (kth_smallest == i**2), " test_select_1_rqp_int8: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call select(x_copy, i, kth_smallest, left=i)
              call check( error,  (kth_smallest == i**2), " test_select_1_rqp_int8: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call select(x_copy, i, kth_smallest, right=i)
              call check( error, (kth_smallest == i**2), " test_select_1_rqp_int8: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array(1:3) = one
              call select(long_array, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest == one), " test_select_1_rqp_int8: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array)
          end if
          ...
          mat_copy = mat
          call select(mat_copy, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int8: mat test 1")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 2_ip, kth_smallest)
          call check(error, kth_smallest == 1, " test_select_1_rqp_int8: mat test 2")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, size(mat, kind=ip)+1_ip-4_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int8: mat test 3")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 5_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int8: mat test 4")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 6_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int8: mat test 5")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 7_ip, kth_smallest)
          call check(error, kth_smallest == 5, " test_select_1_rqp_int8: mat test 6")
          if(allocated(error)) return

          ! Check it works for size(a) == 1
          len1(1) = -1 * one
          call select(len1, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int8: array with size 1")
          if(allocated(error)) return

          ! Check it works for size(a) == 2
          len2 = [-3, -5]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -3, " test_select_1_rqp_int8: array with size 2, test 1")
          if(allocated(error)) return
          len2 = [-3, -5]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -5, " test_select_1_rqp_int8: array with size 2, test 2")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int8: array with size 2, test 3")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int8: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(p) <= &
                      random_vals((p+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int8: random data regular select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(up_rank) <= &
                      random_vals((up_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int8: random data left-constrained select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(down_rank) <= &
                      random_vals((down_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int8: random data right-constrained select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(mid_rank) <= &
                      random_vals((mid_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int8: random data left-right-constrained&
                      & select")
                  if(allocated(error)) return
      ...
      subroutine test_select_1_rqp_int16(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              x_copy = x
              call select(x_copy, i, kth_smallest)
              call check( error, (kth_smallest == i**2), " test_select_1_rqp_int16: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call select(x_copy, i, kth_smallest, left=i)
              call check( error,  (kth_smallest == i**2), " test_select_1_rqp_int16: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call select(x_copy, i, kth_smallest, right=i)
              call check( error, (kth_smallest == i**2), " test_select_1_rqp_int16: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array(1:3) = one
              call select(long_array, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest == one), " test_select_1_rqp_int16: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array)
          end if
          ...
          mat_copy = mat
          call select(mat_copy, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int16: mat test 1")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 2_ip, kth_smallest)
          call check(error, kth_smallest == 1, " test_select_1_rqp_int16: mat test 2")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, size(mat, kind=ip)+1_ip-4_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int16: mat test 3")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 5_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int16: mat test 4")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 6_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int16: mat test 5")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 7_ip, kth_smallest)
          call check(error, kth_smallest == 5, " test_select_1_rqp_int16: mat test 6")
          if(allocated(error)) return

          ! Check it works for size(a) == 1
          len1(1) = -1 * one
          call select(len1, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int16: array with size 1")
          if(allocated(error)) return

          ! Check it works for size(a) == 2
          len2 = [-3, -5]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -3, " test_select_1_rqp_int16: array with size 2, test 1")
          if(allocated(error)) return
          len2 = [-3, -5]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -5, " test_select_1_rqp_int16: array with size 2, test 2")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int16: array with size 2, test 3")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int16: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(p) <= &
                      random_vals((p+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int16: random data regular select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(up_rank) <= &
                      random_vals((up_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int16: random data left-constrained select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(down_rank) <= &
                      random_vals((down_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int16: random data right-constrained&
                      & select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(mid_rank) <= &
                      random_vals((mid_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int16: random data left-right-constrained&
                      & select")
                  if(allocated(error)) return
      ...
      subroutine test_select_1_rqp_int32(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              x_copy = x
              call select(x_copy, i, kth_smallest)
              call check( error, (kth_smallest == i**2), " test_select_1_rqp_int32: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call select(x_copy, i, kth_smallest, left=i)
              call check( error,  (kth_smallest == i**2), " test_select_1_rqp_int32: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call select(x_copy, i, kth_smallest, right=i)
              call check( error, (kth_smallest == i**2), " test_select_1_rqp_int32: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array(1:3) = one
              call select(long_array, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest == one), " test_select_1_rqp_int32: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array)
          end if
          ...
          mat_copy = mat
          call select(mat_copy, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int32: mat test 1")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 2_ip, kth_smallest)
          call check(error, kth_smallest == 1, " test_select_1_rqp_int32: mat test 2")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, size(mat, kind=ip)+1_ip-4_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int32: mat test 3")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 5_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int32: mat test 4")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 6_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int32: mat test 5")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 7_ip, kth_smallest)
          call check(error, kth_smallest == 5, " test_select_1_rqp_int32: mat test 6")
          if(allocated(error)) return

          ! Check it works for size(a) == 1
          len1(1) = -1 * one
          call select(len1, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int32: array with size 1")
          if(allocated(error)) return

          ! Check it works for size(a) == 2
          len2 = [-3, -5]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -3, " test_select_1_rqp_int32: array with size 2, test 1")
          if(allocated(error)) return
          len2 = [-3, -5]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -5, " test_select_1_rqp_int32: array with size 2, test 2")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int32: array with size 2, test 3")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int32: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(p) <= &
                      random_vals((p+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int32: random data regular select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(up_rank) <= &
                      random_vals((up_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int32: random data left-constrained select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(down_rank) <= &
                      random_vals((down_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int32: random data right-constrained&
                      & select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(mid_rank) <= &
                      random_vals((mid_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int32: random data left-right-constrained&
                      & select")
                  if(allocated(error)) return
      ...
      subroutine test_select_1_rqp_int64(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              x_copy = x
              call select(x_copy, i, kth_smallest)
              call check( error, (kth_smallest == i**2), " test_select_1_rqp_int64: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call select(x_copy, i, kth_smallest, left=i)
              call check( error,  (kth_smallest == i**2), " test_select_1_rqp_int64: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call select(x_copy, i, kth_smallest, right=i)
              call check( error, (kth_smallest == i**2), " test_select_1_rqp_int64: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array(1:3) = one
              call select(long_array, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest == one), " test_select_1_rqp_int64: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array)
          end if
          ...
          mat_copy = mat
          call select(mat_copy, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int64: mat test 1")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 2_ip, kth_smallest)
          call check(error, kth_smallest == 1, " test_select_1_rqp_int64: mat test 2")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, size(mat, kind=ip)+1_ip-4_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int64: mat test 3")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 5_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int64: mat test 4")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 6_ip, kth_smallest)
          call check(error, kth_smallest == 4, " test_select_1_rqp_int64: mat test 5")
          if(allocated(error)) return
          mat_copy = mat
          call select(mat_copy, 7_ip, kth_smallest)
          call check(error, kth_smallest == 5, " test_select_1_rqp_int64: mat test 6")
          if(allocated(error)) return

          ! Check it works for size(a) == 1
          len1(1) = -1 * one
          call select(len1, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int64: array with size 1")
          if(allocated(error)) return

          ! Check it works for size(a) == 2
          len2 = [-3, -5]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -3, " test_select_1_rqp_int64: array with size 2, test 1")
          if(allocated(error)) return
          len2 = [-3, -5]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -5, " test_select_1_rqp_int64: array with size 2, test 2")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 1_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int64: array with size 2, test 3")
          if(allocated(error)) return
          len2 = [-1, -1]*one
          call select(len2, 2_ip, kth_smallest)
          call check(error, kth_smallest == -1, " test_select_1_rqp_int64: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(p) <= &
                      random_vals((p+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int64: random data regular select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(up_rank) <= &
                      random_vals((up_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int64: random data left-constrained select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(down_rank) <= &
                      random_vals((down_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int64: random data right-constrained&
                      & select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(mid_rank) <= &
                      random_vals((mid_rank+1):size(random_vals, kind=ip)))
                  call check(error, (test1 .and. test2 .and. test3), "test_select_1_rqp_int64: random data left-right-constrained&
                      & select")
                  if(allocated(error)) return
      ...
      subroutine test_arg_select_1_rxdp_int8(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          real(xdp) :: x(N), mat(Nm), len1(1), len2(2), random_vals(Nr), one=1
          ...
          do i = 1, size(x, kind=ip)
              indx_copy = indx
              call arg_select(x, indx, i, kth_smallest)
              call check(error, x(kth_smallest) == i**2, " test_arg_select_1_rxdp_int8: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call arg_select(x, indx_copy,  i, kth_smallest, left=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rxdp_int8: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call arg_select(x, indx_copy, i, kth_smallest, right=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rxdp_int8: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array_index = (/( i, i = 1_ip, size(long_array, kind=ip) )/)
              call arg_select(long_array, long_array_index, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest < 4), " test_arg_select_1_rxdp_int8: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array, long_array_index)
          end if
          ...
          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 1_ip, kth_smallest)
          call check(error, mat(kth_smallest) == -1, " test_arg_select_1_rxdp_int8: mat test 1")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 2_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 1, " test_arg_select_1_rxdp_int8: mat test 2")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, size(mat, kind=ip)+1_ip-4_ip, &
              kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int8: mat test 3")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 5_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int8: mat test 4")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 6_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int8: mat test 5")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 7_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 5, " test_arg_select_1_rxdp_int8: mat test 6")
          if(allocated(error)) return
          ...
          indx_len1(1) = 1
          call arg_select(len1, indx_len1, 1_ip, kth_smallest)
          call check(error, len1(kth_smallest) == -1, " test_arg_select_1_rxdp_int8: array with size 1")
          if(allocated(error)) return
          ...
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -3, " test_arg_select_1_rxdp_int8: array with size 2, test 1")
          if(allocated(error)) return

          len2 = [-3, -5] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -5, " test_arg_select_1_rxdp_int8: array with size 2, test 2")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rxdp_int8: array with size 2, test 3")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rxdp_int8: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(indx_r(p)) <= &
                      random_vals(indx_r((p+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int8: random data regular arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(up_rank)) <= &
                      random_vals(indx_r((up_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int8: random data left-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(down_rank)) <= &
                      random_vals(indx_r((down_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int8: random data right-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(mid_rank)) <= &
                      random_vals(indx_r((mid_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int8: random data&
                      & left-right-constrained arg_select")
                  if(allocated(error)) return
      ...
      subroutine test_arg_select_1_rxdp_int16(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              indx_copy = indx
              call arg_select(x, indx, i, kth_smallest)
              call check(error, x(kth_smallest) == i**2, " test_arg_select_1_rxdp_int16: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call arg_select(x, indx_copy,  i, kth_smallest, left=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rxdp_int16: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call arg_select(x, indx_copy, i, kth_smallest, right=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rxdp_int16: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array_index = (/( i, i = 1_ip, size(long_array, kind=ip) )/)
              call arg_select(long_array, long_array_index, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest < 4), " test_arg_select_1_rxdp_int16: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array, long_array_index)
          end if
          ...
          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 1_ip, kth_smallest)
          call check(error, mat(kth_smallest) == -1, " test_arg_select_1_rxdp_int16: mat test 1")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 2_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 1, " test_arg_select_1_rxdp_int16: mat test 2")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, size(mat, kind=ip)+1_ip-4_ip, &
              kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int16: mat test 3")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 5_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int16: mat test 4")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 6_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int16: mat test 5")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 7_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 5, " test_arg_select_1_rxdp_int16: mat test 6")
          if(allocated(error)) return
          ...
          indx_len1(1) = 1
          call arg_select(len1, indx_len1, 1_ip, kth_smallest)
          call check(error, len1(kth_smallest) == -1, " test_arg_select_1_rxdp_int16: array with size 1")
          if(allocated(error)) return
          ...
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -3, " test_arg_select_1_rxdp_int16: array with size 2, test 1")
          if(allocated(error)) return

          len2 = [-3, -5] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -5, " test_arg_select_1_rxdp_int16: array with size 2, test 2")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rxdp_int16: array with size 2, test 3")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rxdp_int16: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(indx_r(p)) <= &
                      random_vals(indx_r((p+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int16: random data regular arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(up_rank)) <= &
                      random_vals(indx_r((up_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int16: random data left-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(down_rank)) <= &
                      random_vals(indx_r((down_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int16: random data right-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(mid_rank)) <= &
                      random_vals(indx_r((mid_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int16: random data&
                      & left-right-constrained arg_select")
                  if(allocated(error)) return
      ...
      subroutine test_arg_select_1_rxdp_int32(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              indx_copy = indx
              call arg_select(x, indx, i, kth_smallest)
              call check(error, x(kth_smallest) == i**2, " test_arg_select_1_rxdp_int32: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call arg_select(x, indx_copy,  i, kth_smallest, left=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rxdp_int32: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call arg_select(x, indx_copy, i, kth_smallest, right=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rxdp_int32: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array_index = (/( i, i = 1_ip, size(long_array, kind=ip) )/)
              call arg_select(long_array, long_array_index, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest < 4), " test_arg_select_1_rxdp_int32: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array, long_array_index)
          end if
          ...
          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 1_ip, kth_smallest)
          call check(error, mat(kth_smallest) == -1, " test_arg_select_1_rxdp_int32: mat test 1")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 2_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 1, " test_arg_select_1_rxdp_int32: mat test 2")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, size(mat, kind=ip)+1_ip-4_ip, &
              kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int32: mat test 3")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 5_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int32: mat test 4")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 6_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int32: mat test 5")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 7_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 5, " test_arg_select_1_rxdp_int32: mat test 6")
          if(allocated(error)) return
          ...
          indx_len1(1) = 1
          call arg_select(len1, indx_len1, 1_ip, kth_smallest)
          call check(error, len1(kth_smallest) == -1, " test_arg_select_1_rxdp_int32: array with size 1")
          if(allocated(error)) return
          ...
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -3, " test_arg_select_1_rxdp_int32: array with size 2, test 1")
          if(allocated(error)) return

          len2 = [-3, -5] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -5, " test_arg_select_1_rxdp_int32: array with size 2, test 2")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rxdp_int32: array with size 2, test 3")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rxdp_int32: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(indx_r(p)) <= &
                      random_vals(indx_r((p+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int32: random data regular arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(up_rank)) <= &
                      random_vals(indx_r((up_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int32: random data left-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(down_rank)) <= &
                      random_vals(indx_r((down_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int32: random data right-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(mid_rank)) <= &
                      random_vals(indx_r((mid_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int32: random data&
                      & left-right-constrained arg_select")
                  if(allocated(error)) return
      ...
      subroutine test_arg_select_1_rxdp_int64(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              indx_copy = indx
              call arg_select(x, indx, i, kth_smallest)
              call check(error, x(kth_smallest) == i**2, " test_arg_select_1_rxdp_int64: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call arg_select(x, indx_copy,  i, kth_smallest, left=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rxdp_int64: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call arg_select(x, indx_copy, i, kth_smallest, right=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rxdp_int64: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array_index = (/( i, i = 1_ip, size(long_array, kind=ip) )/)
              call arg_select(long_array, long_array_index, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest < 4), " test_arg_select_1_rxdp_int64: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array, long_array_index)
          end if
          ...
          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 1_ip, kth_smallest)
          call check(error, mat(kth_smallest) == -1, " test_arg_select_1_rxdp_int64: mat test 1")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 2_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 1, " test_arg_select_1_rxdp_int64: mat test 2")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, size(mat, kind=ip)+1_ip-4_ip, &
              kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int64: mat test 3")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 5_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int64: mat test 4")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 6_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rxdp_int64: mat test 5")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 7_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 5, " test_arg_select_1_rxdp_int64: mat test 6")
          if(allocated(error)) return
          ...
          indx_len1(1) = 1
          call arg_select(len1, indx_len1, 1_ip, kth_smallest)
          call check(error, len1(kth_smallest) == -1, " test_arg_select_1_rxdp_int64: array with size 1")
          if(allocated(error)) return
          ...
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -3, " test_arg_select_1_rxdp_int64: array with size 2, test 1")
          if(allocated(error)) return

          len2 = [-3, -5] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -5, " test_arg_select_1_rxdp_int64: array with size 2, test 2")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rxdp_int64: array with size 2, test 3")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rxdp_int64: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(indx_r(p)) <= &
                      random_vals(indx_r((p+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int64: random data regular arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(up_rank)) <= &
                      random_vals(indx_r((up_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int64: random data left-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(down_rank)) <= &
                      random_vals(indx_r((down_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int64: random data right-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(mid_rank)) <= &
                      random_vals(indx_r((mid_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rxdp_int64: random data&
                      & left-right-constrained arg_select")
                  if(allocated(error)) return
      ...
      subroutine test_arg_select_1_rqp_int8(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          real(qp) :: x(N), mat(Nm), len1(1), len2(2), random_vals(Nr), one=1
          ...
          do i = 1, size(x, kind=ip)
              indx_copy = indx
              call arg_select(x, indx, i, kth_smallest)
              call check(error, x(kth_smallest) == i**2, " test_arg_select_1_rqp_int8: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call arg_select(x, indx_copy,  i, kth_smallest, left=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rqp_int8: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call arg_select(x, indx_copy, i, kth_smallest, right=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rqp_int8: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array_index = (/( i, i = 1_ip, size(long_array, kind=ip) )/)
              call arg_select(long_array, long_array_index, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest < 4), " test_arg_select_1_rqp_int8: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array, long_array_index)
          end if
          ...
          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 1_ip, kth_smallest)
          call check(error, mat(kth_smallest) == -1, " test_arg_select_1_rqp_int8: mat test 1")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 2_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 1, " test_arg_select_1_rqp_int8: mat test 2")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, size(mat, kind=ip)+1_ip-4_ip, &
              kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int8: mat test 3")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 5_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int8: mat test 4")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 6_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int8: mat test 5")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 7_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 5, " test_arg_select_1_rqp_int8: mat test 6")
          if(allocated(error)) return
          ...
          indx_len1(1) = 1
          call arg_select(len1, indx_len1, 1_ip, kth_smallest)
          call check(error, len1(kth_smallest) == -1, " test_arg_select_1_rqp_int8: array with size 1")
          if(allocated(error)) return
          ...
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -3, " test_arg_select_1_rqp_int8: array with size 2, test 1")
          if(allocated(error)) return

          len2 = [-3, -5] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -5, " test_arg_select_1_rqp_int8: array with size 2, test 2")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rqp_int8: array with size 2, test 3")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rqp_int8: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(indx_r(p)) <= &
                      random_vals(indx_r((p+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int8: random data regular arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(up_rank)) <= &
                      random_vals(indx_r((up_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int8: random data left-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(down_rank)) <= &
                      random_vals(indx_r((down_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int8: random data right-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(mid_rank)) <= &
                      random_vals(indx_r((mid_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int8: random data&
                      & left-right-constrained arg_select")
                  if(allocated(error)) return
      ...
      subroutine test_arg_select_1_rqp_int16(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              indx_copy = indx
              call arg_select(x, indx, i, kth_smallest)
              call check(error, x(kth_smallest) == i**2, " test_arg_select_1_rqp_int16: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call arg_select(x, indx_copy,  i, kth_smallest, left=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rqp_int16: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call arg_select(x, indx_copy, i, kth_smallest, right=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rqp_int16: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array_index = (/( i, i = 1_ip, size(long_array, kind=ip) )/)
              call arg_select(long_array, long_array_index, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest < 4), " test_arg_select_1_rqp_int16: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array, long_array_index)
          end if
          ...
          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 1_ip, kth_smallest)
          call check(error, mat(kth_smallest) == -1, " test_arg_select_1_rqp_int16: mat test 1")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 2_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 1, " test_arg_select_1_rqp_int16: mat test 2")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, size(mat, kind=ip)+1_ip-4_ip, &
              kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int16: mat test 3")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 5_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int16: mat test 4")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 6_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int16: mat test 5")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 7_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 5, " test_arg_select_1_rqp_int16: mat test 6")
          if(allocated(error)) return
          ...
          indx_len1(1) = 1
          call arg_select(len1, indx_len1, 1_ip, kth_smallest)
          call check(error, len1(kth_smallest) == -1, " test_arg_select_1_rqp_int16: array with size 1")
          if(allocated(error)) return
          ...
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -3, " test_arg_select_1_rqp_int16: array with size 2, test 1")
          if(allocated(error)) return

          len2 = [-3, -5] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -5, " test_arg_select_1_rqp_int16: array with size 2, test 2")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rqp_int16: array with size 2, test 3")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rqp_int16: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(indx_r(p)) <= &
                      random_vals(indx_r((p+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int16: random data regular arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(up_rank)) <= &
                      random_vals(indx_r((up_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int16: random data left-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(down_rank)) <= &
                      random_vals(indx_r((down_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int16: random data right-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(mid_rank)) <= &
                      random_vals(indx_r((mid_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int16: random data&
                      & left-right-constrained arg_select")
                  if(allocated(error)) return
      ...
      subroutine test_arg_select_1_rqp_int32(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              indx_copy = indx
              call arg_select(x, indx, i, kth_smallest)
              call check(error, x(kth_smallest) == i**2, " test_arg_select_1_rqp_int32: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call arg_select(x, indx_copy,  i, kth_smallest, left=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rqp_int32: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call arg_select(x, indx_copy, i, kth_smallest, right=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rqp_int32: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array_index = (/( i, i = 1_ip, size(long_array, kind=ip) )/)
              call arg_select(long_array, long_array_index, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest < 4), " test_arg_select_1_rqp_int32: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array, long_array_index)
          end if
          ...
          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 1_ip, kth_smallest)
          call check(error, mat(kth_smallest) == -1, " test_arg_select_1_rqp_int32: mat test 1")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 2_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 1, " test_arg_select_1_rqp_int32: mat test 2")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, size(mat, kind=ip)+1_ip-4_ip, &
              kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int32: mat test 3")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 5_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int32: mat test 4")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 6_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int32: mat test 5")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 7_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 5, " test_arg_select_1_rqp_int32: mat test 6")
          if(allocated(error)) return
          ...
          indx_len1(1) = 1
          call arg_select(len1, indx_len1, 1_ip, kth_smallest)
          call check(error, len1(kth_smallest) == -1, " test_arg_select_1_rqp_int32: array with size 1")
          if(allocated(error)) return
          ...
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -3, " test_arg_select_1_rqp_int32: array with size 2, test 1")
          if(allocated(error)) return

          len2 = [-3, -5] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -5, " test_arg_select_1_rqp_int32: array with size 2, test 2")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rqp_int32: array with size 2, test 3")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rqp_int32: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(indx_r(p)) <= &
                      random_vals(indx_r((p+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int32: random data regular arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(up_rank)) <= &
                      random_vals(indx_r((up_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int32: random data left-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(down_rank)) <= &
                      random_vals(indx_r((down_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int32: random data right-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(mid_rank)) <= &
                      random_vals(indx_r((mid_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int32: random data&
                      & left-right-constrained arg_select")
                  if(allocated(error)) return
      ...
      subroutine test_arg_select_1_rqp_int64(error)
          type(error_type), allocatable, intent(out) :: error
          ...
          do i = 1, size(x, kind=ip)
              indx_copy = indx
              call arg_select(x, indx, i, kth_smallest)
              call check(error, x(kth_smallest) == i**2, " test_arg_select_1_rqp_int64: kth smallest entry should be i**2")
              if(allocated(error)) return
          end do
          ...
          do i = 1, size(x, kind=ip), 1
              call arg_select(x, indx_copy,  i, kth_smallest, left=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rqp_int64: kth smallest entry with left specified")
              if(allocated(error)) return
          end do
          ...
          do i = size(x, kind=ip), 1, -1
              call arg_select(x, indx_copy, i, kth_smallest, right=i)
              call check(error, (x(kth_smallest) == i**2), " test_arg_select_1_rqp_int64: kth smallest entry with right specified")
              if(allocated(error)) return
          end do
          ...
          if(near_huge < 200) then
              ...
              long_array_index = (/( i, i = 1_ip, size(long_array, kind=ip) )/)
              call arg_select(long_array, long_array_index, near_huge - 2_ip, kth_smallest)
              call check( error, (kth_smallest < 4), " test_arg_select_1_rqp_int64: designed to catch overflow in middle index")
              if(allocated(error)) return
              deallocate(long_array, long_array_index)
          end if
          ...
          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 1_ip, kth_smallest)
          call check(error, mat(kth_smallest) == -1, " test_arg_select_1_rqp_int64: mat test 1")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 2_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 1, " test_arg_select_1_rqp_int64: mat test 2")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, size(mat, kind=ip)+1_ip-4_ip, &
              kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int64: mat test 3")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 5_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int64: mat test 4")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 6_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 4, " test_arg_select_1_rqp_int64: mat test 5")
          if(allocated(error)) return

          indx_mat_copy = indx_mat
          call arg_select(mat, indx_mat_copy, 7_ip, kth_smallest)
          call check(error, mat(kth_smallest) == 5, " test_arg_select_1_rqp_int64: mat test 6")
          if(allocated(error)) return
          ...
          indx_len1(1) = 1
          call arg_select(len1, indx_len1, 1_ip, kth_smallest)
          call check(error, len1(kth_smallest) == -1, " test_arg_select_1_rqp_int64: array with size 1")
          if(allocated(error)) return
          ...
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -3, " test_arg_select_1_rqp_int64: array with size 2, test 1")
          if(allocated(error)) return

          len2 = [-3, -5] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -5, " test_arg_select_1_rqp_int64: array with size 2, test 2")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 1_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rqp_int64: array with size 2, test 3")
          if(allocated(error)) return

          len2 = [-1, -1] * one
          indx_len2 = [1_ip, 2_ip]
          call arg_select(len2, indx_len2, 2_ip, kth_smallest)
          call check(error, len2(kth_smallest) == -1, " test_arg_select_1_rqp_int64: array with size 2, test 4")
          if(allocated(error)) return
          ...
          do p = 3, Nr-2
              ...
              do i = 1, Nreps
                  ...
                  test3 = all(random_vals(indx_r(p)) <= &
                      random_vals(indx_r((p+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int64: random data regular arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(up_rank)) <= &
                      random_vals(indx_r((up_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int64: random data left-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(down_rank)) <= &
                      random_vals(indx_r((down_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int64: random data right-constrained&
                      & arg_select")
                  if(allocated(error)) return
                  ...
                  test3 = all(random_vals(indx_r(mid_rank)) <= &
                      random_vals(indx_r((mid_rank+1):size(random_vals, kind=ip))))
                  call check(error, (test1 .and. test2 .and. test3), "test_arg_select_1_rqp_int64: random data&
                      & left-right-constrained arg_select")
                  if(allocated(error)) return
