...
module test_linalg_solve
    ...
    subroutine test_linear_systems(tests)
        ...
        tests = [tests,new_unittest("solve_x",test_x_solve), &
                       new_unittest("solve_x_multiple",test_x_solve_multiple)]
        tests = [tests,new_unittest("solve_q",test_q_solve), &
                       new_unittest("solve_q_multiple",test_q_solve_multiple)]
        ...
        tests = [tests,new_unittest("solve_complex_y",test_y_solve), &
                       new_unittest("solve_2x2_complex_y",test_2x2_y_solve)]
        tests = [tests,new_unittest("solve_complex_w",test_w_solve), &
                       new_unittest("solve_2x2_complex_w",test_2x2_w_solve)]
