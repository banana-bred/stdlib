...
module test_linalg_cholesky
    ...
    subroutine test_cholesky_factorization(tests)
        ...
        tests = [tests,new_unittest("least_cholesky_x",test_cholesky_x)]
        tests = [tests,new_unittest("least_cholesky_q",test_cholesky_q)]
        tests = [tests,new_unittest("least_cholesky_c",test_cholesky_c)]
        tests = [tests,new_unittest("least_cholesky_z",test_cholesky_z)]
        tests = [tests,new_unittest("least_cholesky_y",test_cholesky_y)]
        tests = [tests,new_unittest("least_cholesky_w",test_cholesky_w)]
