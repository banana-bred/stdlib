...
module test_linalg_determinant
    ...
    subroutine test_matrix_determinant(tests)
        ...
        call add_test(tests,new_unittest("$complex_det_cxdp",test_csp_complex_determinant))
        call add_test(tests,new_unittest("$complex_det_cxdp",test_cdp_complex_determinant))
