...
module test_linalg_determinant
    ...
    subroutine test_matrix_determinant(tests)
        ...
        tests = [tests,new_unittest("$eye_det_rqp",test_rqp_eye_determinant)]
        tests = [tests,new_unittest("$eye_det_multiple_rqp",test_rqp_eye_multiple)]
        ...
        tests = [tests,new_unittest("$eye_det_cqp",test_cqp_eye_determinant)]
        tests = [tests,new_unittest("$eye_det_multiple_cqp",test_cqp_eye_multiple)]
        tests = [tests,new_unittest("$complex_det_cqp",test_csp_complex_determinant)]
        tests = [tests,new_unittest("$complex_det_cqp",test_cdp_complex_determinant)]
        tests = [tests,new_unittest("$complex_det_cqp",test_cqp_complex_determinant)]
