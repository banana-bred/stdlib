module test_specialfunctions_gamma
    ...
    real(xdp), parameter :: tol_xdp = sqrt(epsilon(1.0_xdp))
    real(qp), parameter :: tol_qp = sqrt(epsilon(1.0_qp))
...
contains
    ...
    subroutine collect_specialfunctions_gamma(testsuite)
        ...
        testsuite = [                                                          &
            ...
            , new_unittest("log_gamma_cdp",                        &
                           test_loggamma_cdp)                      &
            , new_unittest("gamma_cxdp",                            &
                           test_gamma_cxdp)                         &
            , new_unittest("log_gamma_cxdp",                        &
                           test_loggamma_cxdp)                      &
            ...
            , new_unittest("lower_incomplete_gamma_iint8xdp",     &
                           test_lincgamma_iint8xdp)               &
            , new_unittest("log_lower_incomplete_gamma_iint8xdp", &
                           test_log_lincgamma_iint8xdp)           &
            , new_unittest("upper_incomplete_gamma_iint8xdp",     &
                           test_uincgamma_iint8xdp)               &
            , new_unittest("log_upper_incomplete_gamma_iint8xdp", &
                           test_log_uincgamma_iint8xdp)           &
            , new_unittest("regularized_gamma_p_iint8xdp",        &
                           test_gamma_p_iint8xdp)                 &
            , new_unittest("regularized_gamma_q_iint8xdp",        &
                           test_gamma_q_iint8xdp)                 &
            ...
            , new_unittest("lower_incomplete_gamma_iint16xdp",     &
                           test_lincgamma_iint16xdp)               &
            , new_unittest("log_lower_incomplete_gamma_iint16xdp", &
                           test_log_lincgamma_iint16xdp)           &
            , new_unittest("upper_incomplete_gamma_iint16xdp",     &
                           test_uincgamma_iint16xdp)               &
            , new_unittest("log_upper_incomplete_gamma_iint16xdp", &
                           test_log_uincgamma_iint16xdp)           &
            , new_unittest("regularized_gamma_p_iint16xdp",        &
                           test_gamma_p_iint16xdp)                 &
            , new_unittest("regularized_gamma_q_iint16xdp",        &
                           test_gamma_q_iint16xdp)                 &
            ...
            , new_unittest("lower_incomplete_gamma_iint32xdp",     &
                           test_lincgamma_iint32xdp)               &
            , new_unittest("log_lower_incomplete_gamma_iint32xdp", &
                           test_log_lincgamma_iint32xdp)           &
            , new_unittest("upper_incomplete_gamma_iint32xdp",     &
                           test_uincgamma_iint32xdp)               &
            , new_unittest("log_upper_incomplete_gamma_iint32xdp", &
                           test_log_uincgamma_iint32xdp)           &
            , new_unittest("regularized_gamma_p_iint32xdp",        &
                           test_gamma_p_iint32xdp)                 &
            , new_unittest("regularized_gamma_q_iint32xdp",        &
                           test_gamma_q_iint32xdp)                 &
            ...
            , new_unittest("lower_incomplete_gamma_iint64xdp",     &
                           test_lincgamma_iint64xdp)               &
            , new_unittest("log_lower_incomplete_gamma_iint64xdp", &
                           test_log_lincgamma_iint64xdp)           &
            , new_unittest("upper_incomplete_gamma_iint64xdp",     &
                           test_uincgamma_iint64xdp)               &
            , new_unittest("log_upper_incomplete_gamma_iint64xdp", &
                           test_log_uincgamma_iint64xdp)           &
            , new_unittest("regularized_gamma_p_iint64xdp",        &
                           test_gamma_p_iint64xdp)                 &
            , new_unittest("regularized_gamma_q_iint64xdp",        &
                           test_gamma_q_iint64xdp)                 &
            ...
            , new_unittest("regularized_gamma_q_rdp",              &
                           test_gamma_q_rdp)                       &
            , new_unittest("lower_incomplete_gamma_rxdp",           &
                           test_lincgamma_rxdp)                     &
            , new_unittest("log_lower_incomplete_gamma_rxdp",       &
                           test_log_lincgamma_rxdp)                 &
            , new_unittest("upper_incomplete_gamma_rxdp",           &
                           test_uincgamma_rxdp)                     &
            , new_unittest("log_upper_incomplete_gamma_rxdp",       &
                           test_log_uincgamma_rxdp)                 &
            , new_unittest("regularized_gamma_p_rxdp",              &
                           test_gamma_p_rxdp)                       &
            , new_unittest("regularized_gamma_q_rxdp",              &
                           test_gamma_q_rxdp)                       &
            ]
    ...
    subroutine test_logfact_iint8(error)
        ...
        real(xdp), parameter :: res(*) = [0.0_xdp, &
                                       0.0_xdp, &
                                       0.69314718055994_xdp, &
                                       3.17805383034794_xdp, &
                                       4.78749174278204_xdp, &
                                       8.52516136106541_xdp, &
                                       1.998721449566e1_xdp, &
                                       4.233561646075e1_xdp, &
                                       3.637393755555e2_xdp, &
                                       2.611330458460e3_xdp, &
                                       5.498100377941e4_xdp, &
                                       9.366874681600e5_xdp]        

        integer(int8), parameter :: x(*)   = pack(xtest, xtest<huge(0_int8))
        real(xdp), parameter :: ans(*) = pack(res  , xtest<huge(0_int8))
        integer, parameter :: n = size(x)

        do i = 1, n
            call check(error, log_factorial(x(i)), ans(i), "Integer kind "     &
                       //"int8 failed", thr = tol_xdp, rel = .true.)
    ...
    subroutine test_logfact_iint16(error)
        ...
        real(xdp), parameter :: ans(*) = pack(res  , xtest<huge(0_int16))
        integer, parameter :: n = size(x)

        do i = 1, n
            call check(error, log_factorial(x(i)), ans(i), "Integer kind "     &
                       //"int16 failed", thr = tol_xdp, rel = .true.)
    ...
    subroutine test_logfact_iint32(error)
        ...
        real(xdp), parameter :: ans(*) = pack(res  , xtest<huge(0_int32))
        integer, parameter :: n = size(x)

        do i = 1, n
            call check(error, log_factorial(x(i)), ans(i), "Integer kind "     &
                       //"int32 failed", thr = tol_xdp, rel = .true.)
    ...
    subroutine test_logfact_iint64(error)
        ...
        real(xdp), parameter :: ans(*) = pack(res  , xtest<huge(0_int64))
        integer, parameter :: n = size(x)

        do i = 1, n
            call check(error, log_factorial(x(i)), ans(i), "Integer kind "     &
                       //"int64 failed", thr = tol_xdp, rel = .true.)
    ...
    subroutine test_gamma_cxdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 5
        integer :: i
        type(state_type) :: err
        ...
        complex(xdp), parameter :: x(n) = [(0.25_xdp, 0.25_xdp),               &
                                     (0.5_xdp, -0.5_xdp),                &
                                     (1.0_xdp, 1.0_xdp),                 &
                                     (-1.254e1_xdp, -9.87_xdp),          &
                                     (0.0_xdp, 1.0_xdp)                  &
                                    ]

        complex(xdp), parameter :: ans(n) =                                          &
                     [(1.6511332803889208_xdp, -1.8378758749947890_xdp), &
                      (0.81816399954174739_xdp, 0.76331382871398262_xdp),&
                     (0.49801566811835604_xdp, -0.15494982830181069_xdp),&
             (-2.18767396709283064e-21_xdp, 2.77577940846953455e-21_xdp),&
                    (-0.15494982830181067_xdp, -0.49801566811835607_xdp) &
             ]
        ...
        do i = 1, n
            ...
            err = state_type(STDLIB_VALUE_ERROR,'Complex xdp failed: x=',x(i), &
                             ' gamma=',gamma(x(i)), &
                             'expected=',ans(i), &
                             ' tol=',tol_xdp)

            call check(error, gamma(x(i)), ans(i), err%print(),&
                       thr = tol_xdp, rel = .true.)

        end do
        
    end subroutine test_gamma_cxdp



    subroutine test_loggamma_cxdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer :: i
        type(state_type) :: err
        

        complex(xdp), parameter :: x(*) = [(0.25_xdp, 0.25_xdp),               &
                                     (0.5_xdp, -0.5_xdp),                &
                                     (1.0_xdp, 1.0_xdp),                 &
                                     (-1.254e1_xdp, -9.87_xdp)]

        complex(xdp), parameter :: ans(*) =                                          &
                    [(0.90447450949333889_xdp, -0.83887024394321282_xdp),&
                     (0.11238724280962311_xdp, 0.75072920212205074_xdp), &
                    (-0.65092319930185634_xdp, -0.30164032046753320_xdp),&
                   (-4.7091788015763380e1_xdp, 1.4804627819235690e1_xdp)]
    ...
    end subroutine test_loggamma_cxdp
    ...
    subroutine test_lincgamma_iint8xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int8), parameter :: p(n) = [1_int8, 2_int8, 3_int8, 2_int8]
        real(xdp), parameter :: x(n) = [0.5_xdp, 3.5_xdp, -5.0_xdp, -10.0_xdp]

        real(xdp), parameter :: ans(n) = [0.3934693402873667_xdp,              &
                                       0.86411177459956675_xdp,             &
                                       -2.5210237047438023e3_xdp,           &
                                       1.9823919215326045e5_xdp]

        do i = 1, n

            call check(error, lower_incomplete_gamma(p(i), x(i)), ans(i),      &
              "Lower incomplete gamma function with p(kind=int8) and "       &
              //"x(kind=xdp) failed", thr = tol_xdp, rel = .true.)

        end do

    end subroutine test_lincgamma_iint8xdp



    subroutine test_log_lincgamma_iint8xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int8) :: p(n) = [1_int8, 2_int8, 3_int8, 2_int8]
        real(xdp) :: x(n) = [0.5_xdp, 3.5_xdp, -5.0_xdp, -10.0_xdp]

        real(xdp), parameter :: ans(n) = [-0.93275212956718857_xdp,            &
                                       -0.14605314979599791_xdp,            &
                                        7.8324203300567640_xdp,             &
                                        1.2197229621760137e1_xdp]

        do i = 1, n

            call check(error, log_lower_incomplete_gamma(p(i), x(i)), ans(i),  &
              "Logarithm of lower incomplete gamma function with "             &
              //"p(kind=int8) and x(kind=xdp) failed", thr = tol_xdp,  &
              rel = .true.)

        end do

    end subroutine test_log_lincgamma_iint8xdp



    subroutine test_uincgamma_iint8xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int8) :: p(n) = [1_int8, 2_int8, 3_int8, 2_int8]
        ...
        real(xdp), parameter :: ans(n) = [0.60653065971263342_xdp,             &
                                       0.13588822540043325_xdp,             &
                                       2.5230237047438022E3_xdp,            &
                                       -1.9823819215326045e5_xdp]
    ...
    end subroutine test_uincgamma_iint8xdp



    subroutine test_log_uincgamma_iint8xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int8) :: p(n) = [1_int8, 2_int8, 3_int8, 2_int8]
        ...
        real(xdp), parameter :: ans(n) = [-0.5_xdp, -1.9959226032237259_xdp,&
                                       7.8332133440562161_xdp,              &
                                       1.2197224577336219e1_xdp]
    ...
    end subroutine test_log_uincgamma_iint8xdp




    subroutine test_gamma_p_iint8xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int8) :: p(n) = [1_int8, 1_int8, 3_int8, 3_int8]
        real(xdp) :: x(n) = [0.5_xdp, 1.5_xdp, 0.5_xdp, 3.5_xdp]

        real(xdp), parameter :: ans(n) = [0.39346934028736658_xdp,             &
                                       0.77686983985157017_xdp,             &
                                       1.4387677966970687e-2_xdp,           &
                                       0.67915280113786593_xdp]
    ...
    end subroutine test_gamma_p_iint8xdp



    subroutine test_gamma_q_iint8xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int8) :: p(n) = [1_int8, 1_int8, 3_int8, 3_int8]
        ...
        real(xdp), parameter :: ans(n) = [0.60653065971263342_xdp,             &
                                       0.22313016014842983_xdp,             &
                                       0.98561232203302931_xdp,             &
                                       0.32084719886213407_xdp]
    ...
    end subroutine test_gamma_q_iint8xdp
    ...
    subroutine test_lincgamma_iint16xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int16), parameter :: p(n) = [1_int16, 2_int16, 3_int16, 2_int16]
    ...
    end subroutine test_lincgamma_iint16xdp



    subroutine test_log_lincgamma_iint16xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int16) :: p(n) = [1_int16, 2_int16, 3_int16, 2_int16]
        ...
        do i = 1, n
            ...
            call check(error, log_lower_incomplete_gamma(p(i), x(i)), ans(i),  &
              "Logarithm of lower incomplete gamma function with "             &
              //"p(kind=int16) and x(kind=xdp) failed", thr = tol_xdp,  &
              rel = .true.)

        end do

    end subroutine test_log_lincgamma_iint16xdp



    subroutine test_uincgamma_iint16xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int16) :: p(n) = [1_int16, 2_int16, 3_int16, 2_int16]
    ...
    end subroutine test_uincgamma_iint16xdp



    subroutine test_log_uincgamma_iint16xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int16) :: p(n) = [1_int16, 2_int16, 3_int16, 2_int16]
    ...
    end subroutine test_log_uincgamma_iint16xdp




    subroutine test_gamma_p_iint16xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int16) :: p(n) = [1_int16, 1_int16, 3_int16, 3_int16]
    ...
    end subroutine test_gamma_p_iint16xdp



    subroutine test_gamma_q_iint16xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int16) :: p(n) = [1_int16, 1_int16, 3_int16, 3_int16]
    ...
    end subroutine test_gamma_q_iint16xdp
    ...
    subroutine test_lincgamma_iint32xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int32), parameter :: p(n) = [1_int32, 2_int32, 3_int32, 2_int32]
    ...
    end subroutine test_lincgamma_iint32xdp



    subroutine test_log_lincgamma_iint32xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int32) :: p(n) = [1_int32, 2_int32, 3_int32, 2_int32]
        ...
        do i = 1, n
            ...
            call check(error, log_lower_incomplete_gamma(p(i), x(i)), ans(i),  &
              "Logarithm of lower incomplete gamma function with "             &
              //"p(kind=int32) and x(kind=xdp) failed", thr = tol_xdp,  &
              rel = .true.)

        end do

    end subroutine test_log_lincgamma_iint32xdp



    subroutine test_uincgamma_iint32xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int32) :: p(n) = [1_int32, 2_int32, 3_int32, 2_int32]
    ...
    end subroutine test_uincgamma_iint32xdp



    subroutine test_log_uincgamma_iint32xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int32) :: p(n) = [1_int32, 2_int32, 3_int32, 2_int32]
    ...
    end subroutine test_log_uincgamma_iint32xdp




    subroutine test_gamma_p_iint32xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int32) :: p(n) = [1_int32, 1_int32, 3_int32, 3_int32]
    ...
    end subroutine test_gamma_p_iint32xdp



    subroutine test_gamma_q_iint32xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int32) :: p(n) = [1_int32, 1_int32, 3_int32, 3_int32]
    ...
    end subroutine test_gamma_q_iint32xdp
    ...
    subroutine test_lincgamma_iint64xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int64), parameter :: p(n) = [1_int64, 2_int64, 3_int64, 2_int64]
    ...
    end subroutine test_lincgamma_iint64xdp



    subroutine test_log_lincgamma_iint64xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int64) :: p(n) = [1_int64, 2_int64, 3_int64, 2_int64]
        ...
        do i = 1, n
            ...
            call check(error, log_lower_incomplete_gamma(p(i), x(i)), ans(i),  &
              "Logarithm of lower incomplete gamma function with "             &
              //"p(kind=int64) and x(kind=xdp) failed", thr = tol_xdp,  &
              rel = .true.)

        end do

    end subroutine test_log_lincgamma_iint64xdp



    subroutine test_uincgamma_iint64xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int64) :: p(n) = [1_int64, 2_int64, 3_int64, 2_int64]
    ...
    end subroutine test_uincgamma_iint64xdp



    subroutine test_log_uincgamma_iint64xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int64) :: p(n) = [1_int64, 2_int64, 3_int64, 2_int64]
    ...
    end subroutine test_log_uincgamma_iint64xdp




    subroutine test_gamma_p_iint64xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int64) :: p(n) = [1_int64, 1_int64, 3_int64, 3_int64]
    ...
    end subroutine test_gamma_p_iint64xdp



    subroutine test_gamma_q_iint64xdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        integer(int64) :: p(n) = [1_int64, 1_int64, 3_int64, 3_int64]
    ...
    end subroutine test_gamma_q_iint64xdp
    ...
    subroutine test_lincgamma_rxdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        real(xdp) :: p(n) = [1.0_xdp, 2.0_xdp, 3.1_xdp, 6.5_xdp]
        real(xdp) :: x(n) = [0.5_xdp, 3.5_xdp, 5.0_xdp, 3.2_xdp]

        real(xdp), parameter :: ans(n) = [0.3934693402873667_xdp,              &
                                       0.86411177459956675_xdp,             &
                                       1.8980559470963281_xdp,              &
                                       2.0043549563092636e1_xdp]

        do i = 1, n

            call check(error, lower_incomplete_gamma(p(i), x(i)), ans(i),      &
              "Lower incomplete gamma function with p(kind=xdp) and "       &
              //"x(kind=xdp) failed", thr = tol_xdp, rel = .true.)

        end do

    end subroutine test_lincgamma_rxdp



    subroutine test_log_lincgamma_rxdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        real(xdp) :: p(n) = [1.0_xdp, 2.0_xdp, 3.1_xdp, 6.5_xdp]
        ...
        real(xdp), parameter :: ans(n) = [-0.93275212956718857_xdp,            &
                                       -0.14605314979599791_xdp,            &
                                        0.64083017662175706_xdp,            &
                                        2.9979073844388951_xdp]

        do i = 1, n

            call check(error, log_lower_incomplete_gamma(p(i), x(i)), ans(i),  &
              "Logarithm of lower incomplete gamma function with "             &
              //"p(kind=xdp) and x(kind=xdp) failed", thr = tol_xdp,  &
              rel = .true.)

        end do

    end subroutine test_log_lincgamma_rxdp



    subroutine test_uincgamma_rxdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        real(xdp) :: p(n) = [1.0_xdp, 2.0_xdp, 3.1_xdp, 6.5_xdp]
        ...
        real(xdp), parameter :: ans(n) = [0.60653065971263342_xdp,             &
                                       0.13588822540043325_xdp,             &
                                       0.29956433129614910_xdp,             &
                                       2.6784172825195172e2_xdp]
    ...
    end subroutine test_uincgamma_rxdp



    subroutine test_log_uincgamma_rxdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        real(xdp) :: p(n) = [1.0_xdp, 2.0_xdp, 3.1_xdp, 6.5_xdp]
        ...
        real(xdp), parameter :: ans(n) = [-0.5_xdp, -1.9959226032237259_xdp,&
                                       -1.2054260888453405_xdp,             &
                                       5.5903962398338761_xdp]
    ...
    end subroutine test_log_uincgamma_rxdp



    subroutine test_gamma_p_rxdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        real(xdp) :: p(n) = [1.3_xdp, 1.3_xdp, 3.7_xdp, 3.7_xdp]
        real(xdp) :: x(n) = [0.5_xdp, 2.1_xdp, 2.6_xdp, 5.1_xdp]

        real(xdp), parameter :: ans(n) = [0.26487356764588505_xdp,             &
                                       0.81011791338807457_xdp,             &
                                       0.32198359288949589_xdp,             &
                                       0.79435732817518852_xdp]

        do i = 1, n

            call check(error, regularized_gamma_p(p(i), x(i)), ans(i),         &
              "Regularized gamma P function with p(kind=xdp) and "          &
              //"x(kind=xdp) failed", thr = tol_xdp, rel = .true.)

        end do
    end subroutine test_gamma_p_rxdp



    subroutine test_gamma_q_rxdp(error)
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: n = 4
        integer :: i
        real(xdp) :: p(n) = [1.3_xdp, 1.3_xdp, 3.7_xdp, 3.7_xdp]
        ...
        real(xdp), parameter :: ans(n) = [0.73512643235411495_xdp,             &
                                       0.18988208661192543_xdp,             &
                                       0.67801640711050411_xdp,             &
                                       0.20564267182481148_xdp]

        do i = 1, n

            call check(error, regularized_gamma_q(p(i), x(i)), ans(i),         &
              "Regularized gamma Q function with p(kind=xdp) and "          &
              //"x(kind=xdp) failed", thr = tol_xdp, rel = .true.)

        end do
    end subroutine test_gamma_q_rxdp
