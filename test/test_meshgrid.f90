...
contains
    ...
    subroutine collect_meshgrid(testsuite)
        ...
        testsuite = [ &
            ...
            new_unittest("meshgrid_default_1_rxdp_rxdp", test_meshgrid_default_1_rxdp_rxdp), &
            new_unittest("meshgrid_xy_1_rxdp_rxdp", test_meshgrid_xy_1_rxdp_rxdp), &
            new_unittest("meshgrid_ij_1_rxdp_rxdp", test_meshgrid_ij_1_rxdp_rxdp), &
            new_unittest("meshgrid_default_2_rxdp_rxdp", test_meshgrid_default_2_rxdp_rxdp), &
            new_unittest("meshgrid_xy_2_rxdp_rxdp", test_meshgrid_xy_2_rxdp_rxdp), &
            new_unittest("meshgrid_ij_2_rxdp_rxdp", test_meshgrid_ij_2_rxdp_rxdp), &
            new_unittest("meshgrid_default_3_rxdp_rxdp", test_meshgrid_default_3_rxdp_rxdp), &
            new_unittest("meshgrid_xy_3_rxdp_rxdp", test_meshgrid_xy_3_rxdp_rxdp), &
            new_unittest("meshgrid_ij_3_rxdp_rxdp", test_meshgrid_ij_3_rxdp_rxdp), &
            new_unittest("meshgrid_default_4_rxdp_rxdp", test_meshgrid_default_4_rxdp_rxdp), &
            new_unittest("meshgrid_xy_4_rxdp_rxdp", test_meshgrid_xy_4_rxdp_rxdp), &
            new_unittest("meshgrid_ij_4_rxdp_rxdp", test_meshgrid_ij_4_rxdp_rxdp), &
            new_unittest("meshgrid_default_1_rqp_rqp", test_meshgrid_default_1_rqp_rqp), &
            new_unittest("meshgrid_xy_1_rqp_rqp", test_meshgrid_xy_1_rqp_rqp), &
            new_unittest("meshgrid_ij_1_rqp_rqp", test_meshgrid_ij_1_rqp_rqp), &
            new_unittest("meshgrid_default_2_rqp_rqp", test_meshgrid_default_2_rqp_rqp), &
            new_unittest("meshgrid_xy_2_rqp_rqp", test_meshgrid_xy_2_rqp_rqp), &
            new_unittest("meshgrid_ij_2_rqp_rqp", test_meshgrid_ij_2_rqp_rqp), &
            new_unittest("meshgrid_default_3_rqp_rqp", test_meshgrid_default_3_rqp_rqp), &
            new_unittest("meshgrid_xy_3_rqp_rqp", test_meshgrid_xy_3_rqp_rqp), &
            new_unittest("meshgrid_ij_3_rqp_rqp", test_meshgrid_ij_3_rqp_rqp), &
            new_unittest("meshgrid_default_4_rqp_rqp", test_meshgrid_default_4_rqp_rqp), &
            new_unittest("meshgrid_xy_4_rqp_rqp", test_meshgrid_xy_4_rqp_rqp), &
            new_unittest("meshgrid_ij_4_rqp_rqp", test_meshgrid_ij_4_rqp_rqp), &
    ...
    subroutine test_meshgrid_default_1_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length)
        real(xdp) :: xm1(length)
        real(xdp) :: xm1_exact(length)
        integer :: i
        integer :: i1
        real(xdp), parameter :: ZERO = 0
        ! valid test case
        x1 = [(i, i = length * 0 + 1, length * 1)]
        xm1_exact = reshape( &
                [(x1(i1), i1 = 1, size(x1))], &
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm1 - xm1_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_default_1_rxdp_rxdp
    subroutine test_meshgrid_xy_1_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm1 - xm1_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_xy_1_rxdp_rxdp
    subroutine test_meshgrid_ij_1_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm1 - xm1_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_ij_1_rxdp_rxdp
    subroutine test_meshgrid_default_2_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length),x2(length)
        real(xdp) :: xm1(length,length),xm2(length,length)
        real(xdp) :: xm1_exact(length,length),xm2_exact(length,length)
        integer :: i
        integer :: i1,i2
        real(xdp), parameter :: ZERO = 0
        ! valid test case
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm2 - xm2_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_default_2_rxdp_rxdp
    subroutine test_meshgrid_xy_2_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length),x2(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm2 - xm2_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_xy_2_rxdp_rxdp
    subroutine test_meshgrid_ij_2_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length),x2(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm2 - xm2_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_ij_2_rxdp_rxdp
    subroutine test_meshgrid_default_3_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length),x2(length),x3(length)
        real(xdp) :: xm1(length,length,length),xm2(length,length,length),xm3(length,length,length)
        real(xdp) :: xm1_exact(length,length,length),xm2_exact(length,length,length),xm3_exact(length,length,length)
        integer :: i
        integer :: i1,i2,i3
        real(xdp), parameter :: ZERO = 0
        ! valid test case
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm3 - xm3_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_default_3_rxdp_rxdp
    subroutine test_meshgrid_xy_3_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length),x2(length),x3(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm3 - xm3_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_xy_3_rxdp_rxdp
    subroutine test_meshgrid_ij_3_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length),x2(length),x3(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm3 - xm3_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_ij_3_rxdp_rxdp
    subroutine test_meshgrid_default_4_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length),x2(length),x3(length),x4(length)
        real(xdp) :: xm1(length,length,length,length),xm2(length,length,length,length),xm3(length,length,length,length),xm4(length,&
            &length,length,length)
        real(xdp) :: xm1_exact(length,length,length,length),xm2_exact(length,length,length,length),xm3_exact(length,length,length,l&
            &ength),xm4_exact(length,length,length,length)
        integer :: i
        integer :: i1,i2,i3,i4
        real(xdp), parameter :: ZERO = 0
        ! valid test case
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm4 - xm4_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_default_4_rxdp_rxdp
    subroutine test_meshgrid_xy_4_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length),x2(length),x3(length),x4(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm4 - xm4_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_xy_4_rxdp_rxdp
    subroutine test_meshgrid_ij_4_rxdp_rxdp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(xdp) :: x1(length),x2(length),x3(length),x4(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm4 - xm4_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_ij_4_rxdp_rxdp
    subroutine test_meshgrid_default_1_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length)
        real(qp) :: xm1(length)
        real(qp) :: xm1_exact(length)
        integer :: i
        integer :: i1
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm1 - xm1_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_default_1_rqp_rqp
    subroutine test_meshgrid_xy_1_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm1 - xm1_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_xy_1_rqp_rqp
    subroutine test_meshgrid_ij_1_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm1 - xm1_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_ij_1_rqp_rqp
    subroutine test_meshgrid_default_2_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length),x2(length)
        real(qp) :: xm1(length,length),xm2(length,length)
        real(qp) :: xm1_exact(length,length),xm2_exact(length,length)
        integer :: i
        integer :: i1,i2
        real(qp), parameter :: ZERO = 0
        ! valid test case
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm2 - xm2_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_default_2_rqp_rqp
    subroutine test_meshgrid_xy_2_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length),x2(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm2 - xm2_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_xy_2_rqp_rqp
    subroutine test_meshgrid_ij_2_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length),x2(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm2 - xm2_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_ij_2_rqp_rqp
    subroutine test_meshgrid_default_3_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length),x2(length),x3(length)
        real(qp) :: xm1(length,length,length),xm2(length,length,length),xm3(length,length,length)
        real(qp) :: xm1_exact(length,length,length),xm2_exact(length,length,length),xm3_exact(length,length,length)
        integer :: i
        integer :: i1,i2,i3
        real(qp), parameter :: ZERO = 0
        ! valid test case
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm3 - xm3_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_default_3_rqp_rqp
    subroutine test_meshgrid_xy_3_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length),x2(length),x3(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm3 - xm3_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_xy_3_rqp_rqp
    subroutine test_meshgrid_ij_3_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length),x2(length),x3(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm3 - xm3_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_ij_3_rqp_rqp
    subroutine test_meshgrid_default_4_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length),x2(length),x3(length),x4(length)
        real(qp) :: xm1(length,length,length,length),xm2(length,length,length,length),xm3(length,length,length,length),xm4(length,l&
            &ength,length,length)
        real(qp) :: xm1_exact(length,length,length,length),xm2_exact(length,length,length,length),xm3_exact(length,length,length,le&
            &ngth),xm4_exact(length,length,length,length)
        integer :: i
        integer :: i1,i2,i3,i4
        real(qp), parameter :: ZERO = 0
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm4 - xm4_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_default_4_rqp_rqp
    subroutine test_meshgrid_xy_4_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length),x2(length),x3(length),x4(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm4 - xm4_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_xy_4_rqp_rqp
    subroutine test_meshgrid_ij_4_rqp_rqp(error)
        !> Error handling
        type(error_type), allocatable, intent(out) :: error
        integer, parameter :: length = 3
        real(qp) :: x1(length),x2(length),x3(length),x4(length)
        ...
        call meshgrid( &
            ...
            call check(error, maxval(abs(xm4 - xm4_exact)), ZERO)
            if (allocated(error)) return
    end subroutine test_meshgrid_ij_4_rqp_rqp
