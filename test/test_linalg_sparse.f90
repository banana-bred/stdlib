...
contains
    ...
    subroutine test_coo(error)
        ...
        block
            ...
            real(xdp), allocatable :: dense(:,:)
            real(xdp), allocatable :: vec_x(:)
            real(xdp), allocatable :: vec_y1(:), vec_y2(:)
        ...
        block
            ...
            real(qp), allocatable :: dense(:,:)
            real(qp), allocatable :: vec_x(:)
            real(qp), allocatable :: vec_y1(:), vec_y2(:)
    ...
    subroutine test_sellc(error)
        ...
        block
            integer, parameter :: wp = xdp
            type(SELLC_xdp_type) :: SELLC
            type(CSR_xdp_type)   :: CSR
            real(xdp), allocatable :: vec_x(:)
            real(xdp), allocatable :: vec_y(:), vec_y2(:)
            integer :: i
        ...
        block
            integer, parameter :: wp = qp
            type(SELLC_qp_type) :: SELLC
            type(CSR_qp_type)   :: CSR
            real(qp), allocatable :: vec_x(:)
            real(qp), allocatable :: vec_y(:), vec_y2(:)
            integer :: i
    ...
    subroutine test_symmetries(error)
        ...
        block
            ...
            real(xdp), allocatable :: dense(:,:)
            real(xdp), allocatable :: vec_x(:)
            real(xdp), allocatable :: vec_y1(:), vec_y2(:), vec_y3(:), vec_y4(:)
        ...
        block
            ...
            real(qp), allocatable :: dense(:,:)
            real(qp), allocatable :: vec_x(:)
            real(qp), allocatable :: vec_y1(:), vec_y2(:), vec_y3(:), vec_y4(:)
