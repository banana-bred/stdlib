module test_linalg_mnorm
    ...
    subroutine test_matrix_norms(tests)
        ...
        tests = [tests,new_unittest("test_matrix_norms_x",test_matrix_norms_x)]
        tests = [tests,new_unittest("test_mnorm_x_3d",test_mnorm_x_3d)]
        tests = [tests,new_unittest("test_matrix_norms_q",test_matrix_norms_q)]
        tests = [tests,new_unittest("test_mnorm_q_3d",test_mnorm_q_3d)]
        ...
        tests = [tests,new_unittest("test_matrix_norms_y",test_matrix_norms_y)]
        tests = [tests,new_unittest("test_mnorm_y_3d",test_mnorm_y_3d)]
        tests = [tests,new_unittest("test_matrix_norms_w",test_matrix_norms_w)]
        tests = [tests,new_unittest("test_mnorm_w_3d",test_mnorm_w_3d)]
