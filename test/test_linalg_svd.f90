...
module test_linalg_svd
    ...
    subroutine test_svd(tests)
        ...
        call add_test(tests,new_unittest("test_svd_row_x",test_svd_row_x))         
        call add_test(tests,new_unittest("test_svd_row_q",test_svd_row_q))         
        ...
        call add_test(tests,new_unittest("test_svd_row_y",test_svd_row_y))         
        call add_test(tests,new_unittest("test_svd_row_w",test_svd_row_w))         
