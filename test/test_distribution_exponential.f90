...
program test_distribution_expon
    ...
    real(xdp), parameter :: xdptol = 1000 * epsilon(1.0_xdp)
...
contains
    ...
    subroutine test_expon_rvs_rxdp
        real(xdp) :: res(10), lambda, loc, scale
        integer, parameter :: k = 5
        integer :: i
        integer :: seed, get
        real(xdp), parameter :: ans(10) =                                         &
                            [0.609680481289574416337018192280083895_xdp,    &
                             0.137541023585612635452927558314210417_xdp,    &
                             0.134921508232253721063879462841820585_xdp,    &
                              1.33766060689229752493171569464417802_xdp,    &
                             0.111148487576340881943792737729381770_xdp,    &
                             0.533951653963536868966836361020492979_xdp,    &
                              1.96897428558727671799033487332053483_xdp,    &
                             0.371111977992924465160247867364281152_xdp,    &
                             0.811918715695663687862785688290993341_xdp,    &
                             0.404637854946697868759504975362991277_xdp]

        print *, "Test exponential_distribution_rvs_rxdp"
        seed = 593742186

        ! set args
        lambda = 1.5_xdp
        loc    = 0._xdp
        scale  = 1.0_xdp/lambda
        ...
        res(6:10) = expon_rvs(lambda, k)    ! 2 dummies
        call check(all(abs(res - ans) < xdptol),                            &
            msg="exponential_distribution_rvs_rxdp failed", warn=warn)
        ...
        call check(all(abs(res - ans) < xdptol),                            &
            msg="exponential_distribution_rvs_rxdp failed", warn=warn)
    end subroutine test_expon_rvs_rxdp

    subroutine test_expon_rvs_rqp
        real(qp) :: res(10), lambda, loc, scale
        integer, parameter :: k = 5
        integer :: i
        integer :: seed, get
        real(qp), parameter :: ans(10) =                                         &
                            [0.609680481289574416337018192280083895_qp,    &
                             0.137541023585612635452927558314210417_qp,    &
                             0.134921508232253721063879462841820585_qp,    &
                              1.33766060689229752493171569464417802_qp,    &
                             0.111148487576340881943792737729381770_qp,    &
                             0.533951653963536868966836361020492979_qp,    &
                              1.96897428558727671799033487332053483_qp,    &
                             0.371111977992924465160247867364281152_qp,    &
                             0.811918715695663687862785688290993341_qp,    &
                             0.404637854946697868759504975362991277_qp]
    ...
    subroutine test_expon_rvs_cxdp
        complex(xdp) :: res(10), lambda, loc, scale
        integer, parameter :: k = 5
        integer :: i
        integer :: seed, get
        complex(xdp), parameter :: ans(10) =                                         &
                            [(1.30645817419194517786503898345732266_xdp,    &
                             0.158701181060322271676454874977935106_xdp),   &
                            (0.289117517640543687994027420375329869_xdp,    &
                              1.54345454641418945184428733997405138_xdp),   &
                            (0.238175330520730461308127295134389521_xdp,    &
                             0.616098062265619464192503493485184250_xdp),   &
                             (4.21923061197273582426500329997257485_xdp,    &
                             0.428206128453374382877209077728016710_xdp),   &
                             (1.73982581934785075970596933205212874_xdp,    &
                             0.466889832630805233184044202341912994_xdp),   &
                             (2.22649889847873832288931745486999202_xdp,    &
                             0.879109337848515628785697537331053851_xdp),   &
                             (8.76802198822945553859296653951917464_xdp,    &
                             0.200128045239398311139211728004738688_xdp),   &
                            (0.694821947760945587572020290930855262_xdp,    &
                             0.101964167346166995492113143812345625_xdp),   &
                            (0.141476585024528208770330398432893829_xdp,    &
                       3.989655879458742013468417133900891716E-0002_xdp),   &
                             (2.10676792861163792685325850990401309_xdp,    &
                             0.249356813451327473065187125310051027_xdp)]

        print *, "Test exponential_distribution_rvs_cxdp"
        seed = 593742186

        ! set args
        lambda = (0.7_xdp, 1.3_xdp)
        loc    = (0._xdp, 0._xdp)
        scale  = cmplx(1.0_xdp/lambda%re, 1.0_xdp/lambda%im, kind=xdp)
        ...
        res(6:10) = expon_rvs(lambda, k)    ! 2 dummies
        call check(all(abs(res - ans) < xdptol),                            &
            msg="exponential_distribution_rvs_cxdp failed", warn=warn)
        ...
        call check(all(abs(res - ans) < xdptol),                            &
            msg="exponential_distribution_rvs_cxdp failed", warn=warn)
    end subroutine test_expon_rvs_cxdp

    subroutine test_expon_rvs_cqp
        complex(qp) :: res(10), lambda, loc, scale
        integer, parameter :: k = 5
        integer :: i
        integer :: seed, get
        complex(qp), parameter :: ans(10) =                                         &
                            [(1.30645817419194517786503898345732266_qp,    &
                             0.158701181060322271676454874977935106_qp),   &
                            (0.289117517640543687994027420375329869_qp,    &
                              1.54345454641418945184428733997405138_qp),   &
                            (0.238175330520730461308127295134389521_qp,    &
                             0.616098062265619464192503493485184250_qp),   &
                             (4.21923061197273582426500329997257485_qp,    &
                             0.428206128453374382877209077728016710_qp),   &
                             (1.73982581934785075970596933205212874_qp,    &
                             0.466889832630805233184044202341912994_qp),   &
                             (2.22649889847873832288931745486999202_qp,    &
                             0.879109337848515628785697537331053851_qp),   &
                             (8.76802198822945553859296653951917464_qp,    &
                             0.200128045239398311139211728004738688_qp),   &
                            (0.694821947760945587572020290930855262_qp,    &
                             0.101964167346166995492113143812345625_qp),   &
                            (0.141476585024528208770330398432893829_qp,    &
                       3.989655879458742013468417133900891716E-0002_qp),   &
                             (2.10676792861163792685325850990401309_qp,    &
                             0.249356813451327473065187125310051027_qp)]

        print *, "Test exponential_distribution_rvs_cqp"
        seed = 593742186

        ! set args
        lambda = (0.7_qp, 1.3_qp)
        loc    = (0._qp, 0._qp)
        scale  = cmplx(1.0_qp/lambda%re, 1.0_qp/lambda%im, kind=qp)
    ...
    subroutine test_expon_pdf_rxdp

        real(xdp) :: x1, x2(3,4), lambda, loc, scale
        integer :: seed, get
        real(xdp) :: res(3,5)
        real(xdp), parameter :: ans(15) =                                   &
                             [0.362692289054629718342313806171796533_xdp,   &
                              0.362692289054629718342313806171796533_xdp,   &
                              0.362692289054629718342313806171796533_xdp,   &
                               1.44877092399186122284289290051705535_xdp,   &
                               1.08871761038277651996081144393335589_xdp,   &
                              0.203258408490339213767867275283195750_xdp,   &
                              0.730004225568590859263284124264208147_xdp,   &
                              0.237394827760488451509080387833146683_xdp,   &
                              0.301732182586179598102005265289645959_xdp,   &
                               1.35079274124711914255014934401469271_xdp,   &
                              0.416578245043239337295928202660090263_xdp,   &
                               1.44039177901335374382803898226703593_xdp,   &
                              0.196044829271295768265275728683411055_xdp,   &
                              0.271373826917613661285112379170965958_xdp,   &
                               1.00108987409617105109732206933052664_xdp]

        print *, "Test exponential_distribution_pdf_rxdp"
        seed = 123987654
        ...
        res(:,1) = expon_pdf(x1, lambda)
        res(:, 2:5) = expon_pdf(x2, lambda)
        call check(all(abs(res - reshape(ans, [3,5])) < xdptol),            &
            msg="exponential_distribution_pdf_rxdp failed", warn=warn)
    ...
    end subroutine test_expon_pdf_rxdp

    subroutine test_expon_pdf_rqp

        real(qp) :: x1, x2(3,4), lambda, loc, scale
        integer :: seed, get
        real(qp) :: res(3,5)
        real(qp), parameter :: ans(15) =                                   &
                             [0.362692289054629718342313806171796533_qp,   &
                              0.362692289054629718342313806171796533_qp,   &
                              0.362692289054629718342313806171796533_qp,   &
                               1.44877092399186122284289290051705535_qp,   &
                               1.08871761038277651996081144393335589_qp,   &
                              0.203258408490339213767867275283195750_qp,   &
                              0.730004225568590859263284124264208147_qp,   &
                              0.237394827760488451509080387833146683_qp,   &
                              0.301732182586179598102005265289645959_qp,   &
                               1.35079274124711914255014934401469271_qp,   &
                              0.416578245043239337295928202660090263_qp,   &
                               1.44039177901335374382803898226703593_qp,   &
                              0.196044829271295768265275728683411055_qp,   &
                              0.271373826917613661285112379170965958_qp,   &
                               1.00108987409617105109732206933052664_qp]
    ...
    subroutine test_expon_pdf_cxdp

        complex(xdp) :: x1, x2(3,4), lambda, loc, scale
        integer :: seed, get
        real(xdp) :: res(3,5)
        real(xdp), parameter :: ans(15) =                                   &
                             [0.112097715784191810518066563334849515_xdp,   &
                              0.112097715784191810518066563334849515_xdp,   &
                              0.112097715784191810518066563334849515_xdp,   &
                         4.72087485401191174735651518020251204E-0002_xdp,   &
                         3.69705018439006691768174449531170720E-0002_xdp,   &
                         8.69498969681198520061798177185735738E-0002_xdp,   &
                              0.128007654288233028296342302153338001_xdp,   &
                         1.13496395875758374774198906169957218E-0002_xdp,   &
                              0.294260498264128747413785056084385424_xdp,   &
                         4.66169813179250908948018478030960097E-0002_xdp,   &
                         2.84438693906889813143446828488861951E-0002_xdp,   &
                              0.161859307815385236742977105439660254_xdp,   &
                         4.22904796362406579112752522035325397E-0002_xdp,   &
                              0.176117981883470250164040199296778089_xdp,   &
                              0.107352342201327219885025541854724060_xdp]

        print *, "Test exponential_distribution_pdf_cxdp"
        seed = 123987654

        ! set args
        lambda = (0.3_xdp, 1.6_xdp)
        loc    = (0._xdp, 0._xdp)
        scale  = cmplx(1.0_xdp/lambda%re, 1.0_xdp/lambda%im, kind=xdp)
        ...
        res(:, 2:5) = expon_pdf(x2, lambda)
        call check(all(abs(res - reshape(ans, [3,5])) < xdptol),            &
            msg="exponential_distribution_pdf_cxdp failed", warn=warn)
    ...
    end subroutine test_expon_pdf_cxdp

    subroutine test_expon_pdf_cqp

        complex(qp) :: x1, x2(3,4), lambda, loc, scale
        integer :: seed, get
        real(qp) :: res(3,5)
        real(qp), parameter :: ans(15) =                                   &
                             [0.112097715784191810518066563334849515_qp,   &
                              0.112097715784191810518066563334849515_qp,   &
                              0.112097715784191810518066563334849515_qp,   &
                         4.72087485401191174735651518020251204E-0002_qp,   &
                         3.69705018439006691768174449531170720E-0002_qp,   &
                         8.69498969681198520061798177185735738E-0002_qp,   &
                              0.128007654288233028296342302153338001_qp,   &
                         1.13496395875758374774198906169957218E-0002_qp,   &
                              0.294260498264128747413785056084385424_qp,   &
                         4.66169813179250908948018478030960097E-0002_qp,   &
                         2.84438693906889813143446828488861951E-0002_qp,   &
                              0.161859307815385236742977105439660254_qp,   &
                         4.22904796362406579112752522035325397E-0002_qp,   &
                              0.176117981883470250164040199296778089_qp,   &
                              0.107352342201327219885025541854724060_qp]

        print *, "Test exponential_distribution_pdf_cqp"
        seed = 123987654

        ! set args
        lambda = (0.3_qp, 1.6_qp)
        loc    = (0._qp, 0._qp)
        scale  = cmplx(1.0_qp/lambda%re, 1.0_qp/lambda%im, kind=qp)
    ...
    subroutine test_expon_cdf_rxdp

        real(xdp) :: x1, x2(3,4), lambda, loc, scale
        integer :: seed, get
        real(xdp) :: res(3,5)
        real(xdp), parameter :: ans(15) =                                   &
                           [0.109257742653704886153815776449785051_xdp,     &
                            0.109257742653704886153815776449785051_xdp,     &
                            0.109257742653704886153815776449785051_xdp,     &
                            0.717506371795765265795319089684216215_xdp,     &
                       6.82471795435370961628021592837348251E-0002_xdp,     &
                            0.158022297254037860379992220663140220_xdp,     &
                            0.914579543576380160727189390750289231_xdp,     &
                            0.735445094339121647068624074363021598_xdp,     &
                       8.69845458684957375690771394578441361E-0002_xdp,     &
                            0.491195342629961409581199224477971938_xdp,     &
                            0.574283568793105916250099261345264380_xdp,     &
                            0.312823040527767907760475800138803955_xdp,     &
                            0.640029783598040153827956625977856239_xdp,     &
                       2.16202116731629451897815202649346917E-0002_xdp,     &
                       7.74788145547936974757767867581111655E-0002_xdp]

        print *, "Test exponential_distribution_cdf_rxdp"
        seed = 621957438
        ...
        res(:, 2:5) = expon_cdf(x2, lambda)
        call check(all(abs(res - reshape(ans,[3,5])) < xdptol),             &
            msg="exponential_distribution_cdf_rxdp failed", warn=warn)
    ...
    end subroutine test_expon_cdf_rxdp
    ...
    subroutine test_expon_cdf_rqp
        ...
        real(qp) :: res(3,5)
        real(qp), parameter :: ans(15) =                                   &
                           [0.109257742653704886153815776449785051_qp,     &
                            0.109257742653704886153815776449785051_qp,     &
                            0.109257742653704886153815776449785051_qp,     &
                            0.717506371795765265795319089684216215_qp,     &
                       6.82471795435370961628021592837348251E-0002_qp,     &
                            0.158022297254037860379992220663140220_qp,     &
                            0.914579543576380160727189390750289231_qp,     &
                            0.735445094339121647068624074363021598_qp,     &
                       8.69845458684957375690771394578441361E-0002_qp,     &
                            0.491195342629961409581199224477971938_qp,     &
                            0.574283568793105916250099261345264380_qp,     &
                            0.312823040527767907760475800138803955_qp,     &
                            0.640029783598040153827956625977856239_qp,     &
                       2.16202116731629451897815202649346917E-0002_qp,     &
                       7.74788145547936974757767867581111655E-0002_qp]
    ...
    subroutine test_expon_cdf_cxdp

        complex(xdp) :: x1, x2(3,4), lambda, loc, scale
        integer :: seed, get
        real(xdp) :: res(3,5)
        real(xdp), parameter :: ans(15) =                                   &
                        [7.83931265220552191922145459533155073E-0002_xdp,   &
                         7.83931265220552191922145459533155073E-0002_xdp,   &
                         7.83931265220552191922145459533155073E-0002_xdp,   &
                         1.07845760925785109085652212151328215E-0002_xdp,   &
                              0.672623038706161724678635394849362256_xdp,   &
                         4.27264038113873579678831482902258168E-0002_xdp,   &
                              0.179649132114996961326498233168917293_xdp,   &
                         1.38375793985183014482681114776428612E-0002_xdp,   &
                         3.49246365297941076158369468479748612E-0002_xdp,   &
                              0.116869945417176368845403154176734792_xdp,   &
                              0.468462732010133566674397830557697485_xdp,   &
                              0.413506985517976634907329948218002431_xdp,   &
                              0.665679674838121942273909342901808398_xdp,   &
                              0.223748595107983772617787558595393205_xdp,   &
                              0.337722969540396286456937689606849800_xdp]

        print *, "Test exponential_distribution_cdf_cxdp"
        seed = 621957438

        ! set args
        lambda = (1.3_xdp, 2.1_xdp)
        loc    = (0._xdp, 0._xdp)
        scale  = cmplx(1.0_xdp/lambda%re, 1.0_xdp/lambda%im, kind=xdp)
        ...
        res(:, 2:5) = expon_cdf(x2, lambda)
        call check(all(abs(res - reshape(ans,[3,5])) < xdptol),             &
            msg="exponential_distribution_cdf_cxdp failed", warn=warn)
    ...
    end subroutine test_expon_cdf_cxdp
    ...
    subroutine test_expon_cdf_cqp
        ...
        real(qp) :: res(3,5)
        real(qp), parameter :: ans(15) =                                   &
                        [7.83931265220552191922145459533155073E-0002_qp,   &
                         7.83931265220552191922145459533155073E-0002_qp,   &
                         7.83931265220552191922145459533155073E-0002_qp,   &
                         1.07845760925785109085652212151328215E-0002_qp,   &
                              0.672623038706161724678635394849362256_qp,   &
                         4.27264038113873579678831482902258168E-0002_qp,   &
                              0.179649132114996961326498233168917293_qp,   &
                         1.38375793985183014482681114776428612E-0002_qp,   &
                         3.49246365297941076158369468479748612E-0002_qp,   &
                              0.116869945417176368845403154176734792_qp,   &
                              0.468462732010133566674397830557697485_qp,   &
                              0.413506985517976634907329948218002431_qp,   &
                              0.665679674838121942273909342901808398_qp,   &
                              0.223748595107983772617787558595393205_qp,   &
                              0.337722969540396286456937689606849800_qp]

        print *, "Test exponential_distribution_cdf_cqp"
        seed = 621957438

        ! set args
        lambda = (1.3_qp, 2.1_qp)
        loc    = (0._qp, 0._qp)
        scale  = cmplx(1.0_qp/lambda%re, 1.0_qp/lambda%im, kind=qp)
