...
module test_linalg_qr
    ...
    subroutine test_qr_random_x(error)
        ...
        real(xdp) :: a(m,n),aorig(m,n),q(m,m),r(m,n),qred(m,k),rred(k,n),qerr(m,6),rerr(6,n)
    ...
    subroutine test_qr_random_q(error)
        ...
        real(qp) :: a(m,n),aorig(m,n),q(m,m),r(m,n),qred(m,k),rred(k,n),qerr(m,6),rerr(6,n)
    ...
    subroutine test_qr_random_y(error)
        ...
        integer(ilp), parameter :: k   = min(m,n)
        real(xdp), parameter :: tol = 100*sqrt(epsilon(0.0_xdp))
        complex(xdp) :: a(m,n),aorig(m,n),q(m,m),r(m,n),qred(m,k),rred(k,n),qerr(m,6),rerr(6,n)
        real(xdp) :: rea(m,n),ima(m,n)
        integer(ilp) :: lwork
    ...
    subroutine test_qr_random_w(error)
        ...
        integer(ilp), parameter :: k   = min(m,n)
        real(qp), parameter :: tol = 100*sqrt(epsilon(0.0_qp))
        complex(qp) :: a(m,n),aorig(m,n),q(m,m),r(m,n),qred(m,k),rred(k,n),qerr(m,6),rerr(6,n)
        real(qp) :: rea(m,n),ima(m,n)
        integer(ilp) :: lwork
